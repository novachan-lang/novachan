...
; ESCAPE greet: allocs=0 escape=0 local=0
define i64 @greet(i64 %p0) nounwind uwtable !dbg !200 {
entry:
  %slot.name = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.name, align 8, !dbg !201
  %r0.p = getelementptr inbounds [8 x i8], ptr @.str.0, i64 0, i64 0, !dbg !202
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !202
  %r1 = load i64, ptr %slot.name, align 8, !dbg !202
  %r2 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r1), !dbg !202
  %r3.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !202
  %r3 = ptrtoint ptr %r3.p to i64, !dbg !202
  %r4 = call i64 @nova_rt_str_concat(i64 %r2, i64 %r3), !dbg !202
  call i64 @nova_rt_rc_drop_temp(i64 %r2), !dbg !202
  ret i64 %r4, !dbg !202
}

; ESCAPE greet_loud: allocs=0 escape=0 local=0
define i64 @greet_loud(i64 %p0) nounwind uwtable !dbg !203 {
entry:
  %slot.name = alloca i64, align 8, !dbg !204
  store i64 %p0, ptr %slot.name, align 8, !dbg !204
  %r0.p = getelementptr inbounds [8 x i8], ptr @.str.0, i64 0, i64 0, !dbg !205
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !205
  %r1 = load i64, ptr %slot.name, align 8, !dbg !205
  %r2 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r1), !dbg !205
  %r3.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !205
  %r3 = ptrtoint ptr %r3.p to i64, !dbg !205
  %r4 = call i64 @nova_rt_str_concat(i64 %r2, i64 %r3), !dbg !205
  call i64 @nova_rt_rc_drop_temp(i64 %r2), !dbg !205
  %r5 = call i64 @nova_rt_upper(i64 %r4), !dbg !205
  ret i64 %r5, !dbg !205
}
...
!101 = !DIFile(filename: "packages/pkg-greet/greet.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "greet", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 1, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "greet_loud", scope: !101, file: !101, line: 4, type: !104, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !100)
