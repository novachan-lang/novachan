...
; ESCAPE _hex_char: allocs=0 escape=0 local=0
define i64 @_hex_char(i64 %p0) nounwind uwtable !dbg !200 {
entry:
  %slot.n = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.n, align 8, !dbg !201
  %r0.p = getelementptr inbounds [17 x i8], ptr @.str.0, i64 0, i64 0, !dbg !202
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !202
  %r1 = load i64, ptr %slot.n, align 8, !dbg !202
  %r2 = add i64 16, 0, !dbg !202
  %r3 = call i64 @nova_rt_mod(i64 %r1, i64 %r2), !dbg !202
  %r4 = call i64 @nova_rt_char_at(i64 %r0, i64 %r3), !dbg !202
  ret i64 %r4, !dbg !202
}

; ESCAPE _hex_byte: allocs=0 escape=0 local=0
define i64 @_hex_byte(i64 %p0) nounwind uwtable !dbg !203 {
entry:
  %slot.n = alloca i64, align 8, !dbg !204
  store i64 %p0, ptr %slot.n, align 8, !dbg !204
  %r0 = load i64, ptr %slot.n, align 8, !dbg !205
  %r1 = add i64 16, 0, !dbg !205
  %r2 = call i64 @nova_rt_div(i64 %r0, i64 %r1), !dbg !205
  %r3 = call i64 @_hex_char(i64 %r2), !dbg !205
  %r4 = load i64, ptr %slot.n, align 8, !dbg !205
  %r5 = add i64 16, 0, !dbg !205
  %r6 = call i64 @nova_rt_mod(i64 %r4, i64 %r5), !dbg !205
  %r7 = call i64 @_hex_char(i64 %r6), !dbg !205
  %r8 = call i64 @nova_rt_str_concat(i64 %r3, i64 %r7), !dbg !205
  ret i64 %r8, !dbg !205
}

; ESCAPE _rand_byte: allocs=0 escape=0 local=0
define i64 @_rand_byte() nounwind uwtable !dbg !206 {
entry:
  %r0 = add i64 0, 0, !dbg !208
  %r1 = add i64 255, 0, !dbg !208
  %r2 = call i64 @nova_rt_random_int(i64 %r0, i64 %r1), !dbg !208
  ret i64 %r2, !dbg !208
}

; ESCAPE uuid4: allocs=0 escape=0 local=0
define i64 @uuid4() nounwind uwtable !dbg !209 {
entry:
  %slot.b0 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b0, align 8, !dbg !210
  %slot.b1 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b1, align 8, !dbg !210
  %slot.b2 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b2, align 8, !dbg !210
  %slot.b3 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b3, align 8, !dbg !210
  %slot.b4 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b4, align 8, !dbg !210
  %slot.b5 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b5, align 8, !dbg !210
  %slot.b6_raw = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b6_raw, align 8, !dbg !210
  %slot.b6 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b6, align 8, !dbg !210
  %slot.b7 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b7, align 8, !dbg !210
  %slot.b8_raw = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b8_raw, align 8, !dbg !210
  %slot.b8 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b8, align 8, !dbg !210
  %slot.b9 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b9, align 8, !dbg !210
  %slot.b10 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b10, align 8, !dbg !210
  %slot.b11 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b11, align 8, !dbg !210
  %slot.b12 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b12, align 8, !dbg !210
  %slot.b13 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b13, align 8, !dbg !210
  %slot.b14 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b14, align 8, !dbg !210
  %slot.b15 = alloca i64, align 8, !dbg !210
  store i64 0, ptr %slot.b15, align 8, !dbg !210
  %r0 = call i64 @_rand_byte(), !dbg !211
  %r1 = call i64 @_hex_byte(i64 %r0), !dbg !211
  store i64 %r1, ptr %slot.b0, align 8, !dbg !211
  %r2 = call i64 @_rand_byte(), !dbg !212
  %r3 = call i64 @_hex_byte(i64 %r2), !dbg !212
  store i64 %r3, ptr %slot.b1, align 8, !dbg !212
  %r4 = call i64 @_rand_byte(), !dbg !213
  %r5 = call i64 @_hex_byte(i64 %r4), !dbg !213
  store i64 %r5, ptr %slot.b2, align 8, !dbg !213
  %r6 = call i64 @_rand_byte(), !dbg !214
  %r7 = call i64 @_hex_byte(i64 %r6), !dbg !214
  store i64 %r7, ptr %slot.b3, align 8, !dbg !214
  %r8 = call i64 @_rand_byte(), !dbg !215
  %r9 = call i64 @_hex_byte(i64 %r8), !dbg !215
  store i64 %r9, ptr %slot.b4, align 8, !dbg !215
  %r10 = call i64 @_rand_byte(), !dbg !216
  %r11 = call i64 @_hex_byte(i64 %r10), !dbg !216
  store i64 %r11, ptr %slot.b5, align 8, !dbg !216
  %r12 = call i64 @_rand_byte(), !dbg !217
  store i64 %r12, ptr %slot.b6_raw, align 8, !dbg !217
  %r13 = add i64 %r12, 0, !dbg !218
  %r14 = add i64 15, 0, !dbg !218
  %r15 = and i64 %r13, %r14, !dbg !218
  %r16 = add i64 64, 0, !dbg !218
  %r17 = or i64 %r15, %r16, !dbg !218
  %r18 = call i64 @_hex_byte(i64 %r17), !dbg !218
  store i64 %r18, ptr %slot.b6, align 8, !dbg !218
  %r19 = call i64 @_rand_byte(), !dbg !219
  %r20 = call i64 @_hex_byte(i64 %r19), !dbg !219
  store i64 %r20, ptr %slot.b7, align 8, !dbg !219
  %r21 = call i64 @_rand_byte(), !dbg !220
  store i64 %r21, ptr %slot.b8_raw, align 8, !dbg !220
  %r22 = add i64 %r21, 0, !dbg !221
  %r23 = add i64 63, 0, !dbg !221
  %r24 = and i64 %r22, %r23, !dbg !221
  %r25 = add i64 128, 0, !dbg !221
  %r26 = or i64 %r24, %r25, !dbg !221
  %r27 = call i64 @_hex_byte(i64 %r26), !dbg !221
  store i64 %r27, ptr %slot.b8, align 8, !dbg !221
  %r28 = call i64 @_rand_byte(), !dbg !222
  %r29 = call i64 @_hex_byte(i64 %r28), !dbg !222
  store i64 %r29, ptr %slot.b9, align 8, !dbg !222
  %r30 = call i64 @_rand_byte(), !dbg !223
  %r31 = call i64 @_hex_byte(i64 %r30), !dbg !223
  store i64 %r31, ptr %slot.b10, align 8, !dbg !223
  %r32 = call i64 @_rand_byte(), !dbg !224
  %r33 = call i64 @_hex_byte(i64 %r32), !dbg !224
  store i64 %r33, ptr %slot.b11, align 8, !dbg !224
  %r34 = call i64 @_rand_byte(), !dbg !225
  %r35 = call i64 @_hex_byte(i64 %r34), !dbg !225
  store i64 %r35, ptr %slot.b12, align 8, !dbg !225
  %r36 = call i64 @_rand_byte(), !dbg !226
  %r37 = call i64 @_hex_byte(i64 %r36), !dbg !226
  store i64 %r37, ptr %slot.b13, align 8, !dbg !226
  %r38 = call i64 @_rand_byte(), !dbg !227
  %r39 = call i64 @_hex_byte(i64 %r38), !dbg !227
  store i64 %r39, ptr %slot.b14, align 8, !dbg !227
  %r40 = call i64 @_rand_byte(), !dbg !228
  %r41 = call i64 @_hex_byte(i64 %r40), !dbg !228
  store i64 %r41, ptr %slot.b15, align 8, !dbg !228
  %r42 = add i64 %r1, 0, !dbg !229
  %r43 = add i64 %r3, 0, !dbg !229
  %r44 = call i64 @nova_rt_str_concat(i64 %r42, i64 %r43), !dbg !229
  %r45 = add i64 %r5, 0, !dbg !229
  %r46 = call i64 @nova_rt_str_concat(i64 %r44, i64 %r45), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r44), !dbg !229
  %r47 = add i64 %r7, 0, !dbg !229
  %r48 = call i64 @nova_rt_str_concat(i64 %r46, i64 %r47), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r46), !dbg !229
  %r49.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !229
  %r49 = ptrtoint ptr %r49.p to i64, !dbg !229
  %r50 = call i64 @nova_rt_str_concat(i64 %r48, i64 %r49), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r48), !dbg !229
  %r51 = add i64 %r9, 0, !dbg !229
  %r52 = call i64 @nova_rt_str_concat(i64 %r50, i64 %r51), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r50), !dbg !229
  %r53 = add i64 %r11, 0, !dbg !229
  %r54 = call i64 @nova_rt_str_concat(i64 %r52, i64 %r53), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r52), !dbg !229
  %r55.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !229
  %r55 = ptrtoint ptr %r55.p to i64, !dbg !229
  %r56 = call i64 @nova_rt_str_concat(i64 %r54, i64 %r55), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r54), !dbg !229
  %r57 = add i64 %r18, 0, !dbg !229
  %r58 = call i64 @nova_rt_str_concat(i64 %r56, i64 %r57), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r56), !dbg !229
  %r59 = add i64 %r20, 0, !dbg !229
  %r60 = call i64 @nova_rt_str_concat(i64 %r58, i64 %r59), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r58), !dbg !229
  %r61.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !229
  %r61 = ptrtoint ptr %r61.p to i64, !dbg !229
  %r62 = call i64 @nova_rt_str_concat(i64 %r60, i64 %r61), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r60), !dbg !229
  %r63 = add i64 %r27, 0, !dbg !229
  %r64 = call i64 @nova_rt_str_concat(i64 %r62, i64 %r63), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r62), !dbg !229
  %r65 = add i64 %r29, 0, !dbg !229
  %r66 = call i64 @nova_rt_str_concat(i64 %r64, i64 %r65), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r64), !dbg !229
  %r67.p = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0, !dbg !229
  %r67 = ptrtoint ptr %r67.p to i64, !dbg !229
  %r68 = call i64 @nova_rt_str_concat(i64 %r66, i64 %r67), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r66), !dbg !229
  %r69 = add i64 %r31, 0, !dbg !229
  %r70 = call i64 @nova_rt_str_concat(i64 %r68, i64 %r69), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r68), !dbg !229
  %r71 = add i64 %r33, 0, !dbg !229
  %r72 = call i64 @nova_rt_str_concat(i64 %r70, i64 %r71), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r70), !dbg !229
  %r73 = add i64 %r35, 0, !dbg !229
  %r74 = call i64 @nova_rt_str_concat(i64 %r72, i64 %r73), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r72), !dbg !229
  %r75 = add i64 %r37, 0, !dbg !229
  %r76 = call i64 @nova_rt_str_concat(i64 %r74, i64 %r75), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r74), !dbg !229
  %r77 = add i64 %r39, 0, !dbg !229
  %r78 = call i64 @nova_rt_str_concat(i64 %r76, i64 %r77), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r76), !dbg !229
  %r79 = add i64 %r41, 0, !dbg !229
  %r80 = call i64 @nova_rt_str_concat(i64 %r78, i64 %r79), !dbg !229
  call i64 @nova_rt_rc_drop_temp(i64 %r78), !dbg !229
  ret i64 %r80, !dbg !229
}
...
!101 = !DIFile(filename: "packages/pkg-uuid/uuid.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "_hex_char", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 1, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "_hex_byte", scope: !101, file: !101, line: 4, type: !104, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !100)
!204 = !DILocation(line: 4, column: 0, scope: !203)
!206 = distinct !DISubprogram(name: "_rand_byte", scope: !101, file: !101, line: 7, type: !104, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !100)
!207 = !DILocation(line: 7, column: 0, scope: !206)
!209 = distinct !DISubprogram(name: "uuid4", scope: !101, file: !101, line: 10, type: !104, scopeLine: 10, spFlags: DISPFlagDefinition, unit: !100)
!210 = !DILocation(line: 10, column: 0, scope: !209)
!202 = !DILocation(line: 2, column: 0, scope: !200)
!205 = !DILocation(line: 5, column: 0, scope: !203)
!208 = !DILocation(line: 8, column: 0, scope: !206)
!211 = !DILocation(line: 11, column: 0, scope: !209)
!212 = !DILocation(line: 12, column: 0, scope: !209)
!213 = !DILocation(line: 13, column: 0, scope: !209)
!214 = !DILocation(line: 14, column: 0, scope: !209)
!215 = !DILocation(line: 15, column: 0, scope: !209)
!216 = !DILocation(line: 16, column: 0, scope: !209)
!217 = !DILocation(line: 17, column: 0, scope: !209)
!218 = !DILocation(line: 18, column: 0, scope: !209)
!219 = !DILocation(line: 19, column: 0, scope: !209)
!220 = !DILocation(line: 20, column: 0, scope: !209)
!221 = !DILocation(line: 21, column: 0, scope: !209)
!222 = !DILocation(line: 22, column: 0, scope: !209)
!223 = !DILocation(line: 23, column: 0, scope: !209)
!224 = !DILocation(line: 24, column: 0, scope: !209)
!225 = !DILocation(line: 25, column: 0, scope: !209)
!226 = !DILocation(line: 26, column: 0, scope: !209)
!227 = !DILocation(line: 27, column: 0, scope: !209)
!228 = !DILocation(line: 28, column: 0, scope: !209)
!229 = !DILocation(line: 29, column: 0, scope: !209)
