...
define i64 @is_prime(i64 %p0) nounwind !dbg !200 {
entry:
  %slot.n = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.n, align 8, !dbg !201
  %slot.d = alloca i64, align 8, !dbg !201
  store i64 0, ptr %slot.d, align 8, !dbg !201
  %r0 = load i64, ptr %slot.n, align 8, !dbg !202
  %r1 = add i64 2, 0, !dbg !202
  %r2.cmp = icmp slt i64 %r0, %r1, !dbg !202
  %r2 = zext i1 %r2.cmp to i64, !dbg !202
  %br_then0 = icmp ne i64 %r2, 0, !dbg !202
  br i1 %br_then0, label %then0, label %else1, !dbg !202
then0:
  %r3 = add i64 0, 0, !dbg !203
  ret i64 %r3, !dbg !203
else1:
  br label %endif2, !dbg !203
endif2:
  %r4 = load i64, ptr %slot.n, align 8, !dbg !204
  %r5 = add i64 2, 0, !dbg !204
  %r6.cmp = icmp eq i64 %r4, %r5, !dbg !204
  %r6 = zext i1 %r6.cmp to i64, !dbg !204
  %br_then3 = icmp ne i64 %r6, 0, !dbg !204
  br i1 %br_then3, label %then3, label %else4, !dbg !204
then3:
  %r7 = add i64 1, 0, !dbg !205
  ret i64 %r7, !dbg !205
else4:
  br label %endif5, !dbg !205
endif5:
  %r8 = load i64, ptr %slot.n, align 8, !dbg !206
  %r9 = add i64 2, 0, !dbg !206
  %r10 = srem i64 %r8, %r9, !dbg !206
  %r11 = add i64 0, 0, !dbg !206
  %r12.cmp = icmp eq i64 %r10, %r11, !dbg !206
  %r12 = zext i1 %r12.cmp to i64, !dbg !206
  %br_then6 = icmp ne i64 %r12, 0, !dbg !206
  br i1 %br_then6, label %then6, label %else7, !dbg !206
then6:
...
endif8:
  %r14 = add i64 3, 0, !dbg !208
  store i64 %r14, ptr %slot.d, align 8, !dbg !208
  br label %while_hdr9, !llvm.loop !91, !dbg !209
while_hdr9:
  %r15 = load i64, ptr %slot.d, align 8, !dbg !209
  %r16 = load i64, ptr %slot.d, align 8, !dbg !209
  %r17 = mul i64 %r15, %r16, !dbg !209
  %r18 = load i64, ptr %slot.n, align 8, !dbg !209
  %r19.cmp = icmp sle i64 %r17, %r18, !dbg !209
  %r19 = zext i1 %r19.cmp to i64, !dbg !209
  %br_while_body10 = icmp ne i64 %r19, 0, !dbg !209
  br i1 %br_while_body10, label %while_body10, label %while_exit11, !prof !90, !dbg !209
while_body10:
  %r20 = load i64, ptr %slot.n, align 8, !dbg !210
  %r21 = load i64, ptr %slot.d, align 8, !dbg !210
  %r22 = srem i64 %r20, %r21, !dbg !210
  %r23 = add i64 0, 0, !dbg !210
  %r24.cmp = icmp eq i64 %r22, %r23, !dbg !210
  %r24 = zext i1 %r24.cmp to i64, !dbg !210
  %br_then12 = icmp ne i64 %r24, 0, !dbg !210
  br i1 %br_then12, label %then12, label %else13, !dbg !210
then12:
  %r25 = add i64 0, 0, !dbg !211
  ret i64 %r25, !dbg !211
else13:
  br label %endif14, !dbg !211
endif14:
  %r26 = load i64, ptr %slot.d, align 8, !dbg !212
  %r27 = add i64 2, 0, !dbg !212
  %r28 = add i64 %r26, %r27, !dbg !212
  store i64 %r28, ptr %slot.d, align 8, !dbg !212
  br label %while_hdr9, !llvm.loop !91, !dbg !212
while_exit11:
  %r29 = add i64 1, 0, !dbg !213
  ret i64 %r29, !dbg !213
}
...
!101 = !DIFile(filename: "primes_tmp.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "is_prime", scope: !101, file: !101, line: 3, type: !104, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 3, column: 0, scope: !200)
!202 = !DILocation(line: 4, column: 0, scope: !200)
!203 = !DILocation(line: 5, column: 0, scope: !200)
!204 = !DILocation(line: 6, column: 0, scope: !200)
!205 = !DILocation(line: 7, column: 0, scope: !200)
!206 = !DILocation(line: 8, column: 0, scope: !200)
!207 = !DILocation(line: 9, column: 0, scope: !200)
!208 = !DILocation(line: 10, column: 0, scope: !200)
!209 = !DILocation(line: 11, column: 0, scope: !200)
!210 = !DILocation(line: 12, column: 0, scope: !200)
!211 = !DILocation(line: 13, column: 0, scope: !200)
!212 = !DILocation(line: 14, column: 0, scope: !200)
!213 = !DILocation(line: 15, column: 0, scope: !200)
