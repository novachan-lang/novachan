...
; ESCAPE ec_get: allocs=0 escape=0 local=0
define i64 @ec_get(i64 %p0, i64 %p1) nounwind uwtable {
entry:
  %slot.key = alloca i64, align 8
  store i64 %p0, ptr %slot.key, align 8
  %slot.default_value = alloca i64, align 8
  store i64 %p1, ptr %slot.default_value, align 8
  %slot.v = alloca i64, align 8
  store i64 0, ptr %slot.v, align 8
  %r0 = load i64, ptr %slot.key, align 8
  %r1 = call i64 @nova_rt_env(i64 %r0)
  store i64 %r1, ptr %slot.v, align 8
  %r2 = load i64, ptr %slot.v, align 8
  %r3 = call i64 @nova_rt_len_any(i64 %r2)
  %r4 = add i64 0, 0
  %r5.cmp = icmp eq i64 %r3, %r4
  %r5 = zext i1 %r5.cmp to i64
  %br_then00 = icmp ne i64 %r5, 0
  br i1 %br_then00, label %then0, label %else1
then0:
  %r6 = load i64, ptr %slot.default_value, align 8
  ret i64 %r6
else1:
  br label %endif2
endif2:
  %r7 = load i64, ptr %slot.v, align 8
  ret i64 %r7
}

; ESCAPE _ec_is_int: allocs=0 escape=0 local=0
define i64 @_ec_is_int(i64 %p0) nounwind uwtable {
entry:
...
endif5:
  %r5 = add i64 0, 0
  store i64 %r5, ptr %slot.start, align 8
  %r6 = load i64, ptr %slot.s, align 8
  %r7 = add i64 0, 0
  %r8 = call i64 @nova_rt_char_at(i64 %r6, i64 %r7)
  %r9.p = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0
  ...
  %br_then61 = icmp ne i64 %r10, 0
  br i1 %br_then61, label %then6, label %else7
then6:
  %r11 = add i64 1, 0
  store i64 %r11, ptr %slot.start, align 8
  br label %endif8
else7:
  br label %endif8
endif8:
  %r12 = load i64, ptr %slot.start, align 8
  %r13 = load i64, ptr %slot.s, align 8
  %r14 = call i64 @nova_rt_len_any(i64 %r13)
  %r15.cmp = icmp sge i64 %r12, %r14
  %r15 = zext i1 %r15.cmp to i64
  %br_then92 = icmp ne i64 %r15, 0
  br i1 %br_then92, label %then9, label %else10
then9:
  %r16 = add i64 0, 0
  ret i64 %r16
else10:
  br label %endif11
endif11:
  %r17 = load i64, ptr %slot.start, align 8
  store i64 %r17, ptr %slot.i, align 8
  br label %while_hdr12
while_hdr12:
  %r18 = load i64, ptr %slot.i, align 8
  %r19 = load i64, ptr %slot.s, align 8
  %r20 = call i64 @nova_rt_len_any(i64 %r19)
  %r21.cmp = icmp slt i64 %r18, %r20
  %r21 = zext i1 %r21.cmp to i64
  %br_while_body133 = icmp ne i64 %r21, 0
  br i1 %br_while_body133, label %while_body13, label %while_exit14, !prof !90
while_body13:
  %r22 = load i64, ptr %slot.s, align 8
  %r23 = load i64, ptr %slot.i, align 8
  %r24 = call i64 @nova_rt_char_at(i64 %r22, i64 %r23)
  %r25 = call i64 @nova_rt_ord(i64 %r24)
  store i64 %r25, ptr %slot.c, align 8
  %r26 = load i64, ptr %slot.c, align 8
  %r27 = add i64 48, 0
  %r28.cmp = icmp slt i64 %r26, %r27
  %r28 = zext i1 %r28.cmp to i64
  store i64 %r28, ptr %slot.__sc_15, align 8
  %br_or_merge174 = icmp ne i64 %r28, 0
  br i1 %br_or_merge174, label %or_merge17, label %or_rhs16
or_rhs16:
  %r29 = load i64, ptr %slot.c, align 8
  %r30 = add i64 57, 0
  %r31.cmp = icmp sgt i64 %r29, %r30
  %r31 = zext i1 %r31.cmp to i64
  store i64 %r31, ptr %slot.__sc_15, align 8
  br label %or_merge17
or_merge17:
  %r32 = load i64, ptr %slot.__sc_15, align 8
  %br_then185 = icmp ne i64 %r32, 0
  br i1 %br_then185, label %then18, label %else19
then18:
  %r33 = add i64 0, 0
  ret i64 %r33
else19:
...
; ESCAPE ec_get_int: allocs=0 escape=0 local=0
define i64 @ec_get_int(i64 %p0, i64 %p1) nounwind uwtable {
entry:
  %slot.key = alloca i64, align 8
  store i64 %p0, ptr %slot.key, align 8
  %slot.default_value = alloca i64, align 8
...
; ESCAPE ec_get_bool: allocs=0 escape=0 local=0
define i64 @ec_get_bool(i64 %p0, i64 %p1) nounwind uwtable {
entry:
  %slot.key = alloca i64, align 8
  store i64 %p0, ptr %slot.key, align 8
  %slot.default_value = alloca i64, align 8
  ...
  %r0 = load i64, ptr %slot.key, align 8
  %r1 = call i64 @nova_rt_env(i64 %r0)
  %r2 = call i64 @nova_rt_lower(i64 %r1)
  store i64 %r2, ptr %slot.v, align 8
  %r3 = load i64, ptr %slot.v, align 8
  %r4.p = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %br_or_merge260 = icmp ne i64 %r5, 0
  br i1 %br_or_merge260, label %or_merge26, label %or_rhs25
or_rhs25:
  ...
  store i64 %r8, ptr %slot.__sc_24, align 8
  br label %or_merge26
or_merge26:
  %r9 = load i64, ptr %slot.__sc_24, align 8
  %br_then271 = icmp ne i64 %r9, 0
  br i1 %br_then271, label %then27, label %else28
then27:
  %r10 = add i64 1, 0
  ret i64 %r10
else28:
  br label %endif29
endif29:
  %r11 = load i64, ptr %slot.v, align 8
  %r12.p = getelementptr inbounds [6 x i8], ptr @.str.3, i64 0, i64 0
  ...
  %br_or_merge322 = icmp ne i64 %r13, 0
  br i1 %br_or_merge322, label %or_merge32, label %or_rhs31
or_rhs31:
  %r14 = load i64, ptr %slot.v, align 8
  %r15.p = getelementptr inbounds [2 x i8], ptr @.str.4, i64 0, i64 0
  %r15 = ptrtoint ptr %r15.p to i64
  %r16.p0 = inttoptr i64 %r14 to ptr
  %r16.p1 = inttoptr i64 %r15 to ptr
  %r16.sc = call i32 @strcmp(ptr %r16.p0, ptr %r16.p1)
  %r16.cmp = icmp eq i32 %r16.sc, 0
  %r16 = zext i1 %r16.cmp to i64
  store i64 %r16, ptr %slot.__sc_30, align 8
  br label %or_merge32
or_merge32:
  %r17 = load i64, ptr %slot.__sc_30, align 8
  %br_then333 = icmp ne i64 %r17, 0
  br i1 %br_then333, label %then33, label %else34
then33:
  %r18 = add i64 0, 0
  ret i64 %r18
else34:
  br label %endif35
endif35:
  %r19 = load i64, ptr %slot.default_value, align 8
  ret i64 %r19
}

; ESCAPE ec_require: allocs=0 escape=0 local=0
define i64 @ec_require(i64 %p0) nounwind uwtable {
entry:
  %slot.key = alloca i64, align 8
  store i64 %p0, ptr %slot.key, align 8
  %slot.v = alloca i64, align 8
  ...
  %r5.cmp = icmp eq i64 %r3, %r4
  %r5 = zext i1 %r5.cmp to i64
  %br_then360 = icmp ne i64 %r5, 0
  br i1 %br_then360, label %then36, label %else37
then36:
  %r6.p = getelementptr inbounds [27 x i8], ptr @.str.5, i64 0, i64 0
  %r6 = ptrtoint ptr %r6.p to i64
  %r7 = load i64, ptr %slot.key, align 8
  %r8 = call i64 @nova_rt_str_concat(i64 %r6, i64 %r7)
  %r9 = call i64 @nova_rt_err(i64 %r8)
  ret i64 %r9
else37:
  br label %endif38
endif38:
  %r10 = load i64, ptr %slot.v, align 8
  %r11 = call i64 @nova_rt_ok(i64 %r10)
  ret i64 %r11
}

; ESCAPE ec_prefix: allocs=1 escape=1 local=0
define i64 @ec_prefix(i64 %p0, i64 %p1) nounwind uwtable {
entry:
  %slot.prefix = alloca i64, align 8
  store i64 %p0, ptr %slot.prefix, align 8
  %slot.candidate_keys = alloca i64, align 8
  store i64 %p1, ptr %slot.candidate_keys, align 8
  ...
  %slot.full_key = alloca i64, align 8
  store i64 0, ptr %slot.full_key, align 8
  %slot.v = alloca i64, align 8
  store i64 0, ptr %slot.v, align 8
  ...
  br label %while_hdr39
while_hdr39:
  %r2 = load i64, ptr %slot.i, align 8
  %r3 = load i64, ptr %slot.candidate_keys, align 8
  %r4 = call i64 @nova_rt_len_any(i64 %r3)
  %r5.cmp = icmp slt i64 %r2, %r4
  %r5 = zext i1 %r5.cmp to i64
  %br_while_body400 = icmp ne i64 %r5, 0
  br i1 %br_while_body400, label %while_body40, label %while_exit41, !prof !90
while_body40:
  %r6 = load i64, ptr %slot.candidate_keys, align 8
  %r7 = load i64, ptr %slot.i, align 8
  %r8 = call i64 @nova_rt_index_get(i64 %r6, i64 %r7)
  store i64 %r8, ptr %slot.key, align 8
  %r9 = load i64, ptr %slot.prefix, align 8
  %r10 = load i64, ptr %slot.key, align 8
  %r11 = call i64 @nova_rt_str_concat(i64 %r9, i64 %r10)
  store i64 %r11, ptr %slot.full_key, align 8
  %r12 = load i64, ptr %slot.full_key, align 8
  %r13 = call i64 @nova_rt_env(i64 %r12)
  ...
  %br_then421 = icmp ne i64 %r17, 0
  br i1 %br_then421, label %then42, label %else43
then42:
  %r18 = load i64, ptr %slot.v, align 8
  %r19 = load i64, ptr %slot.out, align 8
  %r20 = load i64, ptr %slot.full_key, align 8
  %_is.dv2 = call i64 @nova_rt_dict_set(i64 %r19, i64 %r20, i64 %r18)
  br label %endif44
else43:
  br label %endif44
endif44:
  ...
  %r22 = add i64 1, 0
  %r23 = add i64 %r21, %r22
  store i64 %r23, ptr %slot.i, align 8
  br label %while_hdr39
while_exit41:
  %r24 = load i64, ptr %slot.out, align 8
  ret i64 %r24
}

; ESCAPE ce_get: allocs=0 escape=0 local=0
define i64 @ce_get(i64 %p0, i64 %p1) nounwind uwtable !dbg !200 {
entry:
  %slot.name = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.name, align 8, !dbg !201
  %slot.default_value = alloca i64, align 8, !dbg !201
  store i64 %p1, ptr %slot.default_value, align 8, !dbg !201
  %r0 = load i64, ptr %slot.name, align 8, !dbg !202
  %r1 = load i64, ptr %slot.default_value, align 8, !dbg !202
  %r2 = call i64 @ec_get(i64 %r0, i64 %r1), !dbg !202
  ret i64 %r2, !dbg !202
}

; ESCAPE ce_get_int: allocs=0 escape=0 local=0
define i64 @ce_get_int(i64 %p0, i64 %p1) nounwind uwtable !dbg !203 {
entry:
  %slot.name = alloca i64, align 8, !dbg !204
  store i64 %p0, ptr %slot.name, align 8, !dbg !204
  %slot.default_value = alloca i64, align 8, !dbg !204
  store i64 %p1, ptr %slot.default_value, align 8, !dbg !204
  %r0 = load i64, ptr %slot.name, align 8, !dbg !205
  %r1 = load i64, ptr %slot.default_value, align 8, !dbg !205
  %r2 = call i64 @ec_get_int(i64 %r0, i64 %r1), !dbg !205
  ret i64 %r2, !dbg !205
}

; ESCAPE ce_get_bool: allocs=0 escape=0 local=0
define i64 @ce_get_bool(i64 %p0, i64 %p1) nounwind uwtable !dbg !206 {
entry:
  %slot.name = alloca i64, align 8, !dbg !207
  store i64 %p0, ptr %slot.name, align 8, !dbg !207
  %slot.default_value = alloca i64, align 8, !dbg !207
  store i64 %p1, ptr %slot.default_value, align 8, !dbg !207
  %r0 = load i64, ptr %slot.name, align 8, !dbg !208
  %r1 = load i64, ptr %slot.default_value, align 8, !dbg !208
  %r2 = call i64 @ec_get_bool(i64 %r0, i64 %r1), !dbg !208
  ret i64 %r2, !dbg !208
}

; ESCAPE ce_require: allocs=0 escape=0 local=0
define i64 @ce_require(i64 %p0) nounwind uwtable !dbg !209 {
entry:
  %slot.name = alloca i64, align 8, !dbg !210
  store i64 %p0, ptr %slot.name, align 8, !dbg !210
  %r0 = load i64, ptr %slot.name, align 8, !dbg !211
  %r1 = call i64 @ec_require(i64 %r0), !dbg !211
  ret i64 %r1, !dbg !211
}

; ESCAPE ce_prefix: allocs=0 escape=0 local=0
define i64 @ce_prefix(i64 %p0, i64 %p1) nounwind uwtable !dbg !212 {
entry:
  %slot.prefix = alloca i64, align 8, !dbg !213
  store i64 %p0, ptr %slot.prefix, align 8, !dbg !213
  %slot.candidate_keys = alloca i64, align 8, !dbg !213
  store i64 %p1, ptr %slot.candidate_keys, align 8, !dbg !213
  %r0 = load i64, ptr %slot.prefix, align 8, !dbg !214
  %r1 = load i64, ptr %slot.candidate_keys, align 8, !dbg !214
  %r2 = call i64 @ec_prefix(i64 %r0, i64 %r1), !dbg !214
  ret i64 %r2, !dbg !214
}

; ESCAPE ce_is_set: allocs=0 escape=0 local=0
define i64 @ce_is_set(i64 %p0) nounwind uwtable !dbg !215 {
entry:
  %slot.name = alloca i64, align 8, !dbg !216
  store i64 %p0, ptr %slot.name, align 8, !dbg !216
  %r0 = load i64, ptr %slot.name, align 8, !dbg !217
  %r1 = call i64 @nova_rt_env(i64 %r0), !dbg !217
  %r2 = call i64 @nova_rt_len_any(i64 %r1), !dbg !217
  %r3 = add i64 0, 0, !dbg !217
  %r4.cmp = icmp sgt i64 %r2, %r3, !dbg !217
  %r4 = zext i1 %r4.cmp to i64, !dbg !217
  ret i64 %r4, !dbg !217
}

; ESCAPE nova_user_main: allocs=0 escape=0 local=0
define i64 @nova_user_main() nounwind uwtable !dbg !218 {
entry:
  %r0.p = getelementptr inbounds [25 x i8], ptr @.str.6, i64 0, i64 0, !dbg !220
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !220
  %r1 = call i64 @nova_rt_print_str(i64 %r0), !dbg !220
  ret i64 %r1, !dbg !220
}
...
@.str.5 = private unnamed_addr constant [27 x i8] c"missing required env var: \00"
@.str.6 = private unnamed_addr constant [25 x i8] c"config env module loaded\00"
...
!101 = !DIFile(filename: "std/config/env.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "ce_get", scope: !101, file: !101, line: 53, type: !104, scopeLine: 53, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 53, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "ce_get_int", scope: !101, file: !101, line: 57, type: !104, scopeLine: 57, spFlags: DISPFlagDefinition, unit: !100)
!204 = !DILocation(line: 57, column: 0, scope: !203)
!206 = distinct !DISubprogram(name: "ce_get_bool", scope: !101, file: !101, line: 61, type: !104, scopeLine: 61, spFlags: DISPFlagDefinition, unit: !100)
!207 = !DILocation(line: 61, column: 0, scope: !206)
!209 = distinct !DISubprogram(name: "ce_require", scope: !101, file: !101, line: 66, type: !104, scopeLine: 66, spFlags: DISPFlagDefinition, unit: !100)
!210 = !DILocation(line: 66, column: 0, scope: !209)
!212 = distinct !DISubprogram(name: "ce_prefix", scope: !101, file: !101, line: 73, type: !104, scopeLine: 73, spFlags: DISPFlagDefinition, unit: !100)
!213 = !DILocation(line: 73, column: 0, scope: !212)
!215 = distinct !DISubprogram(name: "ce_is_set", scope: !101, file: !101, line: 79, type: !104, scopeLine: 79, spFlags: DISPFlagDefinition, unit: !100)
!216 = !DILocation(line: 79, column: 0, scope: !215)
!218 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 82, type: !104, scopeLine: 82, spFlags: DISPFlagDefinition, unit: !100)
!219 = !DILocation(line: 82, column: 0, scope: !218)
!202 = !DILocation(line: 54, column: 0, scope: !200)
!205 = !DILocation(line: 58, column: 0, scope: !203)
!208 = !DILocation(line: 62, column: 0, scope: !206)
!211 = !DILocation(line: 67, column: 0, scope: !209)
!214 = !DILocation(line: 74, column: 0, scope: !212)
!217 = !DILocation(line: 80, column: 0, scope: !215)
!220 = !DILocation(line: 83, column: 0, scope: !218)
