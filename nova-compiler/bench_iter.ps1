...
$src = "test_programs\iter_bench.nova"
$ll = "test_programs\output\iter_bench.ll"
$exe = "test_programs\output\iter_bench.exe"
...
Write-Host "iter_bench times (ms): $($times -join ', ')"
