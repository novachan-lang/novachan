...
then0:
  %r3.p = getelementptr inbounds [8 x i8], ptr @.str.0, i64 0, i64 0
...
else1:
  br label %endif2
endif2:
  %r12.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
...
entry:
  ...
  %r1.p = getelementptr inbounds [4 x i8], ptr @.str.3, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2.p = getelementptr inbounds [4 x i8], ptr @.str.4, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [8 x i8] c"found: \00"
@.str.1 = private unnamed_addr constant [1 x i8] c"\00"
@.str.2 = private unnamed_addr constant [5 x i8] c"done\00"
@.str.3 = private unnamed_addr constant [4 x i8] c"foo\00"
@.str.4 = private unnamed_addr constant [4 x i8] c"bar\00"
