...
while_body22:
  ...
  %r43 = call i64 @nova_rt_add(i64 %r39, i64 %r42)
...
while_body31:
  ...
  %r78 = add i64 1, 0
  %r79 = call i64 @nova_rt_add(i64 %r77, i64 %r78)
...
then42:
  ...
  %r127 = add i64 1, 0
  %r128 = call i64 @nova_rt_add(i64 %r126, i64 %r127)
...
entry:
  ...
  br label %for_hdr45
for_hdr45:
  %r8 = load i64, ptr %slot.__for_idx_45, align 8
  %r9.cmp = icmp slt i64 %r8, %r7
  %r9 = zext i1 %r9.cmp to i64
  %br_for_body46 = icmp ne i64 %r9, 0
...
for_body46:
  ...
  %r11 = load i64, ptr %slot.__for_idx_45, align 8
  %r12 = add i64 1, 0
  %r13 = add i64 %r11, %r12
  store i64 %r13, ptr %slot.__for_idx_45, align 8
  br label %for_hdr45
for_exit47:
  ret i64 0
}
