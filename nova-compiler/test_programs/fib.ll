...
define i64 @fib(i64 %p0) nounwind !dbg !200 {
entry:
  %slot.n = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.n, align 8, !dbg !201
  %r0 = load i64, ptr %slot.n, align 8, !dbg !202
  %r1 = add i64 1, 0, !dbg !202
  %r2.cmp = icmp sle i64 %r0, %r1, !dbg !202
  %r2 = zext i1 %r2.cmp to i64, !dbg !202
  %br_then0 = icmp ne i64 %r2, 0, !dbg !202
  br i1 %br_then0, label %then0, label %else1, !dbg !202
then0:
  %r3 = load i64, ptr %slot.n, align 8, !dbg !203
  ret i64 %r3, !dbg !203
else1:
  br label %endif2, !dbg !203
endif2:
  %r4 = load i64, ptr %slot.n, align 8, !dbg !204
  %r5 = add i64 1, 0, !dbg !204
  %r6 = sub i64 %r4, %r5, !dbg !204
  %r7 = call i64 @fib(i64 %r6), !dbg !204
  %r8 = load i64, ptr %slot.n, align 8, !dbg !204
  %r9 = add i64 2, 0, !dbg !204
  %r10 = sub i64 %r8, %r9, !dbg !204
  %r11 = call i64 @fib(i64 %r10), !dbg !204
  %r12 = add i64 %r7, %r11, !dbg !204
  ret i64 %r12, !dbg !204
}
...
entry:
  ...
  %r2 = call i64 @nova_rt_print_int(i64 %r1)
  %r3 = add i64 20, 0
  %r4 = call i64 @fib(i64 %r3)
  %r5 = call i64 @nova_rt_print_int(i64 %r4)
  %r6 = add i64 30, 0
  %r7 = call i64 @fib(i64 %r6)
  %r8 = call i64 @nova_rt_print_int(i64 %r7)
  ret i64 0
}
...
!101 = !DIFile(filename: "fib.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "fib", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
