...
entry:
  ...
  %r6.p = getelementptr inbounds [3 x i8], ptr @.str.3, i64 0, i64 0
  %r6 = ptrtoint ptr %r6.p to i64
  %r7 = call i64 @nova_rt_str_concat(i64 %r5, i64 %r6)
  store i64 %r7, ptr %slot.x, align 8
...
@.str.1 = private unnamed_addr constant [5 x i8] c" = \22\00"
@.str.2 = private unnamed_addr constant [6 x i8] c"world\00"
@.str.3 = private unnamed_addr constant [3 x i8] c"\22\0A\00"
