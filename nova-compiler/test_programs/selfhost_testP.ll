...
entry:
  ...
  br label %for_hdr12
for_hdr12:
  %r13 = load i64, ptr %slot.__for_idx_12, align 8
  %r14.cmp = icmp slt i64 %r13, %r12
  %r14 = zext i1 %r14.cmp to i64
  %br_for_body13 = icmp ne i64 %r14, 0
  br i1 %br_for_body13, label %for_body13, label %for_exit14
for_body13:
  %r15 = call i64 @nova_rt_index_get(i64 %r11, i64 %r13)
  store i64 %r15, ptr %slot.line, align 8
  %r16 = load i64, ptr %slot.line, align 8
  %r17 = call i64 @nova_rt_len_any(i64 %r16)
  %r18 = add i64 0, 0
  %r19.cmp = icmp sgt i64 %r17, %r18
  %r19 = zext i1 %r19.cmp to i64
  %br_then15 = icmp ne i64 %r19, 0
  br i1 %br_then15, label %then15, label %else16
then15:
  %r20 = load i64, ptr %slot.line, align 8
  %r21 = call i64 @nova_rt_print_any(i64 %r20)
  br label %endif17
else16:
  br label %endif17
endif17:
  %r22 = load i64, ptr %slot.__for_idx_12, align 8
  %r23 = add i64 1, 0
  %r24 = add i64 %r22, %r23
  store i64 %r24, ptr %slot.__for_idx_12, align 8
  br label %for_hdr12
for_exit14:
  ret i64 0
}
