...
define i64 @first(i64 %p0) nounwind !dbg !200 {
entry:
  ...
  %r2 = load i64, ptr %r2.ep, align 8, !tbaa !4, !dbg !202
  ret i64 %r2, !dbg !202
}

define i64 @nova_user_main() nounwind !dbg !203 {
entry:
  %slot.nums = alloca i64, align 8, !dbg !204
  store i64 0, ptr %slot.nums, align 8, !dbg !204
  %slot.strs = alloca i64, align 8, !dbg !204
  store i64 0, ptr %slot.strs, align 8, !dbg !204
  %slot.r1 = alloca i64, align 8, !dbg !204
  store i64 0, ptr %slot.r1, align 8, !dbg !204
  %slot.r2 = alloca i64, align 8, !dbg !204
  store i64 0, ptr %slot.r2, align 8, !dbg !204
  %r1 = add i64 42, 0, !dbg !205
  %r2 = add i64 99, 0, !dbg !205
  %r0 = call i64 @nova_rt_list_create(), !dbg !205
  call i64 @nova_rt_list_append(i64 %r0, i64 %r1), !dbg !205
  call i64 @nova_rt_list_append(i64 %r0, i64 %r2), !dbg !205
  store i64 %r0, ptr %slot.nums, align 8, !dbg !205
  %r4.p = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0, !dbg !206
  %r4 = ptrtoint ptr %r4.p to i64, !dbg !206
  %r5.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0, !dbg !206
  %r5 = ptrtoint ptr %r5.p to i64, !dbg !206
  %r3 = call i64 @nova_rt_list_create(), !dbg !206
  call i64 @nova_rt_list_append(i64 %r3, i64 %r4), !dbg !206
  call i64 @nova_rt_list_append(i64 %r3, i64 %r5), !dbg !206
  store i64 %r3, ptr %slot.strs, align 8, !dbg !206
  %r6 = add i64 %r0, 0, !dbg !207
  %r7 = call i64 @first(i64 %r6), !dbg !207
  store i64 %r7, ptr %slot.r1, align 8, !dbg !207
  %r8 = add i64 %r3, 0, !dbg !208
  %r9 = call i64 @first(i64 %r8), !dbg !208
  store i64 %r9, ptr %slot.r2, align 8, !dbg !208
  %r10 = add i64 %r7, 0, !dbg !209
  %r11 = call i64 @nova_rt_int_to_str(i64 %r10), !dbg !209
  %r12 = call i64 @nova_rt_print_str(i64 %r11), !dbg !209
  %r13 = add i64 %r9, 0, !dbg !210
  %r14 = call i64 @nova_rt_int_to_str(i64 %r13), !dbg !210
  %r15 = call i64 @nova_rt_print_str(i64 %r14), !dbg !210
  ret i64 %r15, !dbg !210
}
...
!101 = !DIFile(filename: "poly_simple.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "first", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 1, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 4, type: !104, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !100)
!204 = !DILocation(line: 4, column: 0, scope: !203)
!202 = !DILocation(line: 2, column: 0, scope: !200)
!205 = !DILocation(line: 5, column: 0, scope: !203)
!206 = !DILocation(line: 6, column: 0, scope: !203)
!207 = !DILocation(line: 7, column: 0, scope: !203)
!208 = !DILocation(line: 8, column: 0, scope: !203)
!209 = !DILocation(line: 9, column: 0, scope: !203)
!210 = !DILocation(line: 10, column: 0, scope: !203)
