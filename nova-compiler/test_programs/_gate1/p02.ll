...
entry:
  ...
  %slot.height = alloca i64, align 8
  store i64 0, ptr %slot.height, align 8
  %slot.is_student = alloca i64, align 8
  store i64 0, ptr %slot.is_student, align 8
  %slot.radius = alloca i64, align 8
  store i64 0, ptr %slot.radius, align 8
  %slot.area = alloca i64, align 8
  store i64 0, ptr %slot.area, align 8
  ...
  %r1 = add i64 30, 0
  store i64 %r1, ptr %slot.age, align 8
  %r2 = add i64 4610560118520545280, 0
  store i64 %r2, ptr %slot.height, align 8
  %r3 = add i64 0, 0
  store i64 %r3, ptr %slot.is_student, align 8
  %r4 = add i64 4617315517961601024, 0
  store i64 %r4, ptr %slot.radius, align 8
  %r5 = add i64 4614256650576692846, 0
  %r6 = load i64, ptr %slot.radius, align 8
  %r7 = add i64 2, 0
  %r8 = call i64 @nova_rt_pow(i64 %r6, i64 %r7)
  %r9.af = bitcast i64 %r5 to double
  %r9.bf = bitcast i64 %r8 to double
  %r9.rf = fmul double %r9.af, %r9.bf
  %r9 = bitcast double %r9.rf to i64
  store i64 %r9, ptr %slot.area, align 8
  %r10.p = getelementptr inbounds [8 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %r14.p = getelementptr inbounds [11 x i8], ptr @.str.2, i64 0, i64 0
  %r14 = ptrtoint ptr %r14.p to i64
  %r15 = call i64 @nova_rt_str_concat(i64 %r13, i64 %r14)
  call i64 @nova_rt_rc_drop_temp(i64 %r13)
  %r16 = load i64, ptr %slot.age, align 8
  %r17 = call i64 @nova_rt_any_to_str(i64 %r16)
  %r18 = call i64 @nova_rt_str_concat(i64 %r15, i64 %r17)
  call i64 @nova_rt_rc_drop_temp(i64 %r15)
  %r19.p = getelementptr inbounds [12 x i8], ptr @.str.3, i64 0, i64 0
  %r19 = ptrtoint ptr %r19.p to i64
  %r20 = call i64 @nova_rt_str_concat(i64 %r18, i64 %r19)
  call i64 @nova_rt_rc_drop_temp(i64 %r18)
  %frcold.greeting0 = load i64, ptr %slot.greeting, align 8
  call i64 @nova_rt_rc_drop_reassign(i64 %frcold.greeting0, i64 %r20)
  store i64 %r20, ptr %slot.greeting, align 8
  %r21 = load i64, ptr %slot.greeting, align 8
  %r22 = call i64 @nova_rt_print_str(i64 %r21)
  %r24 = add i64 1, 0
  %r25 = add i64 2, 0
  %r26 = add i64 3, 0
  %r27 = add i64 4, 0
  ...
  call i64 @nova_rt_list_append(i64 %r23, i64 %r24)
  call i64 @nova_rt_list_append(i64 %r23, i64 %r25)
  call i64 @nova_rt_list_append(i64 %r23, i64 %r26)
  call i64 @nova_rt_list_append(i64 %r23, i64 %r27)
  call i64 @nova_rt_list_append(i64 %r23, i64 %r28)
  %frcold.items1 = load i64, ptr %slot.items, align 8
  call i64 @nova_rt_rc_drop_reassign(i64 %frcold.items1, i64 %r23)
  store i64 %r23, ptr %slot.items, align 8
  %r29 = load i64, ptr %slot.items, align 8
  %r30 = call i64 @nova_rt_sum(i64 %r29)
  store i64 %r30, ptr %slot.total, align 8
  %r31 = load i64, ptr %slot.items, align 8
  %r32.ptr = call ptr @nova_rt_struct_alloc(i64 8)
  %r32.tgep = getelementptr i64, ptr %r32.ptr, i64 0
  %r32.tfn = ptrtoint ptr @__tramp_0 to i64
  store i64 %r32.tfn, ptr %r32.tgep, align 8
  %r32 = ptrtoint ptr %r32.ptr to i64
  %r33 = call i64 @nova_rt_list_map(i64 %r31, i64 %r32)
  store i64 %r33, ptr %slot.doubled, align 8
  %r34.p = getelementptr inbounds [6 x i8], ptr @.str.4, i64 0, i64 0
  %r34 = ptrtoint ptr %r34.p to i64
  %r35 = load i64, ptr %slot.total, align 8
  %r36 = call i64 @nova_rt_any_to_str(i64 %r35)
  %r37 = call i64 @nova_rt_str_concat(i64 %r34, i64 %r36)
  %r38.p = getelementptr inbounds [12 x i8], ptr @.str.5, i64 0, i64 0
  %r38 = ptrtoint ptr %r38.p to i64
  %r39 = call i64 @nova_rt_str_concat(i64 %r37, i64 %r38)
  call i64 @nova_rt_rc_drop_temp(i64 %r37)
  %r40 = load i64, ptr %slot.doubled, align 8
  %r41 = call i64 @nova_rt_any_to_str(i64 %r40)
  %r42 = call i64 @nova_rt_str_concat(i64 %r39, i64 %r41)
  call i64 @nova_rt_rc_drop_temp(i64 %r39)
  %r43.p = getelementptr inbounds [1 x i8], ptr @.str.6, i64 0, i64 0
  %r43 = ptrtoint ptr %r43.p to i64
  %r44 = call i64 @nova_rt_str_concat(i64 %r42, i64 %r43)
  call i64 @nova_rt_rc_drop_temp(i64 %r42)
  %r45 = call i64 @nova_rt_print_str(i64 %r44)
  ret i64 0
}

; ESCAPE __lambda_0: allocs=0 escape=0 local=0
define i64 @__lambda_0(i64 %p0) nounwind uwtable {
entry:
  %slot.x = alloca i64, align 8
  store i64 %p0, ptr %slot.x, align 8
  %r0 = load i64, ptr %slot.x, align 8
  %r1 = add i64 2, 0
  %r2 = call i64 @nova_rt_mul(i64 %r0, i64 %r1)
  ret i64 %r2
}

; ESCAPE SUMMARY: allocs=1 escape=0 local=1 (100% local, RC-elidable)
...
@.str.2 = private unnamed_addr constant [11 x i8] c"! You are \00"
@.str.3 = private unnamed_addr constant [12 x i8] c" years old.\00"
@.str.4 = private unnamed_addr constant [6 x i8] c"Sum: \00"
@.str.5 = private unnamed_addr constant [12 x i8] c", Doubled: \00"
