...
entry:
  ...
  %r2 = add i64 1, 0
  store i64 %r2, ptr %slot.col, align 8
  %r3 = add i64 1, 0
  store i64 %r3, ptr %slot.line, align 8
  br label %while_hdr0, !llvm.loop !91
while_hdr0:
  %r4 = load i64, ptr %slot.i, align 8
  %r5 = load i64, ptr %slot.src, align 8
...
then3:
  %r14 = load i64, ptr %slot.line, align 8
  %r15 = add i64 1, 0
  %r16 = add i64 %r14, %r15
  store i64 %r16, ptr %slot.line, align 8
  %r17 = add i64 1, 0
  store i64 %r17, ptr %slot.col, align 8
...
while_exit2:
  ...
  %r29 = load i64, ptr %slot.line, align 8
