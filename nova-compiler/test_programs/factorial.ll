...
define i64 @factorial(i64 %p0) nounwind !dbg !200 {
entry:
...
then0:
  %r3 = add i64 1, 0, !dbg !203
  ret i64 %r3, !dbg !203
else1:
  br label %endif2, !dbg !203
endif2:
  %r4 = load i64, ptr %slot.n, align 8, !dbg !204
  %r5 = load i64, ptr %slot.n, align 8, !dbg !204
  %r6 = add i64 1, 0, !dbg !204
  %r7 = sub i64 %r5, %r6, !dbg !204
  %r8 = call i64 @factorial(i64 %r7), !dbg !204
  %r9 = mul i64 %r4, %r8, !dbg !204
  ret i64 %r9, !dbg !204
}
...
!101 = !DIFile(filename: "factorial.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "factorial", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
