...
entry:
  ...
  %r8.p = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0
  ...
  %r16.p = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0
  %r16 = ptrtoint ptr %r16.p to i64
  %r17 = call i64 @nova_rt_contains(i64 %r15, i64 %r16)
  %r18 = call i64 @nova_rt_print_bool(i64 %r17)
  %r19 = load i64, ptr %slot.d, align 8
  %r20.p = getelementptr inbounds [2 x i8], ptr @.str.2, i64 0, i64 0
  %r20 = ptrtoint ptr %r20.p to i64
  %r21 = call i64 @nova_rt_contains(i64 %r19, i64 %r20)
  %r22 = call i64 @nova_rt_print_bool(i64 %r21)
  ret i64 0
}
