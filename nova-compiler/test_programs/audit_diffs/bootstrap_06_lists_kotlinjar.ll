...
while_exit3:
  %r49 = load i64, ptr %slot.total, align 8
  %t19 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t19, i64 %r49)
  %t20 = load i64, ptr %slot.nums, align 8
