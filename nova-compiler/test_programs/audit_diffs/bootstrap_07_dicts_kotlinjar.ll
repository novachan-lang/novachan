...
entry0:
  ...
  %t1 = call i64 @nova_rt_dict_set(i64 %r1, i64 %r7, i64 10)
  %t2 = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0
  %r12 = ptrtoint ptr %t2 to i64
  %t3 = call i64 @nova_rt_dict_set(i64 %r1, i64 %r12, i64 20)
  %t4 = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0
  %r16 = ptrtoint ptr %t4 to i64
  %r17 = call i64 @nova_rt_dict_get(i64 %r1, i64 %r16)
  %t5 = call i64 @nova_rt_any_to_str(i64 %r17)
  %t6 = inttoptr i64 %t5 to ptr
  call i32 @puts(ptr %t6)
  %t7 = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0
  %r20 = ptrtoint ptr %t7 to i64
  %r21 = call i64 @nova_rt_dict_get(i64 %r1, i64 %r20)
  %t8 = call i64 @nova_rt_any_to_str(i64 %r21)
  %t9 = inttoptr i64 %t8 to ptr
  call i32 @puts(ptr %t9)
  %t10 = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0
  %r24 = ptrtoint ptr %t10 to i64
  %r25 = call i64 @nova_rt_contains(i64 %r1, i64 %r24)
  %t11 = icmp ne i64 %r25, 0
  %t12 = getelementptr inbounds [5 x i8], ptr @.str.6, i64 0, i64 0
  %t13 = getelementptr inbounds [6 x i8], ptr @.str.7, i64 0, i64 0
  %t14 = select i1 %t11, ptr %t12, ptr %t13
  call i32 @puts(ptr %t14)
  %t15 = getelementptr inbounds [2 x i8], ptr @.str.2, i64 0, i64 0
  %r28 = ptrtoint ptr %t15 to i64
  %r29 = call i64 @nova_rt_contains(i64 %r1, i64 %r28)
  call void @nova_rc_dec(i64 %r1)
  %t16 = icmp ne i64 %r29, 0
  %t17 = getelementptr inbounds [5 x i8], ptr @.str.6, i64 0, i64 0
  %t18 = getelementptr inbounds [6 x i8], ptr @.str.7, i64 0, i64 0
