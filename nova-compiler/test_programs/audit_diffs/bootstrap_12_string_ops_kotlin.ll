...
then0:
  %r7.p = getelementptr inbounds [6 x i8], ptr @.str.2, i64 0, i64 0
...
endif2:
  ...
  store i64 %r27, ptr %slot.msg, align 8
  %r28 = load i64, ptr %slot.msg, align 8
...
@.str.4 = private unnamed_addr constant [11 x i8] c"number is \00"
