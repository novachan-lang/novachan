...
entry:
  ...
  store i64 %r0, ptr %slot.greeting, align 8
  %r1.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  store i64 %r1, ptr %slot.name, align 8
  %r2 = load i64, ptr %slot.greeting, align 8
  ...
  store i64 %r6, ptr %slot.msg, align 8
  %r7 = load i64, ptr %slot.msg, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = load i64, ptr %slot.msg, align 8
