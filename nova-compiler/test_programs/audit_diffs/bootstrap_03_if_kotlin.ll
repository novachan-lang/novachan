...
then0:
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.0, i64 0, i64 0
...
then3:
  %r11.p = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
...
@.str.2 = private unnamed_addr constant [4 x i8] c"ten\00"
