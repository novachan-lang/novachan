...
entry:
  ...
  %r5.p = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0
  ...
  %r11.p = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [6 x i8] c"val: \00"
