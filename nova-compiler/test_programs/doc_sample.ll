...
define i64 @add(i64 %p0, i64 %p1) nounwind !dbg !200 {
entry:
...
define i64 @subtract(i64 %p0, i64 %p1) nounwind !dbg !201 {
entry:
  %slot.a = alloca i64, align 8
  store i64 %p0, ptr %slot.a, align 8
  %slot.b = alloca i64, align 8
...
define i64 @distance(i64 %p0, i64 %p1) nounwind !dbg !202 {
entry:
  %slot.p1 = alloca i64, align 8
  store i64 %p0, ptr %slot.p1, align 8
  %slot.p2 = alloca i64, align 8
  store i64 %p1, ptr %slot.p2, align 8
  %r0 = load i64, ptr %slot.p1, align 8
  %r1.ptr = inttoptr i64 %r0 to ptr
  %r1.gep = getelementptr i64, ptr %r1.ptr, i64 1
  %r1 = load i64, ptr %r1.gep, align 8
  %r2 = load i64, ptr %slot.p2, align 8
  %r3.ptr = inttoptr i64 %r2 to ptr
  %r3.gep = getelementptr i64, ptr %r3.ptr, i64 1
  %r3 = load i64, ptr %r3.gep, align 8
  %r4 = sub i64 %r1, %r3
  %r5 = call i64 @nova_rt_abs(i64 %r4)
  ...
  %r8 = load i64, ptr %slot.p2, align 8
  %r9.ptr = inttoptr i64 %r8 to ptr
  %r9.gep = getelementptr i64, ptr %r9.ptr, i64 2
  %r9 = load i64, ptr %r9.gep, align 8
  %r10 = sub i64 %r7, %r9
  %r11 = call i64 @nova_rt_abs(i64 %r10)
  %r12 = call i64 @nova_rt_add(i64 %r5, i64 %r11)
  ret i64 %r12
}

define i64 @helper() nounwind !dbg !203 {
entry:
  %r0.p = getelementptr inbounds [15 x i8], ptr @.str.0, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = call i64 @nova_rt_print_str(i64 %r0)
  ret i64 %r1
}

define i64 @greet(i64 %p0) nounwind !dbg !204 {
entry:
  %slot.name = alloca i64, align 8
  store i64 %p0, ptr %slot.name, align 8
  %r0.p = getelementptr inbounds [8 x i8], ptr @.str.1, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = load i64, ptr %slot.name, align 8
  %r2 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r1)
  %r3.p = getelementptr inbounds [2 x i8], ptr @.str.2, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r4 = call i64 @nova_rt_str_concat(i64 %r2, i64 %r3)
  ret i64 %r4
}

define i64 @factorial(i64 %p0) nounwind !dbg !205 {
entry:
...
entry:
  ...
  %r3 = add i64 10, 0
  %r4 = add i64 20, 0
  %r5 = call i64 @add(i64 %r3, i64 %r4)
  %r6 = call i64 @nova_rt_print_int(i64 %r5)
  %r7.p = getelementptr inbounds [5 x i8], ptr @.str.3, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @greet(i64 %r7)
  %r9 = call i64 @nova_rt_print_str(i64 %r8)
  %r10 = add i64 5, 0
  %r11 = call i64 @factorial(i64 %r10)
...
; String constants
@.str.0 = private unnamed_addr constant [15 x i8] c"no doc comment\00"
...
!101 = !DIFile(filename: "doc_sample.nova", directory: ".")
!102 = !{i32 7, !"Dwarf Version", i32 4}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "add", scope: !101, file: !101, line: 3, type: !104, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !100)
!201 = distinct !DISubprogram(name: "subtract", scope: !101, file: !101, line: 7, type: !104, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !100)
!202 = distinct !DISubprogram(name: "distance", scope: !101, file: !101, line: 17, type: !104, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !100)
!203 = distinct !DISubprogram(name: "helper", scope: !101, file: !101, line: 27, type: !104, scopeLine: 27, spFlags: DISPFlagDefinition, unit: !100)
!204 = distinct !DISubprogram(name: "greet", scope: !101, file: !101, line: 32, type: !104, scopeLine: 32, spFlags: DISPFlagDefinition, unit: !100)
!205 = distinct !DISubprogram(name: "factorial", scope: !101, file: !101, line: 36, type: !104, scopeLine: 36, spFlags: DISPFlagDefinition, unit: !100)
!206 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 43, type: !104, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !100)
