...
entry:
  ...
  %r4.p = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = load i64, ptr %slot.config, align 8
  %r6.p = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %r13.p = getelementptr inbounds [5 x i8], ptr @.str.4, i64 0, i64 0
...
@.str.2 = private unnamed_addr constant [8 x i8] c"host = \00"
