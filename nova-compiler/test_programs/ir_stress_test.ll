...
while_body25:
  ...
  %r14 = call i64 @nova_rt_add(i64 %r10, i64 %r13)
...
entry:
  ...
  %r21 = call i64 @nova_rt_add(i64 %r17, i64 %r20)
  ...
  %r33 = call i64 @nova_rt_add(i64 %r29, i64 %r32)
  ...
  %r39 = call i64 @nova_rt_add(i64 %r35, i64 %r38)
  ...
  %r45 = call i64 @nova_rt_add(i64 %r41, i64 %r44)
...
endif38:
  ...
  %r96 = add i64 1, 0
  %r97 = call i64 @nova_rt_add(i64 %r95, i64 %r96)
...
while_exit35:
  ...
  %r101 = call i64 @nova_rt_add(i64 %r98, i64 %r100)
