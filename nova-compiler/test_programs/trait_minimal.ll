...
entry:
  %r0.p = getelementptr inbounds [3 x i8], ptr @.str.0, i64 0, i64 0, !dbg !202
...
!101 = !DIFile(filename: "trait_minimal.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 4, type: !104, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 4, column: 0, scope: !200)
!202 = !DILocation(line: 5, column: 0, scope: !200)
