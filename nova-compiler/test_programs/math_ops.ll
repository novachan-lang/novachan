...
define i64 @maxOf(i64 %p0, i64 %p1) nounwind !dbg !200 {
entry:
  ...
  %r1 = load i64, ptr %slot.b, align 8, !dbg !202
  %r2.cmp = icmp sgt i64 %r0, %r1, !dbg !202
  %r2 = zext i1 %r2.cmp to i64, !dbg !202
  %br_retthen0 = icmp ne i64 %r2, 0, !dbg !202
  br i1 %br_retthen0, label %retthen0, label %retelse1, !dbg !202
retthen0:
  %r3 = load i64, ptr %slot.a, align 8, !dbg !203
  ret i64 %r3, !dbg !203
retelse1:
  %r4 = load i64, ptr %slot.b, align 8, !dbg !204
  ret i64 %r4, !dbg !204
}

define i64 @minOf(i64 %p0, i64 %p1) nounwind !dbg !205 {
entry:
  %slot.a = alloca i64, align 8, !dbg !206
  store i64 %p0, ptr %slot.a, align 8, !dbg !206
  %slot.b = alloca i64, align 8, !dbg !206
  store i64 %p1, ptr %slot.b, align 8, !dbg !206
  %r0 = load i64, ptr %slot.a, align 8, !dbg !207
  %r1 = load i64, ptr %slot.b, align 8, !dbg !207
  %r2.cmp = icmp slt i64 %r0, %r1, !dbg !207
  %r2 = zext i1 %r2.cmp to i64, !dbg !207
  %br_retthen2 = icmp ne i64 %r2, 0, !dbg !207
  br i1 %br_retthen2, label %retthen2, label %retelse3, !dbg !207
retthen2:
  %r3 = load i64, ptr %slot.a, align 8, !dbg !208
  ret i64 %r3, !dbg !208
retelse3:
  %r4 = load i64, ptr %slot.b, align 8, !dbg !209
  ret i64 %r4, !dbg !209
}

define i64 @absVal(i64 %p0) nounwind !dbg !210 {
entry:
  %slot.x = alloca i64, align 8, !dbg !211
  store i64 %p0, ptr %slot.x, align 8, !dbg !211
  %r0 = load i64, ptr %slot.x, align 8, !dbg !212
  %r1 = add i64 0, 0, !dbg !212
  %r2.cmp = icmp slt i64 %r0, %r1, !dbg !212
  %r2 = zext i1 %r2.cmp to i64, !dbg !212
  %br_retthen4 = icmp ne i64 %r2, 0, !dbg !212
  br i1 %br_retthen4, label %retthen4, label %retelse5, !dbg !212
retthen4:
  %r3 = load i64, ptr %slot.x, align 8, !dbg !213
  %r4 = sub i64 0, %r3, !dbg !213
  ret i64 %r4, !dbg !213
retelse5:
  %r5 = load i64, ptr %slot.x, align 8, !dbg !214
  ret i64 %r5, !dbg !214
}
...
entry:
  %r0 = add i64 10, 0
  %r1 = add i64 20, 0
  %r2 = call i64 @maxOf(i64 %r0, i64 %r1)
  %r3 = call i64 @nova_rt_print_int(i64 %r2)
  %r4 = add i64 10, 0
  %r5 = add i64 20, 0
  %r6 = call i64 @minOf(i64 %r4, i64 %r5)
  %r7 = call i64 @nova_rt_print_int(i64 %r6)
  %r8 = add i64 42, 0
  %r9 = sub i64 0, %r8
  %r10 = call i64 @absVal(i64 %r9)
  %r11 = call i64 @nova_rt_print_int(i64 %r10)
  %r12 = add i64 3, 0
  %r13 = add i64 4, 0
  %r14 = add i64 5, 0
  %r15 = mul i64 %r13, %r14
  %r16 = add i64 %r12, %r15
  %r17 = call i64 @nova_rt_print_int(i64 %r16)
  %r18 = add i64 100, 0
  %r19 = add i64 3, 0
  %r20 = sdiv i64 %r18, %r19
  %r21 = call i64 @nova_rt_print_int(i64 %r20)
  %r22 = add i64 100, 0
  %r23 = add i64 7, 0
  %r24 = srem i64 %r22, %r23
  %r25 = call i64 @nova_rt_print_int(i64 %r24)
  ret i64 0
}
...
!101 = !DIFile(filename: "math_ops.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "maxOf", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 1, column: 0, scope: !200)
!205 = distinct !DISubprogram(name: "minOf", scope: !101, file: !101, line: 7, type: !104, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !100)
!206 = !DILocation(line: 7, column: 0, scope: !205)
!210 = distinct !DISubprogram(name: "absVal", scope: !101, file: !101, line: 13, type: !104, scopeLine: 13, spFlags: DISPFlagDefinition, unit: !100)
!211 = !DILocation(line: 13, column: 0, scope: !210)
!202 = !DILocation(line: 2, column: 0, scope: !200)
!203 = !DILocation(line: 3, column: 0, scope: !200)
!204 = !DILocation(line: 5, column: 0, scope: !200)
!207 = !DILocation(line: 8, column: 0, scope: !205)
!208 = !DILocation(line: 9, column: 0, scope: !205)
!209 = !DILocation(line: 11, column: 0, scope: !205)
!212 = !DILocation(line: 14, column: 0, scope: !210)
!213 = !DILocation(line: 15, column: 0, scope: !210)
!214 = !DILocation(line: 17, column: 0, scope: !210)
