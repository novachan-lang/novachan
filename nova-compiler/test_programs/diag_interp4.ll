...
entry:
  ...
  %r3 = load i64, ptr %slot.a, align 8
  %r4 = call i64 @nova_rt_any_to_str(i64 %r3)
  %r5 = call i64 @nova_rt_str_concat(i64 %r2, i64 %r4)
  %r6.p = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %r14.p = getelementptr inbounds [6 x i8], ptr @.str.2, i64 0, i64 0
  %r14 = ptrtoint ptr %r14.p to i64
  store i64 %r14, ptr %slot.name, align 8
  %r15.p = getelementptr inbounds [7 x i8], ptr @.str.3, i64 0, i64 0
  ...
  %r19.p = getelementptr inbounds [1 x i8], ptr @.str.0, i64 0, i64 0
...
@.str.3 = private unnamed_addr constant [7 x i8] c"hello \00"
