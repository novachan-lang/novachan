...
$linkArgs = "-O2 -o `"gen4.exe`" `"nova_compiler.ll`" `"../compiler/nova_runtime.c`" $NovaLinkFlags -D_CRT_SECURE_NO_WARNINGS -w"
...
$linkArgs2 = "-O2 -o `"$Test.exe`" `"$Test.ll`" `"../compiler/nova_runtime.c`" $NovaLinkFlags -D_CRT_SECURE_NO_WARNINGS -w"
