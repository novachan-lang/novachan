...
declare i64 @my_c_mul(i64, i64) nounwind
declare i64 @my_c_factorial(i64) nounwind
...
entry:
  ...
  store i64 0, ptr %slot.p, align 8, !dbg !201
  %slot.f = alloca i64, align 8, !dbg !201
  store i64 0, ptr %slot.f, align 8, !dbg !201
  %r0 = add i64 40, 0, !dbg !202
  %r1 = add i64 2, 0, !dbg !202
  %r2 = call i64 @my_c_add(i64 %r0, i64 %r1), !dbg !202
  store i64 %r2, ptr %slot.s, align 8, !dbg !202
  %r3 = add i64 %r2, 0, !dbg !203
  %r4 = call i64 @nova_rt_print_any(i64 %r3), !dbg !203
  %r5 = add i64 7, 0, !dbg !204
  %r6 = add i64 6, 0, !dbg !204
  %r7 = call i64 @my_c_mul(i64 %r5, i64 %r6), !dbg !204
  store i64 %r7, ptr %slot.p, align 8, !dbg !204
  %r8 = add i64 %r7, 0, !dbg !205
  %r9 = call i64 @nova_rt_print_any(i64 %r8), !dbg !205
  %r10 = add i64 5, 0, !dbg !206
  %r11 = call i64 @my_c_factorial(i64 %r10), !dbg !206
  store i64 %r11, ptr %slot.f, align 8, !dbg !206
...
!101 = !DIFile(filename: "ffi_test.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 7, type: !104, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !100)
