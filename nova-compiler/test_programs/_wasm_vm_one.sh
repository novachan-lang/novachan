...
# results, linked against the FULL value-model runtime (../compiler/nova_runtime_wasm.c under NOVA_FREESTANDING).
...
clang --target=wasm32 -ffreestanding -nostdlib -fno-builtin -O2 -c ../compiler/nova_runtime_wasm.c -o output/nova_runtime_wasm.o 2>/dev/null || { echo "FAIL wasm_vm: runtime wasm compile"; exit 1; }
