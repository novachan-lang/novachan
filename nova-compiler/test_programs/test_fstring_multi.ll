...
entry:
  ...
  %slot.ver = alloca i64, align 8
  store i64 0, ptr %slot.ver, align 8
  ...
  store i64 %r1, ptr %slot.ver, align 8
  %r2 = add i64 1, 0
  %r3 = add i64 1, 0
  %r4.cmp = icmp eq i64 %r2, %r3
  %r4 = zext i1 %r4.cmp to i64
  %br_then0 = icmp ne i64 %r4, 0
  br i1 %br_then0, label %then0, label %else1
then0:
  %r5.p = getelementptr inbounds [10 x i8], ptr @.str.2, i64 0, i64 0
