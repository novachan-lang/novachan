...
$gen5_ll = Build-Gen -Compiler "$base\workerx.exe" -OutputExe "gen5_fidx.exe" -Label "gen5"
$gen6_ll = Build-Gen -Compiler "$base\gen5_fidx.exe" -OutputExe "gen6_fidx.exe" -Label "gen6"
...
if ($hash5 -eq $hash6) {
    ...
    Copy-Item "$base\gen5_fidx.exe" "$base\gen3_test.exe" -Force
