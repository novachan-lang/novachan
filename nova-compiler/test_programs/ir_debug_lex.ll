...
for_body64:
  ...
  store i64 %r16, ptr %slot.__sc_66, align 8
  %br_and_rhs67 = icmp ne i64 %r16, 0
  br i1 %br_and_rhs67, label %and_rhs67, label %and_merge68
and_rhs67:
  %r17 = load i64, ptr %slot.kind, align 8
  %r18.p = getelementptr inbounds [4 x i8], ptr @.str.14, i64 0, i64 0
  %r18 = ptrtoint ptr %r18.p to i64
  %r19 = call i64 @nova_rt_neq(i64 %r17, i64 %r18)
  store i64 %r19, ptr %slot.__sc_66, align 8
  br label %and_merge68
and_merge68:
  %r20 = load i64, ptr %slot.__sc_66, align 8
  %br_then69 = icmp ne i64 %r20, 0
  br i1 %br_then69, label %then69, label %else70
then69:
  %r21 = load i64, ptr %slot.non_nl, align 8
...
endif71:
  ...
  %r25.p = getelementptr inbounds [2 x i8], ptr @.str.16, i64 0, i64 0
  ...
  %r30 = load i64, ptr %slot.__for_idx_63, align 8
  %r31 = add i64 1, 0
  %r32 = add i64 %r30, %r31
  store i64 %r32, ptr %slot.__for_idx_63, align 8
  br label %for_hdr63
for_exit65:
  %r33.p = getelementptr inbounds [8 x i8], ptr @.str.17, i64 0, i64 0
  ...
  %r38.p = getelementptr inbounds [11 x i8], ptr @.str.18, i64 0, i64 0
  %r38 = ptrtoint ptr %r38.p to i64
  %r39 = call i64 @nova_rt_str_concat(i64 %r37, i64 %r38)
  %r40 = load i64, ptr %slot.non_nl, align 8
...
else73:
  ...
  %r55 = call i64 @nova_rt_str_concat(i64 %r51, i64 %r54)
