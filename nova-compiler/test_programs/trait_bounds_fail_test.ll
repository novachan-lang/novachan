...
define i64 @Point__show(i64 %p0) nounwind !dbg !200 {
entry:
  %slot.self = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.self, align 8, !dbg !201
  %r0.p = getelementptr inbounds [2 x i8], ptr @.str.0, i64 0, i64 0, !dbg !202
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !202
  %r1 = load i64, ptr %slot.self, align 8, !dbg !202
  %r2.ptr = inttoptr i64 %r1 to ptr, !dbg !202
  %r2.gep = getelementptr i64, ptr %r2.ptr, i64 1, !dbg !202
  %r2 = load i64, ptr %r2.gep, align 8, !dbg !202
  %r3 = call i64 @nova_rt_int_to_str(i64 %r2), !dbg !202
  %r4 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r3), !dbg !202
  %r5.p = getelementptr inbounds [3 x i8], ptr @.str.1, i64 0, i64 0, !dbg !202
  %r5 = ptrtoint ptr %r5.p to i64, !dbg !202
  %r6 = call i64 @nova_rt_str_concat(i64 %r4, i64 %r5), !dbg !202
  %r7 = load i64, ptr %slot.self, align 8, !dbg !202
  ...
  %r9 = call i64 @nova_rt_int_to_str(i64 %r8), !dbg !202
  %r10 = call i64 @nova_rt_str_concat(i64 %r6, i64 %r9), !dbg !202
  %r11.p = getelementptr inbounds [2 x i8], ptr @.str.2, i64 0, i64 0, !dbg !202
  %r11 = ptrtoint ptr %r11.p to i64, !dbg !202
  %r12 = call i64 @nova_rt_str_concat(i64 %r10, i64 %r11), !dbg !202
  ret i64 %r12, !dbg !202
}

define i64 @display(i64 %p0) nounwind !dbg !203 {
entry:
  %slot.item = alloca i64, align 8, !dbg !204
  store i64 %p0, ptr %slot.item, align 8, !dbg !204
  %r0.p = getelementptr inbounds [6 x i8], ptr @.str.3, i64 0, i64 0, !dbg !205
  %r0 = ptrtoint ptr %r0.p to i64, !dbg !205
  ret i64 %r0, !dbg !205
}

define i64 @nova_user_main() nounwind !dbg !206 {
entry:
  %slot.c = alloca i64, align 8, !dbg !207
  store i64 0, ptr %slot.c, align 8, !dbg !207
  %slot.s = alloca i64, align 8, !dbg !207
  store i64 0, ptr %slot.s, align 8, !dbg !207
  %r0 = add i64 255, 0, !dbg !208
  %r1 = add i64 0, 0, !dbg !208
  %r2 = add i64 0, 0, !dbg !208
  %r3.ptr = call ptr @nova_rt_struct_alloc(i64 32), !dbg !208
  %r3.thash = getelementptr i64, ptr %r3.ptr, i64 0, !dbg !208
  store i64 210671116836, ptr %r3.thash, align 8, !dbg !208
  %r3.f0 = getelementptr i64, ptr %r3.ptr, i64 1, !dbg !208
  store i64 %r0, ptr %r3.f0, align 8, !dbg !208
  %r3.f1 = getelementptr i64, ptr %r3.ptr, i64 2, !dbg !208
  store i64 %r1, ptr %r3.f1, align 8, !dbg !208
  %r3.f2 = getelementptr i64, ptr %r3.ptr, i64 3, !dbg !208
  store i64 %r2, ptr %r3.f2, align 8, !dbg !208
  %r3 = ptrtoint ptr %r3.ptr to i64, !dbg !208
  store i64 %r3, ptr %slot.c, align 8, !dbg !208
  %r4 = add i64 %r3, 0, !dbg !209
  %r5 = call i64 @display(i64 %r4), !dbg !209
  store i64 %r5, ptr %slot.s, align 8, !dbg !209
  %r6 = add i64 %r5, 0, !dbg !210
  %r7 = call i64 @nova_rt_print_str(i64 %r6), !dbg !210
  ret i64 %r7, !dbg !210
}
...
@.str.3 = private unnamed_addr constant [6 x i8] c"shown\00"
...
!101 = !DIFile(filename: "trait_bounds_fail_test.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "Point__show", scope: !101, file: !101, line: 10, type: !104, scopeLine: 10, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 10, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "display", scope: !101, file: !101, line: 18, type: !104, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !100)
!204 = !DILocation(line: 18, column: 0, scope: !203)
!206 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 21, type: !104, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !100)
!207 = !DILocation(line: 21, column: 0, scope: !206)
!202 = !DILocation(line: 11, column: 0, scope: !200)
!205 = !DILocation(line: 19, column: 0, scope: !203)
!208 = !DILocation(line: 22, column: 0, scope: !206)
!209 = !DILocation(line: 23, column: 0, scope: !206)
!210 = !DILocation(line: 24, column: 0, scope: !206)
