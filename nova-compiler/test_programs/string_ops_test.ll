...
entry:
  ...
  %slot.find = alloca i64, align 8
  store i64 0, ptr %slot.find, align 8
...
for_exit5:
  ...
  %r92 = call i64 @nova_rt_eq(i64 %r90, i64 %r91)
  ...
  %r122 = load i64, ptr %slot.find, align 8
  %r121.rec = inttoptr i64 %r122 to ptr
  %r121.fnraw = load i64, ptr %r121.rec, align 8
  %r121.fnptr = inttoptr i64 %r121.fnraw to ptr
  %r121 = call i64 %r121.fnptr(i64 %r122, i64 %r119, i64 %r120)
  store i64 %r121, ptr %slot.idx, align 8
  %r123 = load i64, ptr %slot.idx, align 8
  %r124 = add i64 7, 0
  %r125 = call i64 @nova_rt_eq(i64 %r123, i64 %r124)
  %r126.p = getelementptr inbounds [5 x i8], ptr @.str.31, i64 0, i64 0
  %r126 = ptrtoint ptr %r126.p to i64
  %r127 = call i64 @nova_rt_assert(i64 %r125, i64 %r126)
  %r128 = load i64, ptr %slot.s, align 8
  %r129.p = getelementptr inbounds [6 x i8], ptr @.str.29, i64 0, i64 0
  %r129 = ptrtoint ptr %r129.p to i64
  %r130.p = getelementptr inbounds [5 x i8], ptr @.str.32, i64 0, i64 0
  %r130 = ptrtoint ptr %r130.p to i64
  %r131 = call i64 @nova_rt_replace(i64 %r128, i64 %r129, i64 %r130)
  store i64 %r131, ptr %slot.replaced, align 8
  %r132 = load i64, ptr %slot.replaced, align 8
  %r133.p = getelementptr inbounds [13 x i8], ptr @.str.33, i64 0, i64 0
  %r133 = ptrtoint ptr %r133.p to i64
  %r134 = call i64 @nova_rt_eq(i64 %r132, i64 %r133)
  %r135.p = getelementptr inbounds [8 x i8], ptr @.str.34, i64 0, i64 0
  %r135 = ptrtoint ptr %r135.p to i64
  %r136 = call i64 @nova_rt_assert(i64 %r134, i64 %r135)
  %r137.p = getelementptr inbounds [6 x i8], ptr @.str.35, i64 0, i64 0
  %r137 = ptrtoint ptr %r137.p to i64
  %r138.p = getelementptr inbounds [2 x i8], ptr @.str.36, i64 0, i64 0
  %r138 = ptrtoint ptr %r138.p to i64
  %r139 = call i64 @nova_rt_split(i64 %r137, i64 %r138)
  store i64 %r139, ptr %slot.parts, align 8
  %r140 = load i64, ptr %slot.parts, align 8
  %r141 = call i64 @nova_rt_len_any(i64 %r140)
  %r142 = add i64 3, 0
  %r143 = call i64 @nova_rt_eq(i64 %r141, i64 %r142)
  %r144.p = getelementptr inbounds [13 x i8], ptr @.str.37, i64 0, i64 0
  %r144 = ptrtoint ptr %r144.p to i64
  %r145 = call i64 @nova_rt_assert(i64 %r143, i64 %r144)
  %r146 = load i64, ptr %slot.parts, align 8
  %r147 = add i64 0, 0
  %r148 = call i64 @nova_rt_index_get(i64 %r146, i64 %r147)
  %r149.p = getelementptr inbounds [2 x i8], ptr @.str.38, i64 0, i64 0
  %r149 = ptrtoint ptr %r149.p to i64
  %r150 = call i64 @nova_rt_eq(i64 %r148, i64 %r149)
  %r151.p = getelementptr inbounds [9 x i8], ptr @.str.39, i64 0, i64 0
  %r151 = ptrtoint ptr %r151.p to i64
  %r152 = call i64 @nova_rt_assert(i64 %r150, i64 %r151)
  %r153 = load i64, ptr %slot.parts, align 8
  %r154 = add i64 2, 0
  %r155 = call i64 @nova_rt_index_get(i64 %r153, i64 %r154)
  %r156.p = getelementptr inbounds [2 x i8], ptr @.str.40, i64 0, i64 0
  %r156 = ptrtoint ptr %r156.p to i64
  %r157 = call i64 @nova_rt_eq(i64 %r155, i64 %r156)
  %r158.p = getelementptr inbounds [9 x i8], ptr @.str.41, i64 0, i64 0
  %r158 = ptrtoint ptr %r158.p to i64
  %r159 = call i64 @nova_rt_assert(i64 %r157, i64 %r158)
  %r160 = load i64, ptr %slot.parts, align 8
  %r161.p = getelementptr inbounds [2 x i8], ptr @.str.42, i64 0, i64 0
  %r161 = ptrtoint ptr %r161.p to i64
  %r162 = call i64 @nova_rt_join(i64 %r160, i64 %r161)
  store i64 %r162, ptr %slot.joined, align 8
  %r163 = load i64, ptr %slot.joined, align 8
  %r164.p = getelementptr inbounds [6 x i8], ptr @.str.43, i64 0, i64 0
  %r164 = ptrtoint ptr %r164.p to i64
  %r165 = call i64 @nova_rt_eq(i64 %r163, i64 %r164)
  %r166.p = getelementptr inbounds [5 x i8], ptr @.str.44, i64 0, i64 0
  %r166 = ptrtoint ptr %r166.p to i64
  %r167 = call i64 @nova_rt_assert(i64 %r165, i64 %r166)
  %r168.p = getelementptr inbounds [30 x i8], ptr @.str.45, i64 0, i64 0
  %r168 = ptrtoint ptr %r168.p to i64
  %r169 = call i64 @nova_rt_print_any(i64 %r168)
  ret i64 0
}
