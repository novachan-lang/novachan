...
entry:
  ...
  %br_then0 = icmp ne i64 %r3, 0
  br i1 %br_then0, label %then0, label %else1
then0:
  %r4.p = getelementptr inbounds [10 x i8], ptr @.str.1, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = load i64, ptr %slot.name, align 8
  %r6 = call i64 @nova_rt_any_to_str(i64 %r5)
  %r7 = call i64 @nova_rt_str_concat(i64 %r4, i64 %r6)
  %r8.p = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
...
else1:
  br label %endif2
endif2:
  %r11.p = getelementptr inbounds [5 x i8], ptr @.str.3, i64 0, i64 0
...
@.str.1 = private unnamed_addr constant [10 x i8] c"Package '\00"
