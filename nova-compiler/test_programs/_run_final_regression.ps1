...
$core_tests = @(
    ...
    '_bytes_identity_test','bytes_socket_test','_bytes_arena_test','forge_binary_serve_test','_bytes_anyops_test','forge_binary_file_test','_bytes_builders_test','forge_multipart_test','_ws_codec_test','forge_ws_echo_test',
