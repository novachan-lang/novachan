...
$core_tests = @(
    ...
    'prof_test','demo_sqlite_test','demo_sqlite_bind_test','sqlitex_test','forge_db_test','forge_typed_db_test','forge_hero_test','demo_forge_crud_test','forge_typed_query_test','forge_orm_test','demo_http_server_test','demo_forge_test','demo_forge_v2_test',
