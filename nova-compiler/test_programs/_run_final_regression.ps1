...
$core_tests = @(
    ...
    'codegen_pattern_test','match_expr_test','match_any_module_test','orm_typed_rewrite_test',
    ...
    'prof_test','demo_sqlite_test','demo_sqlite_bind_test','sqlitex_test','forge_db_test','forge_typed_db_test','forge_hero_test','demo_forge_crud_test','forge_typed_query_test','forge_orm_test','_mysql_test','demo_http_server_test','demo_forge_test','demo_forge_v2_test',
