...
$core_tests = @(
    ...
    '_bytes_identity_test','bytes_socket_test','_bytes_arena_test',
...
$server_tests = @('demo_http_server_test','demo_forge_test','demo_forge_v2_test','demo_forge_todo_test','demo_cortex_serve_test','demo_ops_test','demo_full_stack_test','real_http_api','http_offload_test','forge_spawn_test','forge_recover_test','forge_recv_security_test','forge_keepalive_test','forge_model_route_test','bytes_socket_test')
