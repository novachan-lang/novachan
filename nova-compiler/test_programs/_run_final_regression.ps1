...
$core_tests = @(
    ...
    'corex_lib_test','strx_lib_test','urlx_lib_test','csvx_lib_test','bignum_lib_test','complexnum_lib_test','rational_lib_test','basex_lib_test','setops_lib_test','matrixx_lib_test','collx_lib_test','getin_lib_test','prng_lib_test','uuid_lib_test','bitset_lib_test','graphemex_lib_test','pvecx_lib_test','coro_lib_test',
