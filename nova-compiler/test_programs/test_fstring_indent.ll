...
then0:
  ...
  %r10 = call i64 @nova_rt_dict_get(i64 %r8, i64 %r9)
  %r11 = call i64 @nova_rt_any_to_str(i64 %r10)
  %r12 = call i64 @nova_rt_str_concat(i64 %r7, i64 %r11)
  %r13.p = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
...
else1:
  br label %endif2
endif2:
  %r16.p = getelementptr inbounds [4 x i8], ptr @.str.4, i64 0, i64 0
...
@.str.4 = private unnamed_addr constant [4 x i8] c"end\00"
