...
define i64 @isEven(i64 %p0) nounwind !dbg !200 {
entry:
  %slot.n = alloca i64, align 8, !dbg !201
  store i64 %p0, ptr %slot.n, align 8, !dbg !201
  %r0 = load i64, ptr %slot.n, align 8, !dbg !202
  %r1 = add i64 2, 0, !dbg !202
  %r2 = srem i64 %r0, %r1, !dbg !202
  %r3 = add i64 0, 0, !dbg !202
  %r4.cmp = icmp eq i64 %r2, %r3, !dbg !202
  %r4 = zext i1 %r4.cmp to i64, !dbg !202
  ret i64 %r4, !dbg !202
}

define i64 @toFloat(i64 %p0) nounwind !dbg !203 {
entry:
  %slot.n = alloca i64, align 8, !dbg !204
  store i64 %p0, ptr %slot.n, align 8, !dbg !204
  %r0 = load i64, ptr %slot.n, align 8, !dbg !205
  %r1 = add i64 4607182418800017408, 0, !dbg !205
  %r2.af = sitofp i64 %r0 to double, !dbg !205
  %r2.bf = bitcast i64 %r1 to double, !dbg !205
  %r2.rf = fmul double %r2.af, %r2.bf, !dbg !205
  %r2 = bitcast double %r2.rf to i64, !dbg !205
  ret i64 %r2, !dbg !205
}

define i64 @sqrtApprox(i64 %p0) nounwind !dbg !206 {
entry:
  %slot.x = alloca i64, align 8, !dbg !207
  store i64 %p0, ptr %slot.x, align 8, !dbg !207
  %slot.g = alloca i64, align 8, !dbg !207
  store i64 0, ptr %slot.g, align 8, !dbg !207
  %r0 = load i64, ptr %slot.x, align 8, !dbg !208
  %r1 = add i64 4611686018427387904, 0, !dbg !208
  %r2 = call i64 @nova_rt_div(i64 %r0, i64 %r1), !dbg !208
  store i64 %r2, ptr %slot.g, align 8, !dbg !208
  %r3 = add i64 %r2, 0, !dbg !209
  %r4 = load i64, ptr %slot.x, align 8, !dbg !209
  %r5 = add i64 %r2, 0, !dbg !209
  %r6 = call i64 @nova_rt_div(i64 %r4, i64 %r5), !dbg !209
  %r7 = call i64 @nova_rt_add(i64 %r3, i64 %r6), !dbg !209
  %r8 = add i64 4611686018427387904, 0, !dbg !209
  %r9 = call i64 @nova_rt_div(i64 %r7, i64 %r8), !dbg !209
  store i64 %r9, ptr %slot.g, align 8, !dbg !209
  %r10 = add i64 %r9, 0, !dbg !210
  %r11 = load i64, ptr %slot.x, align 8, !dbg !210
  %r12 = add i64 %r9, 0, !dbg !210
  %r13 = call i64 @nova_rt_div(i64 %r11, i64 %r12), !dbg !210
  %r14 = call i64 @nova_rt_add(i64 %r10, i64 %r13), !dbg !210
  %r15 = add i64 4611686018427387904, 0, !dbg !210
  %r16 = call i64 @nova_rt_div(i64 %r14, i64 %r15), !dbg !210
  store i64 %r16, ptr %slot.g, align 8, !dbg !210
  %r17 = add i64 %r16, 0, !dbg !211
  %r18 = load i64, ptr %slot.x, align 8, !dbg !211
  %r19 = add i64 %r16, 0, !dbg !211
  %r20 = call i64 @nova_rt_div(i64 %r18, i64 %r19), !dbg !211
  %r21 = call i64 @nova_rt_add(i64 %r17, i64 %r20), !dbg !211
  %r22 = add i64 4611686018427387904, 0, !dbg !211
  %r23 = call i64 @nova_rt_div(i64 %r21, i64 %r22), !dbg !211
  store i64 %r23, ptr %slot.g, align 8, !dbg !211
  %r24 = add i64 %r23, 0, !dbg !212
  %r25 = load i64, ptr %slot.x, align 8, !dbg !212
  %r26 = add i64 %r23, 0, !dbg !212
  %r27 = call i64 @nova_rt_div(i64 %r25, i64 %r26), !dbg !212
  %r28 = call i64 @nova_rt_add(i64 %r24, i64 %r27), !dbg !212
  %r29 = add i64 4611686018427387904, 0, !dbg !212
  %r30 = call i64 @nova_rt_div(i64 %r28, i64 %r29), !dbg !212
  store i64 %r30, ptr %slot.g, align 8, !dbg !212
  %r31 = add i64 %r30, 0, !dbg !213
  %r32 = load i64, ptr %slot.x, align 8, !dbg !213
  %r33 = add i64 %r30, 0, !dbg !213
  %r34 = call i64 @nova_rt_div(i64 %r32, i64 %r33), !dbg !213
  %r35 = call i64 @nova_rt_add(i64 %r31, i64 %r34), !dbg !213
  %r36 = add i64 4611686018427387904, 0, !dbg !213
  %r37 = call i64 @nova_rt_div(i64 %r35, i64 %r36), !dbg !213
  store i64 %r37, ptr %slot.g, align 8, !dbg !213
  %r38 = add i64 %r37, 0, !dbg !214
  ret i64 %r38, !dbg !214
}

define i64 @distance(i64 %p0, i64 %p1, i64 %p2, i64 %p3) nounwind !dbg !215 {
entry:
  %slot.x1 = alloca i64, align 8, !dbg !216
  store i64 %p0, ptr %slot.x1, align 8, !dbg !216
  %slot.y1 = alloca i64, align 8, !dbg !216
  store i64 %p1, ptr %slot.y1, align 8, !dbg !216
  %slot.x2 = alloca i64, align 8, !dbg !216
  store i64 %p2, ptr %slot.x2, align 8, !dbg !216
  %slot.y2 = alloca i64, align 8, !dbg !216
  store i64 %p3, ptr %slot.y2, align 8, !dbg !216
  %slot.dx = alloca i64, align 8, !dbg !216
  store i64 0, ptr %slot.dx, align 8, !dbg !216
  %slot.dy = alloca i64, align 8, !dbg !216
  store i64 0, ptr %slot.dy, align 8, !dbg !216
  %r0 = load i64, ptr %slot.x2, align 8, !dbg !217
  %r1 = load i64, ptr %slot.x1, align 8, !dbg !217
  %r2.af = bitcast i64 %r0 to double, !dbg !217
  %r2.bf = bitcast i64 %r1 to double, !dbg !217
  %r2.rf = fsub double %r2.af, %r2.bf, !dbg !217
  %r2 = bitcast double %r2.rf to i64, !dbg !217
  store i64 %r2, ptr %slot.dx, align 8, !dbg !217
  %r3 = load i64, ptr %slot.y2, align 8, !dbg !218
  %r4 = load i64, ptr %slot.y1, align 8, !dbg !218
  %r5.af = bitcast i64 %r3 to double, !dbg !218
  %r5.bf = bitcast i64 %r4 to double, !dbg !218
  %r5.rf = fsub double %r5.af, %r5.bf, !dbg !218
  %r5 = bitcast double %r5.rf to i64, !dbg !218
  store i64 %r5, ptr %slot.dy, align 8, !dbg !218
  %r6 = add i64 %r2, 0, !dbg !219
  %r7 = add i64 %r2, 0, !dbg !219
  %r8.af = bitcast i64 %r6 to double, !dbg !219
  %r8.bf = bitcast i64 %r7 to double, !dbg !219
  %r8.rf = fmul double %r8.af, %r8.bf, !dbg !219
  %r8 = bitcast double %r8.rf to i64, !dbg !219
  %r9 = add i64 %r5, 0, !dbg !219
  %r10 = add i64 %r5, 0, !dbg !219
  %r11.af = bitcast i64 %r9 to double, !dbg !219
  %r11.bf = bitcast i64 %r10 to double, !dbg !219
  %r11.rf = fmul double %r11.af, %r11.bf, !dbg !219
  %r11 = bitcast double %r11.rf to i64, !dbg !219
  %r12.af = bitcast i64 %r8 to double, !dbg !219
  %r12.bf = bitcast i64 %r11 to double, !dbg !219
  %r12.rf = fadd double %r12.af, %r12.bf, !dbg !219
  %r12 = bitcast double %r12.rf to i64, !dbg !219
  %r13 = call i64 @sqrtApprox(i64 %r12), !dbg !219
  ret i64 %r13, !dbg !219
}

define i64 @power(i64 %p0, i64 %p1) nounwind !dbg !220 {
entry:
  %slot.base = alloca i64, align 8, !dbg !221
  store i64 %p0, ptr %slot.base, align 8, !dbg !221
  %slot.exp = alloca i64, align 8, !dbg !221
  store i64 %p1, ptr %slot.exp, align 8, !dbg !221
  %slot.result = alloca i64, align 8, !dbg !221
  store i64 0, ptr %slot.result, align 8, !dbg !221
  %slot.i = alloca i64, align 8, !dbg !221
  store i64 0, ptr %slot.i, align 8, !dbg !221
  %r0 = add i64 1, 0, !dbg !222
  store i64 %r0, ptr %slot.result, align 8, !dbg !222
  %r1 = add i64 0, 0, !dbg !223
  store i64 %r1, ptr %slot.i, align 8, !dbg !223
  br label %while_hdr0, !dbg !224
while_hdr0:
  %r2 = load i64, ptr %slot.i, align 8, !dbg !224
  %r3 = load i64, ptr %slot.exp, align 8, !dbg !224
  %r4.cmp = icmp slt i64 %r2, %r3, !dbg !224
  %r4 = zext i1 %r4.cmp to i64, !dbg !224
  %br_while_body1 = icmp ne i64 %r4, 0, !dbg !224
  br i1 %br_while_body1, label %while_body1, label %while_exit2, !prof !90, !dbg !224
while_body1:
  %r5 = load i64, ptr %slot.base, align 8, !dbg !225
  %r6 = load i64, ptr %slot.result, align 8, !dbg !225
  %r7 = mul i64 %r6, %r5, !dbg !225
  store i64 %r7, ptr %slot.result, align 8, !dbg !225
  %r8 = add i64 1, 0, !dbg !226
  %r9 = load i64, ptr %slot.i, align 8, !dbg !226
  %r10 = add i64 %r9, %r8, !dbg !226
  store i64 %r10, ptr %slot.i, align 8, !dbg !226
  br label %while_hdr0, !dbg !226
while_exit2:
  %r11 = load i64, ptr %slot.result, align 8, !dbg !227
  ret i64 %r11, !dbg !227
}

define i64 @nova_main() nounwind {
entry:
  %r0.p = getelementptr inbounds [20 x i8], ptr @.str.0, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = call i64 @nova_rt_print_str(i64 %r0)
  %r2 = add i64 2, 0
  %r3 = add i64 10, 0
  %r4 = call i64 @power(i64 %r2, i64 %r3)
  %r5 = call i64 @nova_rt_print_int(i64 %r4)
  %r6 = add i64 3, 0
  %r7 = add i64 5, 0
  %r8 = call i64 @power(i64 %r6, i64 %r7)
  %r9 = call i64 @nova_rt_print_int(i64 %r8)
  %r10 = add i64 42, 0
  %r11 = call i64 @isEven(i64 %r10)
  %r12 = call i64 @nova_rt_print_int(i64 %r11)
  %r13 = add i64 17, 0
  %r14 = call i64 @isEven(i64 %r13)
  %r15 = call i64 @nova_rt_print_int(i64 %r14)
  %r16.p = getelementptr inbounds [18 x i8], ptr @.str.1, i64 0, i64 0
  %r16 = ptrtoint ptr %r16.p to i64
  %r17 = call i64 @nova_rt_print_str(i64 %r16)
  %r18 = add i64 0, 0
  %r19 = add i64 0, 0
  %r20 = add i64 4613937818241073152, 0
  %r21 = add i64 4616189618054758400, 0
  %r22 = call i64 @distance(i64 %r18, i64 %r19, i64 %r20, i64 %r21)
  %r23 = call i64 @nova_rt_print_float(i64 %r22)
  %r24 = add i64 42, 0
  %r25 = call i64 @toFloat(i64 %r24)
  %r26 = call i64 @nova_rt_print_float(i64 %r25)
  %r27.p = getelementptr inbounds [26 x i8], ptr @.str.2, i64 0, i64 0
  %r27 = ptrtoint ptr %r27.p to i64
  %r28 = call i64 @nova_rt_print_str(i64 %r27)
  %r29 = add i64 2, 0
  %r30 = add i64 20, 0
  %r31 = call i64 @power(i64 %r29, i64 %r30)
  %r32 = call i64 @nova_rt_print_int(i64 %r31)
  ret i64 0
}
...
!101 = !DIFile(filename: "mixed_types.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "isEven", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
!201 = !DILocation(line: 1, column: 0, scope: !200)
!203 = distinct !DISubprogram(name: "toFloat", scope: !101, file: !101, line: 4, type: !104, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !100)
!204 = !DILocation(line: 4, column: 0, scope: !203)
!206 = distinct !DISubprogram(name: "sqrtApprox", scope: !101, file: !101, line: 7, type: !104, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !100)
!207 = !DILocation(line: 7, column: 0, scope: !206)
!215 = distinct !DISubprogram(name: "distance", scope: !101, file: !101, line: 16, type: !104, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !100)
!216 = !DILocation(line: 16, column: 0, scope: !215)
!220 = distinct !DISubprogram(name: "power", scope: !101, file: !101, line: 21, type: !104, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !100)
!221 = !DILocation(line: 21, column: 0, scope: !220)
!202 = !DILocation(line: 2, column: 0, scope: !200)
!205 = !DILocation(line: 5, column: 0, scope: !203)
!208 = !DILocation(line: 8, column: 0, scope: !206)
!209 = !DILocation(line: 9, column: 0, scope: !206)
!210 = !DILocation(line: 10, column: 0, scope: !206)
!211 = !DILocation(line: 11, column: 0, scope: !206)
!212 = !DILocation(line: 12, column: 0, scope: !206)
!213 = !DILocation(line: 13, column: 0, scope: !206)
!214 = !DILocation(line: 14, column: 0, scope: !206)
!217 = !DILocation(line: 17, column: 0, scope: !215)
!218 = !DILocation(line: 18, column: 0, scope: !215)
!219 = !DILocation(line: 19, column: 0, scope: !215)
!222 = !DILocation(line: 22, column: 0, scope: !220)
!223 = !DILocation(line: 23, column: 0, scope: !220)
!224 = !DILocation(line: 24, column: 0, scope: !220)
!225 = !DILocation(line: 25, column: 0, scope: !220)
!226 = !DILocation(line: 26, column: 0, scope: !220)
!227 = !DILocation(line: 27, column: 0, scope: !220)
