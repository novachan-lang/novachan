...
entry:
  ...
  %r0 = add i64 4614253070214989087, 0, !dbg !202
  store i64 %r0, ptr %slot.x, align 8, !dbg !202
  %r1 = add i64 %r0, 0, !dbg !203
  %r2 = add i64 1, 0, !dbg !203
  %r3.af = bitcast i64 %r1 to double, !dbg !203
  %r3.bf = sitofp i64 %r2 to double, !dbg !203
  %r3.rf = fadd double %r3.af, %r3.bf, !dbg !203
  %r3 = bitcast double %r3.rf to i64, !dbg !203
  %r4 = call i64 @nova_rt_print_float(i64 %r3), !dbg !203
  %r5 = add i64 %r0, 0, !dbg !204
  %r6 = call i64 @nova_rt_float_to_str(i64 %r5), !dbg !204
  %r7 = call i64 @nova_rt_print_str(i64 %r6), !dbg !204
  ret i64 %r7, !dbg !204
}
...
!101 = !DIFile(filename: "C:\Users\mange\Crypto\AI\New folder\New folder\nova-compiler\test_programs\_sanity.nova", directory: ".")
