...
entry:
  ...
  %r6 = add i64 1, 0
  %r7.lp = inttoptr i64 %r5 to ptr
  %r7.dp = load ptr, ptr %r7.lp, align 8, !tbaa !2
  %r7.ep = getelementptr i64, ptr %r7.dp, i64 %r6
  %r7 = load i64, ptr %r7.ep, align 8, !tbaa !4
  %r8 = call i64 @nova_rt_any_to_str(i64 %r7)
  %r9 = call i64 @nova_rt_str_concat(i64 %r4, i64 %r8)
  %r10.p = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
