...
entry:
  ...
  store i64 %r15, ptr %slot.items, align 8
  %r19 = load i64, ptr %slot.items, align 8
  %r20 = call i64 @nova_rt_print_any(i64 %r19)
  %r21.p = getelementptr inbounds [13 x i8], ptr @.str.7, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [32 x i8] c"=== print empty string test ===\00"
@.str.1 = private unnamed_addr constant [1 x i8] c"\00"
@.str.2 = private unnamed_addr constant [12 x i8] c"after empty\00"
@.str.3 = private unnamed_addr constant [4 x i8] c"---\00"
@.str.4 = private unnamed_addr constant [16 x i8] c"after var empty\00"
