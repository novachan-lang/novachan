...
entry:
  ...
  %r1 = call i64 @nova_rt_print_str(i64 %r0), !dbg !202
  ret i64 %r1, !dbg !202
}
...
; String constants
@.str.0 = private unnamed_addr constant [17 x i8] c"Hello from NOVA!\00"
...
!101 = !DIFile(filename: "hello.nova", directory: ".")
!102 = !{i32 2, !"CodeView", i32 1}
!103 = !{i32 2, !"Debug Info Version", i32 3}
!104 = !DISubroutineType(types: !105)
!105 = !{null}
!200 = distinct !DISubprogram(name: "nova_user_main", scope: !101, file: !101, line: 1, type: !104, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !100)
