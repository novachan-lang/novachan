...
while_body100:
  ...
  %r63 = add i64 1, 0
  %r64 = call i64 @nova_rt_add(i64 %r62, i64 %r63)
...
while_body112:
  ...
  %r100 = call i64 @nova_rt_add(i64 %r96, i64 %r99)
...
then117:
  ...
  %r125 = add i64 1, 0
  %r126 = call i64 @nova_rt_add(i64 %r124, i64 %r125)
  store i64 %r126, ptr %slot.pos, align 8
  %r127 = load i64, ptr %slot.col, align 8
  %r128 = add i64 1, 0
  %r129 = call i64 @nova_rt_add(i64 %r127, i64 %r128)
