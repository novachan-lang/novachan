...
$ps.FileName = $compiler; $ps.Arguments = "_iopoll_diag3.nova"; $ps.WorkingDirectory = $dir
...
& clang "$dir\_iopoll_diag3.ll" $rtObj -o "$dir\_iopoll_diag3.exe" -O2 -lws2_32 -ladvapi32 -D_CRT_SECURE_NO_WARNINGS -w 2>&1
Write-Host "Linked"

$rps = New-Object System.Diagnostics.ProcessStartInfo
$rps.FileName = "$dir\_iopoll_diag3.exe"; $rps.WorkingDirectory = $dir
