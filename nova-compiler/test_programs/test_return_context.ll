...
then0:
  %r3.p = getelementptr inbounds [16 x i8], ptr @.str.0, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r4 = load i64, ptr %slot.d, align 8
  %r5 = load i64, ptr %slot.k, align 8
  %r6 = call i64 @nova_rt_dict_get(i64 %r4, i64 %r5)
  %r7 = call i64 @nova_rt_any_to_str(i64 %r6)
  %r8 = call i64 @nova_rt_str_concat(i64 %r3, i64 %r7)
  %r9.p = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
...
endif2:
  ...
  %r14.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  %r14 = ptrtoint ptr %r14.p to i64
  %r15 = call i64 @nova_rt_str_concat(i64 %r13, i64 %r14)
  %r16.p = getelementptr inbounds [4 x i8], ptr @.str.3, i64 0, i64 0
  %r16 = ptrtoint ptr %r16.p to i64
  %r17 = call i64 @nova_rt_str_concat(i64 %r15, i64 %r16)
  %r18.p = getelementptr inbounds [3 x i8], ptr @.str.4, i64 0, i64 0
...
entry:
  ...
  %r1.p = getelementptr inbounds [4 x i8], ptr @.str.5, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2.p = getelementptr inbounds [4 x i8], ptr @.str.6, i64 0, i64 0
  ...
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.5, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @test(i64 %r3, i64 %r4)
  %r6 = load i64, ptr %slot.d, align 8
  %r7.p = getelementptr inbounds [4 x i8], ptr @.str.7, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @test(i64 %r6, i64 %r7)
  ret i64 %r8
}
...
; String constants
@.str.0 = private unnamed_addr constant [16 x i8] c"already there: \00"
@.str.1 = private unnamed_addr constant [1 x i8] c"\00"
@.str.2 = private unnamed_addr constant [5 x i8] c" = \22\00"
@.str.3 = private unnamed_addr constant [4 x i8] c"val\00"
@.str.4 = private unnamed_addr constant [3 x i8] c"\22\0A\00"
@.str.5 = private unnamed_addr constant [4 x i8] c"foo\00"
@.str.6 = private unnamed_addr constant [4 x i8] c"bar\00"
