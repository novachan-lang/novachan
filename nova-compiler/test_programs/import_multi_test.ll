...
; ESCAPE add: allocs=0 escape=0 local=0
...
; ESCAPE multiply: allocs=0 escape=0 local=0
...
; ESCAPE square: allocs=0 escape=0 local=0
...
; ESCAPE _internal_helper: allocs=0 escape=0 local=0
...
; ESCAPE shout: allocs=0 escape=0 local=0
...
; ESCAPE repeat_str: allocs=0 escape=0 local=0
...
entry:
  ...
  %r13 = call i64 @nova_rt_print_str(i64 %r12)
  %r14 = add i64 3, 0
  ...
  %r20 = call i64 @nova_rt_print_int(i64 %r19)
