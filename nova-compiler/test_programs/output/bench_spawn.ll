...
while_body2:
  ...
  %r18 = call i64 @nova_rt_spawn(i64 %t5, i64 %t6)
  %r20 = call i64 @nova_rt_channel_recv(i64 %r12)
  %r24 = load i64, ptr %slot.total, align 8
  %r26 = add i64 %r24, %r20
  store i64 %r26, ptr %slot.total, align 8
  %r29 = load i64, ptr %slot.i, align 8
  %r31 = add i64 %r29, 1
  store i64 %r31, ptr %slot.i, align 8
...
while_exit3:
  ...
  call i32 (ptr, ...) @printf(ptr %t7, i64 %r35)
  ret i64 0
}

define i64 @nova_main_spawn0(i64 %p0, i64 %p1) nounwind {
entry0:
  %r24 = mul i64 %p1, %p1
  %t0 = call i64 @nova_rt_channel_send(i64 %p0, i64 %r24)
  ret i64 0
}
