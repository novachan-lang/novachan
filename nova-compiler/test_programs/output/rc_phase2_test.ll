...
entry0:
  ...
  %t0 = call i64 @nova_rt_list_append(i64 %r12, i64 10)
  %t1 = call i64 @nova_rt_list_append(i64 %r12, i64 20)
  %t2 = call i64 @nova_rt_list_append(i64 %r12, i64 30)
  %t3 = call i64 @nova_rt_list_append(i64 %r12, i64 40)
  %t4 = call i64 @nova_rt_list_append(i64 %r12, i64 50)
  %r13 = call i64 @nova_rt_list_len(i64 %r12)
  call void @nova_rc_dec(i64 %r12)
  %t5 = getelementptr inbounds [5 x i8], ptr @.str.3, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t5, i64 %r13)
  %r25 = call i64 @nova_rt_list_create()
  %t6 = call i64 @nova_rt_list_append(i64 %r25, i64 5)
  %t7 = call i64 @nova_rt_list_append(i64 %r25, i64 4)
  %t8 = call i64 @nova_rt_list_append(i64 %r25, i64 3)
  %t9 = call i64 @nova_rt_list_append(i64 %r25, i64 2)
  %t10 = call i64 @nova_rt_list_append(i64 %r25, i64 1)
  %r26 = call i64 @nova_rt_list_reverse(i64 %r25)
