...
ifb_then1:
  ...
  %r18 = ptrtoint ptr %t6 to i64
  %r19 = load i64, ptr %slot.d, align 8
  %r20 = load i64, ptr %slot.k, align 8
  %r21 = call i64 @nova_rt_dict_get(i64 %r19, i64 %r20)
  %r22 = call i64 @nova_rt_any_to_str(i64 %r21)
  %t7 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r23 = ptrtoint ptr %t7 to i64
  %t8 = call i64 @nova_rt_str_concat(i64 %r18, i64 %r22)
  %t9 = call i64 @nova_rt_str_concat(i64 %t8, i64 %r23)
