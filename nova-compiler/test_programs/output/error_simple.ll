...
@.str.0 = private unnamed_addr constant [16 x i8] c"something broke\00"
...
entry0:
  ...
  store i64 0, ptr %slot.__catch_2, align 8
  store i64 0, ptr %slot.__catch_3, align 8
  %t0 = getelementptr inbounds [16 x i8], ptr @.str.0, i64 0, i64 0
  %r80 = ptrtoint ptr %t0 to i64
  store i64 1, ptr @__nova_error_flag
  store i64 %r80, ptr @__nova_error_msg
...
catch_merge3:
  %r14 = load i64, ptr %slot.__catch_0, align 8
  %t5 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t5, i64 %r14)
  %t6 = load i64, ptr @__nova_error_flag
  store i64 0, ptr @__nova_error_flag
  %t7 = icmp ne i64 %t6, 0
  br i1 %t7, label %catch_err4, label %catch_ok5

catch_err4:
  %t8 = load i64, ptr @__nova_error_msg
  store i64 0, ptr @__nova_error_msg
  store i64 -1, ptr %slot.__catch_1, align 8
  br label %catch_merge6

catch_ok5:
  %t9 = load i64, ptr %slot.__catch_1, align 8
  call void @nova_rc_dec(i64 %t9)
  store i64 42, ptr %slot.__catch_1, align 8
  br label %catch_merge6

catch_merge6:
  %r33 = load i64, ptr %slot.__catch_1, align 8
  %t10 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t10, i64 %r33)
  %t11 = load i64, ptr @__nova_error_flag
  store i64 0, ptr @__nova_error_flag
  %t12 = icmp ne i64 %t11, 0
  br i1 %t12, label %catch_err7, label %catch_ok8

catch_err7:
  %t13 = load i64, ptr @__nova_error_msg
  store i64 0, ptr @__nova_error_msg
  store i64 99, ptr %slot.__catch_2, align 8
  br label %catch_merge9

catch_ok8:
  %t14 = load i64, ptr %slot.__catch_2, align 8
  call void @nova_rc_dec(i64 %t14)
  store i64 15, ptr %slot.__catch_2, align 8
  br label %catch_merge9

catch_merge9:
  %r53 = load i64, ptr %slot.__catch_2, align 8
  %t15 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t15, i64 %r53)
  %t16 = getelementptr inbounds [16 x i8], ptr @.str.0, i64 0, i64 0
  %r86 = ptrtoint ptr %t16 to i64
  store i64 1, ptr @__nova_error_flag
  store i64 %r86, ptr @__nova_error_msg
  %t17 = load i64, ptr @__nova_error_flag
  store i64 0, ptr @__nova_error_flag
  %t18 = icmp ne i64 %t17, 0
  br i1 %t18, label %catch_err10, label %catch_ok11

catch_err10:
  %t19 = load i64, ptr @__nova_error_msg
  store i64 0, ptr @__nova_error_msg
  %t20 = load i64, ptr %slot.__catch_3, align 8
  call void @nova_rc_dec(i64 %t20)
  store i64 %t19, ptr %slot.__catch_3, align 8
  br label %catch_merge12

catch_ok11:
  %t21 = load i64, ptr %slot.__catch_3, align 8
  call void @nova_rc_dec(i64 %t21)
  store i64 0, ptr %slot.__catch_3, align 8
  br label %catch_merge12

catch_merge12:
  %r71 = load i64, ptr %slot.__catch_3, align 8
  %t22 = inttoptr i64 %r71 to ptr
  call i32 @puts(ptr %t22)
  %t23 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r77 = ptrtoint ptr %t23 to i64
  %t24 = inttoptr i64 %r77 to ptr
  call i32 @puts(ptr %t24)
  call void @nova_rc_inc(i64 0)
  %t25 = load i64, ptr %slot.__catch_3, align 8
