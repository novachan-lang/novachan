...
entry0:
  ...
  call i32 (ptr, ...) @printf(ptr %t8, i64 %r11)
  ...
  %r21 = load i64, ptr %t14
  %t15 = inttoptr i64 %r21 to ptr
  ...
  call i32 (ptr, ...) @printf(ptr %t18, i64 %r24)
  ret i64 0
}
