...
@.str.0 = private unnamed_addr constant [3 x i8] c"ab\00"
...
entry0:
  ...
  %t1 = getelementptr inbounds [3 x i8], ptr @.str.0, i64 0, i64 0
  %r3 = ptrtoint ptr %t1 to i64
  br label %__mb0_entry0

__mb0_entry0:
  %t2 = load i64, ptr %slot.__mb0_s, align 8
  call void @nova_rc_dec(i64 %t2)
  store i64 %r3, ptr %slot.__mb0_s, align 8
  store i64 4, ptr %slot.__mb0_n, align 8
  %t3 = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
  %r23 = ptrtoint ptr %t3 to i64
  %t4 = load i64, ptr %slot.__mb0_result, align 8
  call void @nova_rc_dec(i64 %t4)
  store i64 %r23, ptr %slot.__mb0_result, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r51 = load i64, ptr %slot.__mb0_n, align 8
  %r52 = load i64, ptr %slot.__mb0_s, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r32 = load i64, ptr %slot.__mb0_i, align 8
  %t5 = icmp slt i64 %r32, %r51
  br i1 %t5, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r36 = load i64, ptr %slot.__mb0_result, align 8
  %t6 = call i64 @nova_rt_str_concat(i64 %r36, i64 %r52)
  %t7 = load i64, ptr %slot.__mb0_result, align 8
  call void @nova_rc_dec(i64 %t7)
  store i64 %t6, ptr %slot.__mb0_result, align 8
...
__mb0_while_exit3:
  %r47 = load i64, ptr %slot.__mb0_result, align 8
  %t8 = load i64, ptr %slot.__mb0_ret, align 8
  call void @nova_rc_dec(i64 %t8)
  call void @nova_rc_inc(i64 %r47)
  store i64 %r47, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r48 = load i64, ptr %slot.__mb0_ret, align 8
  %t9 = inttoptr i64 %r48 to ptr
  call i32 @puts(ptr %t9)
  %r8 = call i64 @fib(i64 0)
  %t10 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t10, i64 %r8)
  %r11 = call i64 @fib(i64 1)
  %t11 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t11, i64 %r11)
  %r14 = call i64 @fib(i64 7)
  %t12 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t12, i64 %r14)
  %t13 = load i64, ptr %slot.__mb0_s, align 8
  call void @nova_rc_dec(i64 %t13)
  %t14 = load i64, ptr %slot.__mb0_result, align 8
