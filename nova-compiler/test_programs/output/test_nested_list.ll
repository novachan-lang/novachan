...
entry0:
  %t0 = getelementptr inbounds [25 x i8], ptr @.str.0, i64 0, i64 0
  %r1 = ptrtoint ptr %t0 to i64
  %t1 = inttoptr i64 %r1 to ptr
  call i32 @puts(ptr %t1)
  %r7 = call i64 @nova_rt_list_create()
  %t2 = call i64 @nova_rt_list_append(i64 %r7, i64 1)
  %t3 = call i64 @nova_rt_list_append(i64 %r7, i64 2)
  %t4 = call i64 @nova_rt_list_append(i64 %r7, i64 3)
  %r11 = call i64 @nova_rt_list_create()
  %t5 = call i64 @nova_rt_list_append(i64 %r11, i64 4)
  %t6 = call i64 @nova_rt_list_append(i64 %r11, i64 5)
  %t7 = call i64 @nova_rt_list_append(i64 %r11, i64 6)
  %r15 = call i64 @nova_rt_list_create()
  %t8 = call i64 @nova_rt_list_append(i64 %r15, i64 7)
  %t9 = call i64 @nova_rt_list_append(i64 %r15, i64 8)
  %t10 = call i64 @nova_rt_list_append(i64 %r15, i64 9)
  %r16 = call i64 @nova_rt_list_create()
  %t11 = call i64 @nova_rt_list_append(i64 %r16, i64 %r7)
  %t12 = call i64 @nova_rt_list_append(i64 %r16, i64 %r11)
  %t13 = call i64 @nova_rt_list_append(i64 %r16, i64 %r15)
  call i64 @nova_rt_list_print(i64 %r16)
  %t14 = inttoptr i64 %r16 to ptr
  %t15 = load ptr, ptr %t14, align 8, !tbaa !2
  %t16 = getelementptr i64, ptr %t15, i64 0
  %r24 = load i64, ptr %t16, align 8, !tbaa !4
  call i64 @nova_rt_list_print(i64 %r24)
  %t17 = inttoptr i64 %r16 to ptr
  %t18 = load ptr, ptr %t17, align 8, !tbaa !2
  %t19 = getelementptr i64, ptr %t18, i64 1
  %r28 = load i64, ptr %t19, align 8, !tbaa !4
  call i64 @nova_rt_list_print(i64 %r28)
  %t20 = inttoptr i64 %r16 to ptr
  %t21 = load ptr, ptr %t20, align 8, !tbaa !2
  %t22 = getelementptr i64, ptr %t21, i64 2
  %r32 = load i64, ptr %t22, align 8, !tbaa !4
  call i64 @nova_rt_list_print(i64 %r32)
  %t23 = inttoptr i64 %r16 to ptr
  %t24 = load ptr, ptr %t23, align 8, !tbaa !2
  %t25 = getelementptr i64, ptr %t24, i64 1
  %r36 = load i64, ptr %t25, align 8, !tbaa !4
  ...
  %r38 = load i64, ptr %t28, align 8, !tbaa !4
  %t29 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t29, i64 %r38)
  %r43 = call i64 @nova_rt_list_create()
  %t30 = call i64 @nova_rt_list_append(i64 %r43, i64 10)
  %t31 = call i64 @nova_rt_list_append(i64 %r43, i64 20)
  %r46 = call i64 @nova_rt_list_create()
  %t32 = call i64 @nova_rt_list_append(i64 %r46, i64 30)
  %t33 = call i64 @nova_rt_list_append(i64 %r46, i64 40)
  %r47 = call i64 @nova_rt_list_create()
  %t34 = call i64 @nova_rt_list_append(i64 %r47, i64 %r43)
  %t35 = call i64 @nova_rt_list_append(i64 %r47, i64 %r46)
  %t36 = inttoptr i64 %r47 to ptr
  %t37 = load ptr, ptr %t36, align 8, !tbaa !2
  %t38 = getelementptr i64, ptr %t37, i64 0
  %r54 = load i64, ptr %t38, align 8, !tbaa !4
  %t39 = inttoptr i64 %r54 to ptr
  %t40 = load ptr, ptr %t39, align 8, !tbaa !2
  %t41 = getelementptr i64, ptr %t40, i64 0
  %r56 = load i64, ptr %t41, align 8, !tbaa !4
  %t42 = inttoptr i64 %r47 to ptr
  %t43 = load ptr, ptr %t42, align 8, !tbaa !2
  %t44 = getelementptr i64, ptr %t43, i64 0
  %r59 = load i64, ptr %t44, align 8, !tbaa !4
  %t45 = inttoptr i64 %r59 to ptr
  %t46 = load ptr, ptr %t45, align 8, !tbaa !2
  %t47 = getelementptr i64, ptr %t46, i64 1
  %r61 = load i64, ptr %t47, align 8, !tbaa !4
  %r62 = add i64 %r56, %r61
  %t48 = inttoptr i64 %r47 to ptr
  %t49 = load ptr, ptr %t48, align 8, !tbaa !2
  %t50 = getelementptr i64, ptr %t49, i64 1
  %r65 = load i64, ptr %t50, align 8, !tbaa !4
  %t51 = inttoptr i64 %r65 to ptr
  %t52 = load ptr, ptr %t51, align 8, !tbaa !2
  %t53 = getelementptr i64, ptr %t52, i64 0
  %r67 = load i64, ptr %t53, align 8, !tbaa !4
  %r68 = add i64 %r62, %r67
  %t54 = inttoptr i64 %r47 to ptr
  %t55 = load ptr, ptr %t54, align 8, !tbaa !2
  %t56 = getelementptr i64, ptr %t55, i64 1
  %r71 = load i64, ptr %t56, align 8, !tbaa !4
  call void @nova_rc_dec(i64 %r47)
  %t57 = inttoptr i64 %r71 to ptr
  %t58 = load ptr, ptr %t57, align 8, !tbaa !2
  %t59 = getelementptr i64, ptr %t58, i64 1
  %r73 = load i64, ptr %t59, align 8, !tbaa !4
  %r74 = add i64 %r68, %r73
  %t60 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t60, i64 %r74)
  %t61 = getelementptr inbounds [13 x i8], ptr @.str.1, i64 0, i64 0
  %r80 = ptrtoint ptr %t61 to i64
  %t62 = inttoptr i64 %r80 to ptr
