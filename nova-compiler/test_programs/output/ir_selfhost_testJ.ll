...
for_hdr0:
  ...
  %r4.cmp = icmp slt i64 %r3, %r2
  %r4 = zext i1 %r4.cmp to i64
  %br_for_body1 = icmp ne i64 %r4, 0
...
entry:
  ...
  br label %for_hdr6
for_hdr6:
  %r14 = load i64, ptr %slot.__for_idx_6, align 8
  %r15.cmp = icmp slt i64 %r14, %r13
  %r15 = zext i1 %r15.cmp to i64
  %br_for_body7 = icmp ne i64 %r15, 0
  br i1 %br_for_body7, label %for_body7, label %for_exit8
for_body7:
  %r16 = call i64 @nova_rt_index_get(i64 %r12, i64 %r14)
  store i64 %r16, ptr %slot.w, align 8
  %r17 = load i64, ptr %slot.w, align 8
  %r18 = call i64 @nova_rt_print_any(i64 %r17)
  %r19 = load i64, ptr %slot.__for_idx_6, align 8
  %r20 = add i64 1, 0
  %r21 = add i64 %r19, %r20
  store i64 %r21, ptr %slot.__for_idx_6, align 8
  br label %for_hdr6
for_exit8:
  ret i64 0
}
