...
entry0:
  %r1 = call i64 @nova_rt_time_ms()
  call void @nova_rt_sleep_ms(i64 10)
  %r8 = call i64 @nova_rt_time_ms()
  %r15 = sub i64 %r8, %r1
  %t0 = getelementptr inbounds [19 x i8], ptr @.str.0, i64 0, i64 0
  %r19 = ptrtoint ptr %t0 to i64
  %t1 = icmp sge i64 %r15, 10
  %r22 = zext i1 %t1 to i64
  %r23 = call i64 @nova_rt_bool_to_str(i64 %r22)
  %t2 = call i64 @nova_rt_str_concat(i64 %r19, i64 %r23)
  call void @nova_rc_dec(i64 %r23)
  %t3 = inttoptr i64 %t2 to ptr
  call i32 @puts(ptr %t3)
  call void @nova_rc_dec(i64 %t2)
  %r27 = call i64 @nova_rt_clock_ns()
  %r32 = call i64 @nova_rt_clock_ns()
  %t4 = getelementptr inbounds [21 x i8], ptr @.str.1, i64 0, i64 0
  %r36 = ptrtoint ptr %t4 to i64
  %t5 = icmp sge i64 %r32, %r27
  %r39 = zext i1 %t5 to i64
  %r40 = call i64 @nova_rt_bool_to_str(i64 %r39)
  %t6 = call i64 @nova_rt_str_concat(i64 %r36, i64 %r40)
  call void @nova_rc_dec(i64 %r40)
  %t7 = inttoptr i64 %t6 to ptr
  call i32 @puts(ptr %t7)
  call void @nova_rc_dec(i64 %t6)
  %t8 = getelementptr inbounds [14 x i8], ptr @.str.2, i64 0, i64 0
  %r43 = ptrtoint ptr %t8 to i64
  %t9 = icmp sgt i64 %r1, 0
  %r46 = zext i1 %t9 to i64
  %r47 = call i64 @nova_rt_bool_to_str(i64 %r46)
  %t10 = call i64 @nova_rt_str_concat(i64 %r43, i64 %r47)
