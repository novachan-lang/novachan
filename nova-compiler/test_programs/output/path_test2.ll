...
entry0:
  ...
  %t8 = getelementptr inbounds [9 x i8], ptr @.str.5, i64 0, i64 0
  %r20 = ptrtoint ptr %t8 to i64
  %t9 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r23 = ptrtoint ptr %t9 to i64
  %t10 = call i64 @nova_rt_str_concat(i64 %r20, i64 %r16)
  %t11 = call i64 @nova_rt_str_concat(i64 %t10, i64 %r23)
  ...
  %t13 = getelementptr inbounds [19 x i8], ptr @.str.6, i64 0, i64 0
  %r27 = ptrtoint ptr %t13 to i64
  %r28 = call i64 @nova_rt_path_name(i64 %r27)
  %t14 = getelementptr inbounds [7 x i8], ptr @.str.7, i64 0, i64 0
  %r32 = ptrtoint ptr %t14 to i64
  %t15 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r35 = ptrtoint ptr %t15 to i64
  %t16 = call i64 @nova_rt_str_concat(i64 %r32, i64 %r28)
  %t17 = call i64 @nova_rt_str_concat(i64 %t16, i64 %r35)
  ...
  %t19 = getelementptr inbounds [15 x i8], ptr @.str.8, i64 0, i64 0
  %r39 = ptrtoint ptr %t19 to i64
  %r40 = call i64 @nova_rt_path_ext(i64 %r39)
  %t20 = getelementptr inbounds [6 x i8], ptr @.str.9, i64 0, i64 0
  %r44 = ptrtoint ptr %t20 to i64
  %t21 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r47 = ptrtoint ptr %t21 to i64
  %t22 = call i64 @nova_rt_str_concat(i64 %r44, i64 %r40)
  %t23 = call i64 @nova_rt_str_concat(i64 %t22, i64 %r47)
  ...
  %t25 = getelementptr inbounds [17 x i8], ptr @.str.10, i64 0, i64 0
  %r50 = ptrtoint ptr %t25 to i64
  %t26 = inttoptr i64 %r50 to ptr
