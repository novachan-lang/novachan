...
ifb_then7:
  ...
  %r29 = ptrtoint ptr %t6 to i64
  %t7 = inttoptr i64 %r29 to ptr
...
ifb_else8:
  ...
  %r34 = srem i64 %r32, 5
  %t8 = icmp eq i64 %r34, 0
  br i1 %t8, label %ifb_then10, label %ifb_else11
...
ifb_else11:
  ...
  call i32 (ptr, ...) @printf(ptr %t12, i64 %r43)
