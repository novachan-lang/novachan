...
entry:
  ...
  %r3.p = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r4 = load i64, ptr %slot.d, align 8
  %r6 = call i64 @nova_rt_print_any(i64 %r5)
  %r7.p = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
...
entry:
  ...
  %r0.p = getelementptr inbounds [12 x i8], ptr @.str.2, i64 0, i64 0
  ...
  %r5.p = getelementptr inbounds [4 x i8], ptr @.str.4, i64 0, i64 0
  %r5 = ptrtoint ptr %r5.p to i64
  %r6 = load i64, ptr %slot.s, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9.p = getelementptr inbounds [6 x i8], ptr @.str.5, i64 0, i64 0
...
entry:
  ...
  %r1 = ptrtoint ptr %r1.p to i64
  %r2.p = getelementptr inbounds [7 x i8], ptr @.str.7, i64 0, i64 0
  %r2 = ptrtoint ptr %r2.p to i64
  %r3.p = getelementptr inbounds [7 x i8], ptr @.str.8, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r0 = call i64 @nova_rt_list_create()
  call i64 @nova_rt_list_append(i64 %r0, i64 %r1)
  call i64 @nova_rt_list_append(i64 %r0, i64 %r2)
  ...
  %r4.p = getelementptr inbounds [7 x i8], ptr @.str.7, i64 0, i64 0
...
then0:
  %r7.p = getelementptr inbounds [13 x i8], ptr @.str.9, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  br label %endif2
else1:
  br label %endif2
endif2:
  %r9.p = getelementptr inbounds [6 x i8], ptr @.str.10, i64 0, i64 0
  %r9 = ptrtoint ptr %r9.p to i64
  %r10 = load i64, ptr %slot.fruits, align 8
  %br_retthen3 = icmp ne i64 %r11, 0
  br i1 %br_retthen3, label %retthen3, label %retelse4
retthen3:
  %r12.p = getelementptr inbounds [12 x i8], ptr @.str.11, i64 0, i64 0
  %r12 = ptrtoint ptr %r12.p to i64
  %r13 = call i64 @nova_rt_print_any(i64 %r12)
  ret i64 %r13
retelse4:
  %r14.p = getelementptr inbounds [9 x i8], ptr @.str.12, i64 0, i64 0
...
entry:
  ...
  %r1.p = getelementptr inbounds [4 x i8], ptr @.str.13, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3 = call i64 @test_dict_in()
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.13, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6 = call i64 @test_string_in()
  %r7.p = getelementptr inbounds [4 x i8], ptr @.str.13, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = call i64 @test_in_conditions()
  %r10.p = getelementptr inbounds [5 x i8], ptr @.str.14, i64 0, i64 0
...
@.str.4 = private unnamed_addr constant [4 x i8] c"xyz\00"
@.str.5 = private unnamed_addr constant [6 x i8] c"world\00"
@.str.6 = private unnamed_addr constant [6 x i8] c"apple\00"
@.str.7 = private unnamed_addr constant [7 x i8] c"banana\00"
@.str.8 = private unnamed_addr constant [7 x i8] c"cherry\00"
@.str.9 = private unnamed_addr constant [13 x i8] c"found banana\00"
@.str.10 = private unnamed_addr constant [6 x i8] c"grape\00"
@.str.11 = private unnamed_addr constant [12 x i8] c"found grape\00"
@.str.12 = private unnamed_addr constant [9 x i8] c"no grape\00"
