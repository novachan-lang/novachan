...
while_hdr6:
  ...
  %br_while_body7 = icmp ne i64 %r11, 0
...
entry:
  ...
  %r15 = sub i64 %r13, %r14
  %r16 = add i64 1000000, 0
  %r17 = sdiv i64 %r15, %r16
  %r18 = call i64 @nova_rt_int_to_str(i64 %r17)
  %r19 = call i64 @nova_rt_str_concat(i64 %r12, i64 %r18)
  %r20.p = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
  %r20 = ptrtoint ptr %r20.p to i64
  %r21 = call i64 @nova_rt_str_concat(i64 %r19, i64 %r20)
  %r22 = call i64 @nova_rt_print_any(i64 %r21)
  %r23.p = getelementptr inbounds [15 x i8], ptr @.str.3, i64 0, i64 0
  %r23 = ptrtoint ptr %r23.p to i64
  %r24 = load i64, ptr %slot.r2, align 8
  %r25 = call i64 @nova_rt_int_to_str(i64 %r24)
  %r26 = call i64 @nova_rt_str_concat(i64 %r23, i64 %r25)
  %r27.p = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r27 = ptrtoint ptr %r27.p to i64
  %r28 = call i64 @nova_rt_str_concat(i64 %r26, i64 %r27)
  %r29 = load i64, ptr %slot.t2, align 8
  %r30 = load i64, ptr %slot.t1, align 8
  %r31 = sub i64 %r29, %r30
  %r32 = add i64 1000000, 0
  %r33 = sdiv i64 %r31, %r32
  %r34 = call i64 @nova_rt_int_to_str(i64 %r33)
  %r35 = call i64 @nova_rt_str_concat(i64 %r28, i64 %r34)
  %r36.p = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [15 x i8] c"sum(10M)    = \00"
@.str.1 = private unnamed_addr constant [5 x i8] c" in \00"
@.str.2 = private unnamed_addr constant [4 x i8] c" ms\00"
@.str.3 = private unnamed_addr constant [15 x i8] c"primes(50K) = \00"
