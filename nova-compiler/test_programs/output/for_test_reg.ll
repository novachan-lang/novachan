...
for_exit2:
  ...
  %r20.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r20 = ptrtoint ptr %r20.p to i64
  %r21.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  %r21 = ptrtoint ptr %r21.p to i64
  %r18 = call i64 @nova_rt_list_create()
  call i64 @nova_rt_list_append(i64 %r18, i64 %r19)
  call i64 @nova_rt_list_append(i64 %r18, i64 %r20)
  call i64 @nova_rt_list_append(i64 %r18, i64 %r21)
  store i64 %r18, ptr %slot.words, align 8
  %r22 = load i64, ptr %slot.words, align 8
...
for_body4:
  ...
  store i64 %r27, ptr %slot.w, align 8
  %r28 = load i64, ptr %slot.w, align 8
  %r29 = call i64 @nova_rt_print_any(i64 %r28)
  %r30 = load i64, ptr %slot.__for_idx_3, align 8
  %r31 = add i64 1, 0
  %r32 = call i64 @nova_rt_add(i64 %r30, i64 %r31)
  store i64 %r32, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3
for_exit5:
  ret i64 0
}
