...
entry0:
  ...
  %t3 = call i64 @nova_rt_list_append(i64 %r13, i64 4)
  %t4 = call i64 @nova_rt_list_append(i64 %r13, i64 5)
  %t5 = call i64 @nova_rt_list_append(i64 %r13, i64 6)
  %r20 = call i64 @nova_rt_list_create()
  %t6 = call i64 @nova_rt_list_append(i64 %r20, i64 %r5)
  %t7 = call i64 @nova_rt_list_append(i64 %r20, i64 %r13)
  %r25 = call i64 @nova_rt_type_of(i64 %r5)
  %t8 = inttoptr i64 %r25 to ptr
  call i32 @puts(ptr %t8)
  %r28 = call i64 @nova_rt_type_of(i64 %r20)
  %t9 = inttoptr i64 %r28 to ptr
  call i32 @puts(ptr %t9)
  call i64 @nova_rt_list_print(i64 %r5)
  call i64 @nova_rt_list_print(i64 %r13)
  call i64 @nova_rt_list_print(i64 %r20)
  ret i64 0
}
