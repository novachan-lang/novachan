...
ifb_then1:
  ...
  %t5 = getelementptr inbounds [36 x i8], ptr @.str.3, i64 0, i64 0
  %r19 = ptrtoint ptr %t5 to i64
  %r20 = load i64, ptr %slot.ver, align 8
  %t6 = getelementptr inbounds [2 x i8], ptr @.str.4, i64 0, i64 0
  %r22 = ptrtoint ptr %t6 to i64
  %t7 = call i64 @nova_rt_str_concat(i64 %r16, i64 %r17)
  %t8 = call i64 @nova_rt_str_concat(i64 %t7, i64 %r19)
  call void @nova_rc_dec(i64 %t7)
  %t9 = call i64 @nova_rt_str_concat(i64 %t8, i64 %r20)
  call void @nova_rc_dec(i64 %t8)
  %t10 = call i64 @nova_rt_str_concat(i64 %t9, i64 %r22)
  call void @nova_rc_dec(i64 %t9)
  call void @nova_rc_dec(i64 %r17)
  call void @nova_rc_dec(i64 %r20)
...
ifb_merge3:
  ...
  %t13 = inttoptr i64 %r29 to ptr
  call i32 @puts(ptr %t13)
  call void @nova_rc_inc(i64 0)
  %t14 = load i64, ptr %slot.name, align 8
  call void @nova_rc_dec(i64 %t14)
  %t15 = load i64, ptr %slot.ver, align 8
