...
__mb0_entry0:
  ...
  %r92 = load i64, ptr %slot.__mb0_n, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r73 = load i64, ptr %slot.__mb0_i, align 8
  %t0 = icmp slt i64 %r73, %r92
  br i1 %t0, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r77 = load i64, ptr %slot.__mb0_total, align 8
...
__mb0_merge:
  ...
  %t7 = call i64 @nova_rt_str_concat(i64 %t5, i64 %r41)
  call void @nova_rc_dec(i64 %t5)
  %t8 = inttoptr i64 %t7 to ptr
  call i32 @puts(ptr %t8)
  call void @nova_rc_dec(i64 %t7)
  %t9 = getelementptr inbounds [15 x i8], ptr @.str.3, i64 0, i64 0
  %r44 = ptrtoint ptr %t9 to i64
  %r46 = call i64 @nova_rt_int_to_str(i64 %r19)
  %t10 = call i64 @nova_rt_str_concat(i64 %r44, i64 %r46)
  call void @nova_rc_dec(i64 %r46)
  %t11 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r48 = ptrtoint ptr %t11 to i64
  %t12 = call i64 @nova_rt_str_concat(i64 %t10, i64 %r48)
  call void @nova_rc_dec(i64 %t10)
  %r52 = sub i64 %r24, %r13
  %r54 = sdiv i64 %r52, 1000000
  %r55 = call i64 @nova_rt_int_to_str(i64 %r54)
  %t13 = call i64 @nova_rt_str_concat(i64 %t12, i64 %r55)
  ...
  %t15 = call i64 @nova_rt_str_concat(i64 %t13, i64 %r57)
