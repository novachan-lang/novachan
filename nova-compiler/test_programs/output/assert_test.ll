...
entry0:
  ...
  call void @nova_rt_assert(i64 1, i64 %r3)
  %t1 = getelementptr inbounds [11 x i8], ptr @.str.1, i64 0, i64 0
  %r10 = ptrtoint ptr %t1 to i64
  call void @nova_rt_assert(i64 1, i64 %r10)
  %t2 = getelementptr inbounds [11 x i8], ptr @.str.2, i64 0, i64 0
  %r15 = ptrtoint ptr %t2 to i64
  call void @nova_rt_assert(i64 1, i64 %r15)
  %t3 = getelementptr inbounds [17 x i8], ptr @.str.3, i64 0, i64 0
  %r25 = ptrtoint ptr %t3 to i64
  call void @nova_rt_assert(i64 1, i64 %r25)
  %t4 = getelementptr inbounds [14 x i8], ptr @.str.4, i64 0, i64 0
  %r32 = ptrtoint ptr %t4 to i64
  call void @nova_rt_assert(i64 1, i64 %r32)
  %t5 = getelementptr inbounds [23 x i8], ptr @.str.5, i64 0, i64 0
  %r34 = ptrtoint ptr %t5 to i64
  %t6 = inttoptr i64 %r34 to ptr
