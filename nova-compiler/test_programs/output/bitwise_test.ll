...
@.str.0 = private unnamed_addr constant [11 x i8] c"AND failed\00"
@.str.1 = private unnamed_addr constant [10 x i8] c"OR failed\00"
@.str.2 = private unnamed_addr constant [11 x i8] c"XOR failed\00"
@.str.3 = private unnamed_addr constant [11 x i8] c"SHL failed\00"
@.str.4 = private unnamed_addr constant [11 x i8] c"SHR failed\00"
@.str.5 = private unnamed_addr constant [13 x i8] c"NOT 0 failed\00"
@.str.6 = private unnamed_addr constant [13 x i8] c"NOT 1 failed\00"
@.str.7 = private unnamed_addr constant [12 x i8] c"mask failed\00"
@.str.8 = private unnamed_addr constant [15 x i8] c"set bit failed\00"
@.str.9 = private unnamed_addr constant [14 x i8] c"toggle failed\00"
@.str.10 = private unnamed_addr constant [18 x i8] c"precedence failed\00"
@.str.11 = private unnamed_addr constant [20 x i8] c"BITWISE: ALL PASSED\00"
...
entry0:
  ...
  %r16 = ptrtoint ptr %t0 to i64
  call void @nova_rt_assert(i64 1, i64 %r16)
  %t1 = getelementptr inbounds [10 x i8], ptr @.str.1, i64 0, i64 0
  %r23 = ptrtoint ptr %t1 to i64
  call void @nova_rt_assert(i64 1, i64 %r23)
  %t2 = getelementptr inbounds [11 x i8], ptr @.str.2, i64 0, i64 0
  %r30 = ptrtoint ptr %t2 to i64
  call void @nova_rt_assert(i64 1, i64 %r30)
  %t3 = getelementptr inbounds [11 x i8], ptr @.str.3, i64 0, i64 0
  %r37 = ptrtoint ptr %t3 to i64
  call void @nova_rt_assert(i64 1, i64 %r37)
  %t4 = getelementptr inbounds [11 x i8], ptr @.str.4, i64 0, i64 0
  %r44 = ptrtoint ptr %t4 to i64
  call void @nova_rt_assert(i64 1, i64 %r44)
  %r46 = xor i64 0, -1
  %t5 = icmp eq i64 %r46, -1
  %r50 = zext i1 %t5 to i64
  %t6 = getelementptr inbounds [13 x i8], ptr @.str.5, i64 0, i64 0
  %r51 = ptrtoint ptr %t6 to i64
  call void @nova_rt_assert(i64 %r50, i64 %r51)
  %r53 = xor i64 1, -1
  %t7 = icmp eq i64 %r53, -2
  %r57 = zext i1 %t7 to i64
  %t8 = getelementptr inbounds [13 x i8], ptr @.str.6, i64 0, i64 0
  %r58 = ptrtoint ptr %t8 to i64
  call void @nova_rt_assert(i64 %r57, i64 %r58)
  %t9 = getelementptr inbounds [12 x i8], ptr @.str.7, i64 0, i64 0
  %r70 = ptrtoint ptr %t9 to i64
  call void @nova_rt_assert(i64 1, i64 %r70)
  %t10 = getelementptr inbounds [15 x i8], ptr @.str.8, i64 0, i64 0
  %r77 = ptrtoint ptr %t10 to i64
  call void @nova_rt_assert(i64 1, i64 %r77)
  %t11 = getelementptr inbounds [14 x i8], ptr @.str.9, i64 0, i64 0
  %r84 = ptrtoint ptr %t11 to i64
  call void @nova_rt_assert(i64 1, i64 %r84)
  %t12 = getelementptr inbounds [18 x i8], ptr @.str.10, i64 0, i64 0
  %r96 = ptrtoint ptr %t12 to i64
  call void @nova_rt_assert(i64 1, i64 %r96)
  %t13 = getelementptr inbounds [20 x i8], ptr @.str.11, i64 0, i64 0
  %r98 = ptrtoint ptr %t13 to i64
  %t14 = inttoptr i64 %r98 to ptr
