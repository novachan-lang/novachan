...
entry0:
  %t0 = getelementptr inbounds [22 x i8], ptr @.str.0, i64 0, i64 0
  %r1 = ptrtoint ptr %t0 to i64
  %r2 = call i64 @nova_rt_write_raw(i64 %r1)
  %t1 = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r3 = ptrtoint ptr %t1 to i64
  %r4 = call i64 @nova_rt_write_raw(i64 %r3)
  ...
  %t4 = getelementptr inbounds [22 x i8], ptr @.str.3, i64 0, i64 0
