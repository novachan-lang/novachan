...
entry:
  ...
  %r3.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r1 = call i64 @nova_rt_list_create()
  call i64 @nova_rt_list_append(i64 %r1, i64 %r2)
  call i64 @nova_rt_list_append(i64 %r1, i64 %r3)
  call i64 @nova_rt_list_append(i64 %r1, i64 %r4)
  store i64 %r1, ptr %slot.words, align 8
  %r5 = load i64, ptr %slot.words, align 8
...
for_body1:
  %r10.lp = inttoptr i64 %r5 to ptr
  %r10.dp = load ptr, ptr %r10.lp, align 8, !tbaa !2
  %r10.ep = getelementptr i64, ptr %r10.dp, i64 %r8
  %r10 = load i64, ptr %r10.ep, align 8, !tbaa !4
  store i64 %r10, ptr %slot.w, align 8
  ...
  %r16 = load i64, ptr %slot.__for_idx_0, align 8
  %r17 = add i64 1, 0
  %r18 = add i64 %r16, %r17
  store i64 %r18, ptr %slot.__for_idx_0, align 8
  br label %for_hdr0, !llvm.loop !91
for_exit2:
  ...
  %r24 = add i64 0, 0
  %r25.lp = inttoptr i64 %r23 to ptr
  %r25.dp = load ptr, ptr %r25.lp, align 8, !tbaa !2
  %r25.ep = getelementptr i64, ptr %r25.dp, i64 %r24
  %r25 = load i64, ptr %r25.ep, align 8, !tbaa !4
  %r26.ptr = inttoptr i64 %r25 to ptr
  %r26.gep = getelementptr i64, ptr %r26.ptr, i64 0
  %r26 = load i64, ptr %r26.gep, align 8
  %r27 = add i64 210691276070, 0
  %r28.cmp = icmp eq i64 %r26, %r27
  %r28 = zext i1 %r28.cmp to i64
  %br_marm_04 = icmp ne i64 %r28, 0
  br i1 %br_marm_04, label %marm_04, label %match_fall5
marm_04:
  %r29.ptr = inttoptr i64 %r25 to ptr
  %r29.gep = getelementptr i64, ptr %r29.ptr, i64 1
  %r29 = load i64, ptr %r29.gep, align 8
  store i64 %r29, ptr %slot.kind, align 8
  %r30.ptr = inttoptr i64 %r25 to ptr
  %r30.gep = getelementptr i64, ptr %r30.ptr, i64 2
