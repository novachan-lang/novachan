...
entry0:
  ...
  %r8 = call i64 @nova_rt_str_char_at(i64 %r1, i64 0)
  %r15 = call i64 @nova_rt_str_char_at(i64 %r1, i64 4)
  %t1 = inttoptr i64 %r8 to ptr
  call i32 @puts(ptr %t1)
  %t2 = inttoptr i64 %r15 to ptr
  call i32 @puts(ptr %t2)
  %r25 = call i64 @nova_rt_str_char_at(i64 %r1, i64 1)
  %t3 = inttoptr i64 %r25 to ptr
  call i32 @puts(ptr %t3)
  %r28 = call i64 @nova_rt_len(i64 %r1)
  %r30 = add i64 %r28, -1
  %r31 = call i64 @nova_rt_str_char_at(i64 %r1, i64 %r30)
  ...
  %r40 = call i64 @nova_rt_str_char_at(i64 %r34, i64 0)
  %r43 = call i64 @nova_rt_str_char_at(i64 %r34, i64 1)
  %t6 = call i64 @nova_rt_str_concat(i64 %r40, i64 %r43)
  %r47 = call i64 @nova_rt_str_char_at(i64 %r34, i64 2)
  %t7 = call i64 @nova_rt_str_concat(i64 %t6, i64 %r47)
  call void @nova_rc_dec(i64 %t6)
  %r51 = call i64 @nova_rt_str_char_at(i64 %r34, i64 3)
  %t8 = call i64 @nova_rt_str_concat(i64 %t7, i64 %r51)
