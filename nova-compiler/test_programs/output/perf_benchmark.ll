...
while_header4:
  ...
  %r29 = mul i64 %r27, %r28
  %t1 = icmp sle i64 %r29, %r74
  br i1 %t1, label %while_body5, label %while_exit6, !prof !90

while_body5:
  %r34 = load i64, ptr %slot.d, align 8
  %r35 = srem i64 %r74, %r34
  %t2 = icmp eq i64 %r35, 0
  br i1 %t2, label %ifb_then7, label %ifb_else8

while_exit6:
  %r53 = load i64, ptr %slot.is_prime, align 8
  %t3 = icmp eq i64 %r53, 1
  br i1 %t3, label %ifb_then10, label %ifb_else11
...
ifb_merge9:
  ...
  %r49 = add i64 %r47, 1
  store i64 %r49, ptr %slot.d, align 8
  br label %while_header4, !llvm.loop !91

ifb_then10:
  %r58 = load i64, ptr %slot.count, align 8
  %r60 = add i64 %r58, 1
  store i64 %r60, ptr %slot.count, align 8
...
ifb_merge12:
  ...
  %r69 = add i64 %r67, 1
  store i64 %r69, ptr %slot.n, align 8
...
__mb0_entry0:
  store i64 100000000, ptr %slot.__mb0_n, align 8
  store i64 0, ptr %slot.__mb0_total, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r130 = load i64, ptr %slot.__mb0_n, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r111 = load i64, ptr %slot.__mb0_i, align 8
  %t0 = icmp slt i64 %r111, %r130
  br i1 %t0, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r115 = load i64, ptr %slot.__mb0_total, align 8
  %r116 = load i64, ptr %slot.__mb0_i, align 8
  %r117 = add i64 %r115, %r116
  store i64 %r117, ptr %slot.__mb0_total, align 8
  %r120 = load i64, ptr %slot.__mb0_i, align 8
  %r122 = add i64 %r120, 1
  store i64 %r122, ptr %slot.__mb0_i, align 8
  br label %__mb0_while_header1, !llvm.loop !91

__mb0_while_exit3:
  %r126 = load i64, ptr %slot.__mb0_total, align 8
...
__mb0_merge:
  ...
  %r30 = call i64 @count_primes(i64 100000)
  %r35 = call i64 @nova_rt_clock_ns()
  %t1 = getelementptr inbounds [17 x i8], ptr @.str.0, i64 0, i64 0
  %r39 = ptrtoint ptr %t1 to i64
  %r40 = load i64, ptr %slot.r1, align 8
  %r41 = call i64 @nova_rt_int_to_str(i64 %r40)
  %t2 = call i64 @nova_rt_str_concat(i64 %r39, i64 %r41)
  call void @nova_rc_dec(i64 %r41)
  %t3 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  %r43 = ptrtoint ptr %t3 to i64
  %t4 = call i64 @nova_rt_str_concat(i64 %t2, i64 %r43)
  call void @nova_rc_dec(i64 %t2)
  %r45 = load i64, ptr %slot.t1, align 8
  %r46 = load i64, ptr %slot.t0, align 8
  %r47 = sub i64 %r45, %r46
  %r49 = sdiv i64 %r47, 1000000
  %r50 = call i64 @nova_rt_int_to_str(i64 %r49)
  %t5 = call i64 @nova_rt_str_concat(i64 %t4, i64 %r50)
  call void @nova_rc_dec(i64 %t4)
  call void @nova_rc_dec(i64 %r50)
  %t6 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  %r52 = ptrtoint ptr %t6 to i64
  %t7 = call i64 @nova_rt_str_concat(i64 %t5, i64 %r52)
  ...
  %r55 = ptrtoint ptr %t9 to i64
  %r57 = call i64 @nova_rt_int_to_str(i64 %r127)
  %t10 = call i64 @nova_rt_str_concat(i64 %r55, i64 %r57)
  call void @nova_rc_dec(i64 %r57)
  %t11 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  %r59 = ptrtoint ptr %t11 to i64
  %t12 = call i64 @nova_rt_str_concat(i64 %t10, i64 %r59)
  call void @nova_rc_dec(i64 %t10)
  %r62 = load i64, ptr %slot.t1, align 8
  %r63 = sub i64 %r24, %r62
  %r65 = sdiv i64 %r63, 1000000
  %r66 = call i64 @nova_rt_int_to_str(i64 %r65)
  %t13 = call i64 @nova_rt_str_concat(i64 %t12, i64 %r66)
  ...
  %t17 = getelementptr inbounds [17 x i8], ptr @.str.4, i64 0, i64 0
  %r71 = ptrtoint ptr %t17 to i64
  %r73 = call i64 @nova_rt_int_to_str(i64 %r30)
  %t18 = call i64 @nova_rt_str_concat(i64 %r71, i64 %r73)
  call void @nova_rc_dec(i64 %r73)
  %t19 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  %r75 = ptrtoint ptr %t19 to i64
  %t20 = call i64 @nova_rt_str_concat(i64 %t18, i64 %r75)
  call void @nova_rc_dec(i64 %t18)
  %r79 = sub i64 %r35, %r24
  %r81 = sdiv i64 %r79, 1000000
  %r82 = call i64 @nova_rt_int_to_str(i64 %r81)
  %t21 = call i64 @nova_rt_str_concat(i64 %t20, i64 %r82)
  ...
  %t23 = call i64 @nova_rt_str_concat(i64 %t21, i64 %r84)
  call void @nova_rc_dec(i64 %t21)
  %t24 = inttoptr i64 %t23 to ptr
  call i32 @puts(ptr %t24)
  call void @nova_rc_dec(i64 %t23)
  %t25 = getelementptr inbounds [17 x i8], ptr @.str.5, i64 0, i64 0
  %r87 = ptrtoint ptr %t25 to i64
  %r89 = load i64, ptr %slot.t0, align 8
  %r90 = sub i64 %r35, %r89
  %r92 = sdiv i64 %r90, 1000000
  %r93 = call i64 @nova_rt_int_to_str(i64 %r92)
  %t26 = call i64 @nova_rt_str_concat(i64 %r87, i64 %r93)
  call void @nova_rc_dec(i64 %r93)
  %t27 = getelementptr inbounds [4 x i8], ptr @.str.6, i64 0, i64 0
  %r95 = ptrtoint ptr %t27 to i64
  %t28 = call i64 @nova_rt_str_concat(i64 %t26, i64 %r95)
