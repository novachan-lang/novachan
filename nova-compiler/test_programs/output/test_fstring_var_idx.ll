...
entry0:
  ...
  %t3 = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0
  %r14 = ptrtoint ptr %t3 to i64
  %t4 = inttoptr i64 %r5 to ptr
  %t5 = load ptr, ptr %t4, align 8, !tbaa !2
  %t6 = getelementptr i64, ptr %t5, i64 1
  %r17 = load i64, ptr %t6, align 8, !tbaa !4
  call void @nova_rc_dec(i64 %r5)
  %r18 = call i64 @nova_rt_int_to_str(i64 %r17)
  %t7 = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
  %r19 = ptrtoint ptr %t7 to i64
  %t8 = call i64 @nova_rt_str_concat(i64 %r14, i64 %r18)
  %t9 = call i64 @nova_rt_str_concat(i64 %t8, i64 %r19)
