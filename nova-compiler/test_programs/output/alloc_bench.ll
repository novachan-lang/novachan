...
__mb0_entry0:
  store i64 100000, ptr %slot.__mb0_n, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r82 = load i64, ptr %slot.__mb0_n, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r26 = load i64, ptr %slot.__mb0_i, align 8
  %t0 = icmp slt i64 %r26, %r82
...
__mb0_while_exit3:
  %r45 = load i64, ptr %slot.__mb0_n, align 8
  store i64 %r45, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r46 = load i64, ptr %slot.__mb0_ret, align 8
  store i64 %r46, ptr %slot.r1, align 8
  br label %__mb1_entry0

__mb1_entry0:
  store i64 100000, ptr %slot.__mb1_n, align 8
  store i64 0, ptr %slot.__mb1_i, align 8
  %r83 = load i64, ptr %slot.__mb1_n, align 8
  br label %__mb1_while_header1

__mb1_while_header1:
  %r58 = load i64, ptr %slot.__mb1_i, align 8
  %t1 = icmp slt i64 %r58, %r83
  br i1 %t1, label %__mb1_while_body2, label %__mb1_while_exit3, !prof !90

__mb1_while_body2:
  %r72 = load i64, ptr %slot.__mb1_i, align 8
  %r74 = add i64 %r72, 1
  store i64 %r74, ptr %slot.__mb1_i, align 8
  br label %__mb1_while_header1, !llvm.loop !91

__mb1_while_exit3:
  %r78 = load i64, ptr %slot.__mb1_n, align 8
  store i64 %r78, ptr %slot.__mb1_ret, align 8
  br label %__mb1_merge

__mb1_merge:
  %r79 = load i64, ptr %slot.__mb1_ret, align 8
  %r13 = load i64, ptr %slot.r1, align 8
  ...
  call i32 (ptr, ...) @printf(ptr %t3, i64 %r79)
  ret i64 0
}
