...
entry:
  ...
  %r10 = load i64, ptr %slot.Person, align 8
  store i64 %r10, ptr %slot.alice, align 8
  %r11 = call i64 @nova_rt_dict_create()
  %r12 = add i64 0, 0
  %r13 = add i64 0, 0
  call i64 @nova_rt_dict_set(i64 %r11, i64 %r12, i64 %r13)
  %r14 = load i64, ptr %slot.alice, align 8
  ...
  %r17 = load i64, ptr %slot.alice, align 8
