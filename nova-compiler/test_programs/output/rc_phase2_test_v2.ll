...
define i64 @test_list_temp() nounwind {
entry:
...
define i64 @test_nested() nounwind {
entry:
  ...
  %r8 = call i64 @nova_rt_len_any(i64 %r6)
...
define i64 @test_string_chain() nounwind {
entry:
  ...
  %r3 = call i64 @nova_rt_lower(i64 %r2)
  %r4 = call i64 @nova_rt_add(i64 %r1, i64 %r3)
  %r5 = call i64 @nova_rt_len_any(i64 %r4)
  store i64 %r5, ptr %slot.n, align 8
  %r6 = load i64, ptr %slot.n, align 8
...
entry:
  %r0 = call i64 @test_list_temp()
  %r1 = call i64 @test_nested()
  %r2 = call i64 @test_string_chain()
