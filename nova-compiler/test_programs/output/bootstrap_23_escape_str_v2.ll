...
entry:
  ...
  store i64 %r0, ptr %slot.msg, align 8
  %r1 = load i64, ptr %slot.msg, align 8
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3.p = getelementptr inbounds [10 x i8], ptr @.str.1, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  store i64 %r3, ptr %slot.row, align 8
  %r4 = load i64, ptr %slot.row, align 8
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6.p = getelementptr inbounds [14 x i8], ptr @.str.2, i64 0, i64 0
  %r6 = ptrtoint ptr %r6.p to i64
  store i64 %r6, ptr %slot.path, align 8
  %r7 = load i64, ptr %slot.path, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9.p = getelementptr inbounds [25 x i8], ptr @.str.3, i64 0, i64 0
  %r9 = ptrtoint ptr %r9.p to i64
  store i64 %r9, ptr %slot.code, align 8
  %r10 = load i64, ptr %slot.code, align 8
  %r11 = call i64 @nova_rt_print_any(i64 %r10)
  %r12.p = getelementptr inbounds [1 x i8], ptr @.str.4, i64 0, i64 0
  %r12 = ptrtoint ptr %r12.p to i64
  store i64 %r12, ptr %slot.empty, align 8
  %r13 = load i64, ptr %slot.empty, align 8
...
; String constants
@.str.0 = private unnamed_addr constant [12 x i8] c"line1\0Aline2\00"
@.str.1 = private unnamed_addr constant [10 x i8] c"col1\09col2\00"
@.str.2 = private unnamed_addr constant [14 x i8] c"C:\\Users\\test\00"
@.str.3 = private unnamed_addr constant [25 x i8] c"fn main() {\0A\09return 0;\0A}\00"
