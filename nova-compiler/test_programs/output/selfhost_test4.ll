...
__mb0_merge:
  %r23 = load i64, ptr %slot.__mb0_ret, align 8
  %t0 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t0, i64 %r23)
...
__mb1_merge:
  %r40 = load i64, ptr %slot.__mb1_ret, align 8
  %t1 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t1, i64 %r40)
...
__mb2_merge:
  %r57 = load i64, ptr %slot.__mb2_ret, align 8
  %t2 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t2, i64 %r57)
  ret i64 0
}
