...
@.str.0 = private unnamed_addr constant [10 x i8] c"127.0.0.1\00"
@.str.1 = private unnamed_addr constant [41 x i8] c"GET /hello HTTP/1.1\0D\0AHost: localhost\0D\0A\0D\0A\00"
@.str.2 = private unnamed_addr constant [7 x i8] c"200 OK\00"
@.str.3 = private unnamed_addr constant [11 x i8] c"status 200\00"
@.str.4 = private unnamed_addr constant [11 x i8] c"method=GET\00"
@.str.5 = private unnamed_addr constant [14 x i8] c"method parsed\00"
@.str.6 = private unnamed_addr constant [12 x i8] c"path=/hello\00"
@.str.7 = private unnamed_addr constant [12 x i8] c"path parsed\00"
@.str.8 = private unnamed_addr constant [17 x i8] c"HTTP: ALL PASSED\00"
@.str.9 = private unnamed_addr constant [8 x i8] c"method=\00"
@.str.10 = private unnamed_addr constant [7 x i8] c" path=\00"
...
entry0:
  ...
  store i64 19877, ptr %t2
  %t3 = ptrtoint ptr @__nova_spawn_tramp_1 to i64
  %t4 = ptrtoint ptr %t0 to i64
  %r5 = call i64 @nova_rt_spawn(i64 %t3, i64 %t4)
  call void @nova_rt_sleep_ms(i64 100)
  %t5 = getelementptr inbounds [10 x i8], ptr @.str.0, i64 0, i64 0
  %r8 = ptrtoint ptr %t5 to i64
  %r10 = call i64 @nova_rt_tcp_connect(i64 %r8, i64 19877)
  %t6 = getelementptr inbounds [41 x i8], ptr @.str.1, i64 0, i64 0
  %r15 = ptrtoint ptr %t6 to i64
  %r16 = call i64 @nova_rt_tcp_send(i64 %r10, i64 %r15)
  call void @nova_rt_sleep_ms(i64 50)
  %r20 = call i64 @nova_rt_tcp_recv(i64 %r10)
  %r25 = call i64 @nova_rt_tcp_recv(i64 %r10)
  %r31 = call i64 @nova_rt_str_concat(i64 %r20, i64 %r25)
  %r35 = call i64 @nova_rt_tcp_close(i64 %r10)
  %t7 = getelementptr inbounds [7 x i8], ptr @.str.2, i64 0, i64 0
  %r37 = ptrtoint ptr %t7 to i64
  %r38 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r37)
  %t8 = getelementptr inbounds [11 x i8], ptr @.str.3, i64 0, i64 0
  %r39 = ptrtoint ptr %t8 to i64
  call void @nova_rt_assert(i64 %r38, i64 %r39)
  %t9 = getelementptr inbounds [11 x i8], ptr @.str.4, i64 0, i64 0
  %r42 = ptrtoint ptr %t9 to i64
  %r43 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r42)
  %t10 = getelementptr inbounds [14 x i8], ptr @.str.5, i64 0, i64 0
  %r44 = ptrtoint ptr %t10 to i64
  call void @nova_rt_assert(i64 %r43, i64 %r44)
  %t11 = getelementptr inbounds [12 x i8], ptr @.str.6, i64 0, i64 0
  %r47 = ptrtoint ptr %t11 to i64
  %r48 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r47)
  %t12 = getelementptr inbounds [12 x i8], ptr @.str.7, i64 0, i64 0
  %r49 = ptrtoint ptr %t12 to i64
  call void @nova_rt_assert(i64 %r48, i64 %r49)
  %t13 = getelementptr inbounds [17 x i8], ptr @.str.8, i64 0, i64 0
  %r51 = ptrtoint ptr %t13 to i64
  %t14 = inttoptr i64 %r51 to ptr
...
entry0:
  %r9 = call i64 @nova_rt_http_listen(i64 %p0)
  %r10 = call i64 @nova_rt_http_accept(i64 %r9)
  %r12 = call i64 @nova_rt_list_get(i64 %r10, i64 0)
  %r14 = call i64 @nova_rt_list_get(i64 %r10, i64 1)
  %r16 = call i64 @nova_rt_list_get(i64 %r10, i64 2)
  %t0 = getelementptr inbounds [8 x i8], ptr @.str.9, i64 0, i64 0
  %r18 = ptrtoint ptr %t0 to i64
  %t1 = call i64 @nova_rt_str_concat(i64 %r18, i64 %r14)
  %t2 = getelementptr inbounds [7 x i8], ptr @.str.10, i64 0, i64 0
  %r20 = ptrtoint ptr %t2 to i64
  %t3 = call i64 @nova_rt_str_concat(i64 %t1, i64 %r20)
  call void @nova_rc_dec(i64 %t1)
  %t4 = call i64 @nova_rt_str_concat(i64 %t3, i64 %r16)
  call void @nova_rc_dec(i64 %t3)
  %r23 = call i64 @nova_rt_http_respond(i64 %r12, i64 200, i64 %t4)
  %r24 = call i64 @nova_rt_tcp_close(i64 %r9)
  ret i64 %r24
}
