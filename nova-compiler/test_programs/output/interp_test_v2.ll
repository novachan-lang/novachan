...
entry:
  ...
  %r1.p = getelementptr inbounds [8 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %r5.p = getelementptr inbounds [2 x i8], ptr @.str.2, i64 0, i64 0
  %r5 = ptrtoint ptr %r5.p to i64
  %r6 = call i64 @nova_rt_str_concat(i64 %r4, i64 %r5)
  store i64 %r6, ptr %slot.greeting, align 8
  %r7 = load i64, ptr %slot.greeting, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = add i64 42, 0
  store i64 %r9, ptr %slot.x, align 8
  %r10.p = getelementptr inbounds [15 x i8], ptr @.str.3, i64 0, i64 0
  ...
  %r27 = call i64 @nova_rt_any_to_str(i64 %r26)
  %r28 = call i64 @nova_rt_str_concat(i64 %r25, i64 %r27)
  %r29.p = getelementptr inbounds [4 x i8], ptr @.str.6, i64 0, i64 0
...
@.str.3 = private unnamed_addr constant [15 x i8] c"The answer is \00"
