...
@.str.1 = private unnamed_addr constant [13 x i8] c"Hello, NOVA!\00"
@.str.2 = private unnamed_addr constant [17 x i8] c"The number is 42\00"
@.str.3 = private unnamed_addr constant [18 x i8] c"The number is 100\00"
@.str.4 = private unnamed_addr constant [11 x i8] c"sum = 1000\00"
@.str.5 = private unnamed_addr constant [7 x i8] c"pi = 3\00"
...
entry0:
  ...
  %r28 = ptrtoint ptr %t0 to i64
  %t1 = inttoptr i64 %r28 to ptr
  call i32 @puts(ptr %t1)
  %t2 = getelementptr inbounds [13 x i8], ptr @.str.1, i64 0, i64 0
  %r36 = ptrtoint ptr %t2 to i64
  %t3 = inttoptr i64 %r36 to ptr
  call i32 @puts(ptr %t3)
  %t4 = getelementptr inbounds [17 x i8], ptr @.str.2, i64 0, i64 0
  %r44 = ptrtoint ptr %t4 to i64
  %t5 = inttoptr i64 %r44 to ptr
  call i32 @puts(ptr %t5)
  %t6 = getelementptr inbounds [18 x i8], ptr @.str.3, i64 0, i64 0
  %r52 = ptrtoint ptr %t6 to i64
  %t7 = inttoptr i64 %r52 to ptr
  call i32 @puts(ptr %t7)
  %t8 = getelementptr inbounds [11 x i8], ptr @.str.4, i64 0, i64 0
  %r65 = ptrtoint ptr %t8 to i64
  %t9 = inttoptr i64 %r65 to ptr
  call i32 @puts(ptr %t9)
  %t10 = getelementptr inbounds [7 x i8], ptr @.str.5, i64 0, i64 0
  %r78 = ptrtoint ptr %t10 to i64
  %t11 = inttoptr i64 %r78 to ptr
