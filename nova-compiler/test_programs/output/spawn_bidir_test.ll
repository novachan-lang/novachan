...
entry0:
  ...
  %r10 = call i64 @nova_rt_spawn(i64 %t4, i64 %t5)
  %t6 = call i64 @nova_rt_channel_send(i64 %r0, i64 7)
  %r15 = call i64 @nova_rt_channel_recv(i64 %r4)
  %t7 = call i64 @nova_rt_any_to_str(i64 %r15)
...
entry0:
  ...
  %r21 = mul i64 %r14, %r14
  %t0 = call i64 @nova_rt_channel_send(i64 %p1, i64 %r21)
  ret i64 0
}
