...
ifb_then1:
  ...
  %t3 = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
  %r14 = ptrtoint ptr %t3 to i64
  %t4 = call i64 @nova_rt_str_concat(i64 %r11, i64 %r12)
  %t5 = call i64 @nova_rt_str_concat(i64 %t4, i64 %r14)
...
ifb_merge3:
  ...
  %t8 = inttoptr i64 %r21 to ptr
  call i32 @puts(ptr %t8)
  call void @nova_rc_inc(i64 0)
  %t9 = load i64, ptr %slot.name, align 8
