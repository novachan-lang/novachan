...
entry0:
  ...
  %t4 = ptrtoint ptr @makeAdder_lambda0_tramp to i64
  store i64 %t4, ptr %t3
  %t5 = getelementptr i64, ptr %t3, i64 1
  store i64 10, ptr %t5
  %r34 = ptrtoint ptr %t3 to i64
  %r12 = call i64 @makeAdder_lambda0(i64 3, i64 5)
  %t6 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t6, i64 %r12)
  %r16 = call i64 @makeAdder_lambda0(i64 3, i64 10)
  %t7 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t7, i64 %r16)
  %r21 = call i64 @makeAdder_lambda0(i64 1, i64 10)
  %r22 = call i64 @makeAdder_lambda0(i64 %r21, i64 5)
  %t8 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t8, i64 %r22)
  ret i64 0
}
