...
entry:
  ...
  %r2 = add i64 1, 0
  %r3 = add i64 %r1, %r2
  store i64 %r3, ptr %slot.y, align 8
...
then0:
  ...
  br label %endif2
else1:
  %r11.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r11 = ptrtoint ptr %r11.p to i64
  %r12 = call i64 @nova_rt_print_any(i64 %r11)
  br label %endif2
endif2:
  %r13 = add i64 0, 0
  store i64 %r13, ptr %slot.total, align 8
  %r14 = add i64 0, 0
...
while_hdr3:
  ...
  %br_while_body4 = icmp ne i64 %r17, 0
...
while_body4:
  ...
  br label %while_hdr3
while_exit5:
  %r24 = load i64, ptr %slot.total, align 8
