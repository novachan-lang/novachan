...
entry:
  ...
  %r4 = add i64 10000000, 0
  %r5 = call i64 @sum_loop(i64 %r4)
  store i64 %r5, ptr %slot.r2, align 8
  %r6 = call i64 @nova_rt_clock_ns()
  store i64 %r6, ptr %slot.t2, align 8
  %r7 = load i64, ptr %slot.t1, align 8
  %r8 = load i64, ptr %slot.t0, align 8
  %r9 = sub i64 %r7, %r8
  %r10 = add i64 1000000, 0
  %r11 = sdiv i64 %r9, %r10
  store i64 %r11, ptr %slot.fib_ms, align 8
  %r12 = load i64, ptr %slot.t2, align 8
  %r13 = load i64, ptr %slot.t1, align 8
  %r14 = sub i64 %r12, %r13
  %r15 = add i64 1000000, 0
  %r16 = sdiv i64 %r14, %r15
  store i64 %r16, ptr %slot.sum_ms, align 8
  %r17.p = getelementptr inbounds [17 x i8], ptr @.str.0, i64 0, i64 0
  %r17 = ptrtoint ptr %r17.p to i64
  %r18 = load i64, ptr %slot.r1, align 8
