...
entry0:
  ...
  %t1 = load i64, ptr %slot.src, align 8
...
while_exit3:
  ...
  call i32 (ptr, ...) @printf(ptr %t8, i64 %r65)
  %r67 = load i64, ptr %slot.line, align 8
  %t9 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t9, i64 %r67)
  %t10 = load i64, ptr %slot.src, align 8
...
ifb_then4:
  ...
  %r39 = add i64 %r37, 1
  store i64 %r39, ptr %slot.line, align 8
  store i64 1, ptr %slot.col, align 8
...
ifb_else5:
  %r52 = load i64, ptr %slot.col, align 8
  %r54 = add i64 %r52, 1
  store i64 %r54, ptr %slot.col, align 8
