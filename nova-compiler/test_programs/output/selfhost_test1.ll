...
entry0:
  %r2 = call i64 @fib(i64 10)
  %t0 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t0, i64 %r2)
  %t1 = getelementptr inbounds [11 x i8], ptr @.str.0, i64 0, i64 0
  %r8 = ptrtoint ptr %t1 to i64
  %r10 = call i64 @nova_rt_int_to_str(i64 %r2)
  %t2 = call i64 @nova_rt_str_concat(i64 %r8, i64 %r10)
