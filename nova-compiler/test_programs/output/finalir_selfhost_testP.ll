...
entry:
  ...
  %r13 = add i64 0, 0
  store i64 %r13, ptr %slot.__for_idx_12, align 8
  br label %for_hdr12
for_hdr12:
  %r14 = load i64, ptr %slot.__for_idx_12, align 8
  %r15.cmp = icmp slt i64 %r14, %r12
  %r15 = zext i1 %r15.cmp to i64
  %br_for_body13 = icmp ne i64 %r15, 0
...
else16:
  br label %endif17
endif17:
  %r23 = load i64, ptr %slot.__for_idx_12, align 8
  %r24 = add i64 1, 0
  %r25 = add i64 %r23, %r24
  store i64 %r25, ptr %slot.__for_idx_12, align 8
  br label %for_hdr12
for_exit14:
  ret i64 0
}
