...
__mb0_entry0:
  ...
  store i64 %r1, ptr %slot.__mb0_s, align 8
  %r24 = call i64 @nova_rt_dict_create()
  %t2 = load i64, ptr %slot.__mb0_counts, align 8
  call void @nova_rc_dec(i64 %t2)
  store i64 %r24, ptr %slot.__mb0_counts, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r31 = load i64, ptr %slot.__mb0_s, align 8
  %r32 = load i64, ptr %slot.__mb0_counts, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r33 = load i64, ptr %slot.__mb0_i, align 8
  %r34 = call i64 @nova_rt_len(i64 %r31)
  %t3 = icmp slt i64 %r33, %r34
  br i1 %t3, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r36 = load i64, ptr %slot.__mb0_i, align 8
  %r37 = call i64 @nova_rt_str_char_at(i64 %r31, i64 %r36)
  ...
  %r39 = call i64 @nova_rt_contains(i64 %r32, i64 %r37)
  %t5 = trunc i64 %r39 to i1
  br i1 %t5, label %__mb0_ifb_then4, label %__mb0_ifb_else5

__mb0_while_exit3:
  %r40 = load i64, ptr %slot.__mb0_counts, align 8
...
__mb0_ifb_then4:
  %r41 = load i64, ptr %slot.__mb0_ch, align 8
  %r42 = call i64 @nova_rt_dict_get(i64 %r32, i64 %r41)
  %r44 = add i64 %r42, 1
  %r45 = load i64, ptr %slot.__mb0_ch, align 8
  %t7 = call i64 @nova_rt_dict_set(i64 %r32, i64 %r45, i64 %r44)
  br label %__mb0_ifb_merge6

__mb0_ifb_else5:
  %r49 = load i64, ptr %slot.__mb0_ch, align 8
  %t8 = call i64 @nova_rt_dict_set(i64 %r32, i64 %r49, i64 1)
  br label %__mb0_ifb_merge6

__mb0_ifb_merge6:
  %r52 = load i64, ptr %slot.__mb0_i, align 8
  %r54 = add i64 %r52, 1
  store i64 %r54, ptr %slot.__mb0_i, align 8
...
__mb0_merge:
  ...
  %r8 = call i64 @nova_rt_dict_get(i64 %r56, i64 %r7)
  %t10 = call i64 @nova_rt_any_to_str(i64 %r8)
  ...
  %r12 = call i64 @nova_rt_dict_get(i64 %r56, i64 %r11)
  %t13 = call i64 @nova_rt_any_to_str(i64 %r12)
  %t14 = inttoptr i64 %t13 to ptr
  call i32 @puts(ptr %t14)
  %t15 = getelementptr inbounds [2 x i8], ptr @.str.3, i64 0, i64 0
  %r15 = ptrtoint ptr %t15 to i64
  %r16 = call i64 @nova_rt_dict_get(i64 %r56, i64 %r15)
  %t16 = call i64 @nova_rt_any_to_str(i64 %r16)
  %t17 = inttoptr i64 %t16 to ptr
  call i32 @puts(ptr %t17)
  %r19 = call i64 @nova_rt_dict_len(i64 %r56)
  %t18 = getelementptr inbounds [5 x i8], ptr @.str.4, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t18, i64 %r19)
  %t19 = load i64, ptr %slot.__mb0_s, align 8
  call void @nova_rc_dec(i64 %t19)
  %t20 = load i64, ptr %slot.__mb0_counts, align 8
  call void @nova_rc_dec(i64 %t20)
  %t21 = load i64, ptr %slot.__mb0_ch, align 8
