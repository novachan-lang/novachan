...
while_hdr3:
  ...
  %t5 = icmp slt i64 %r2, %r3
  %r4 = zext i1 %t5 to i64
  %t6 = icmp ne i64 %r4, 0
  br i1 %t6, label %while_body4, label %while_exit5
while_body4:
  ...
  %r11 = call i64 @nova_rt_add(i64 %r10, i64 1)
...
entry:
  %r0 = call i64 @fib(i64 10)
  %r1 = call i64 @nova_rt_print_any(i64 %r0)
  %r2 = getelementptr inbounds [3 x i8], ptr @.str.1, i64 0, i64 0
  %r3 = ptrtoint ptr %r2 to i64
  %r4 = call i64 @repeat_str(i64 %r3, i64 4)
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6 = call i64 @fib(i64 0)
  %r7 = call i64 @nova_rt_print_any(i64 %r6)
  %r8 = call i64 @fib(i64 1)
  %r9 = call i64 @nova_rt_print_any(i64 %r8)
  %r10 = call i64 @fib(i64 7)
