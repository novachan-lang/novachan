...
__mb0_ifb_then1:
  %t7 = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
  %r21 = ptrtoint ptr %t7 to i64
  ...
  %t8 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r26 = ptrtoint ptr %t8 to i64
  %t9 = call i64 @nova_rt_str_concat(i64 %r21, i64 %r25)
  %t10 = call i64 @nova_rt_str_concat(i64 %t9, i64 %r26)
...
__mb0_ifb_merge3:
  ...
  %t14 = load i64, ptr %slot.__mb0_ret, align 8
...
__mb0_merge:
  ...
  %t16 = load i64, ptr %slot.__mb0_d, align 8
  call void @nova_rc_dec(i64 %t16)
  %t17 = load i64, ptr %slot.__mb0_k, align 8
