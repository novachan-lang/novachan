...
entry:
  ...
  store i64 %r3, ptr %slot.first, align 8
  %r4 = load i64, ptr %slot.s, align 8
  %r5 = add i64 4, 0
  %r6 = call i64 @nova_rt_index_get(i64 %r4, i64 %r5)
  store i64 %r6, ptr %slot.last, align 8
  %r7 = load i64, ptr %slot.first, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = load i64, ptr %slot.last, align 8
  ...
  %r16 = add i64 1, 0
  %r17 = sub i64 0, %r16
  %r18 = call i64 @nova_rt_index_get(i64 %r15, i64 %r17)
  %r19 = call i64 @nova_rt_print_any(i64 %r18)
  %r20.p = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r20 = ptrtoint ptr %r20.p to i64
  store i64 %r20, ptr %slot.word, align 8
  ...
  %r31 = call i64 @nova_rt_add(i64 %r27, i64 %r30)
  %r32 = load i64, ptr %slot.word, align 8
  %r33 = add i64 3, 0
  %r34 = call i64 @nova_rt_index_get(i64 %r32, i64 %r33)
  %r35 = call i64 @nova_rt_add(i64 %r31, i64 %r34)
