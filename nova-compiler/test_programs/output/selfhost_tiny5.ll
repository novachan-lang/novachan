...
entry0:
  ...
  %slot.__mb0___sc_or_0 = alloca i64, align 8
...
__mb0_entry0:
  %t1 = load i64, ptr %slot.__mb0_ch, align 8
  call void @nova_rc_dec(i64 %t1)
  store i64 %r1, ptr %slot.__mb0_ch, align 8
  store i64 1, ptr %slot.__mb0___sc_or_0, align 8
  %t2 = icmp ne i64 0, 0
  br i1 %t2, label %__mb0_sc_or_merge2, label %__mb0_sc_or_right1

__mb0_sc_or_right1:
  %r28 = load i64, ptr %slot.__mb0_ch, align 8
  %t3 = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0
  %r29 = ptrtoint ptr %t3 to i64
  %t4 = inttoptr i64 %r28 to ptr
  %t5 = inttoptr i64 %r29 to ptr
  %t6 = call i32 @strcmp(ptr %t4, ptr %t5)
  %t7 = icmp eq i32 %t6, 0
  %r30 = zext i1 %t7 to i64
  store i64 %r30, ptr %slot.__mb0___sc_or_0, align 8
  br label %__mb0_sc_or_merge2

__mb0_sc_or_merge2:
  %r32 = load i64, ptr %slot.__mb0___sc_or_0, align 8
  %t8 = trunc i64 %r32 to i1
  br i1 %t8, label %__mb0_ifb_then3, label %__mb0_ifb_else4
...
__mb0_merge:
  %r40 = load i64, ptr %slot.__mb0_ret, align 8
  %t9 = icmp ne i64 %r40, 0
  %t10 = getelementptr inbounds [5 x i8], ptr @.str.5, i64 0, i64 0
  %t11 = getelementptr inbounds [6 x i8], ptr @.str.6, i64 0, i64 0
  %t12 = select i1 %t9, ptr %t10, ptr %t11
  call i32 @puts(ptr %t12)
  %t13 = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0
  %r9 = ptrtoint ptr %t13 to i64
  br label %__mb1_entry0

__mb1_entry0:
  %t14 = load i64, ptr %slot.__mb1_ch, align 8
  call void @nova_rc_dec(i64 %t14)
  store i64 %r9, ptr %slot.__mb1_ch, align 8
  store i64 1, ptr %slot.__mb1___sc_or_0, align 8
  %t15 = icmp ne i64 0, 0
  br i1 %t15, label %__mb1_sc_or_merge2, label %__mb1_sc_or_right1

__mb1_sc_or_right1:
  %r55 = load i64, ptr %slot.__mb1_ch, align 8
  %t16 = getelementptr inbounds [2 x i8], ptr @.str.1, i64 0, i64 0
  %r56 = ptrtoint ptr %t16 to i64
  %t17 = inttoptr i64 %r55 to ptr
  %t18 = inttoptr i64 %r56 to ptr
  %t19 = call i32 @strcmp(ptr %t17, ptr %t18)
  %t20 = icmp eq i32 %t19, 0
  %r57 = zext i1 %t20 to i64
  store i64 %r57, ptr %slot.__mb1___sc_or_0, align 8
  br label %__mb1_sc_or_merge2

__mb1_sc_or_merge2:
  %r59 = load i64, ptr %slot.__mb1___sc_or_0, align 8
  %t21 = trunc i64 %r59 to i1
  br i1 %t21, label %__mb1_ifb_then3, label %__mb1_ifb_else4
...
__mb1_merge:
  %r67 = load i64, ptr %slot.__mb1_ret, align 8
  %t22 = icmp ne i64 %r67, 0
  %t23 = getelementptr inbounds [5 x i8], ptr @.str.5, i64 0, i64 0
  %t24 = getelementptr inbounds [6 x i8], ptr @.str.6, i64 0, i64 0
  %t25 = select i1 %t22, ptr %t23, ptr %t24
  call i32 @puts(ptr %t25)
  %t26 = load i64, ptr %slot.__mb0_ch, align 8
  call void @nova_rc_dec(i64 %t26)
  %t27 = load i64, ptr %slot.__mb1_ch, align 8
