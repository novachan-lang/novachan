...
declare ptr @nova_heap_alloc(i64, i64) nounwind
...
entry:
  ...
  %r0 = getelementptr inbounds [8 x i8], ptr @.str.0, i64 0, i64 0
...
entry:
  %r0 = call i64 @add(i64 10, i64 32)
  store i64 %r0, ptr %slot.x, align 8
  %r1 = load i64, ptr %slot.x, align 8
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  %r4 = ptrtoint ptr %r3 to i64
  %r5 = call i64 @greet(i64 %r4)
  store i64 %r5, ptr %slot.msg, align 8
  %r6 = load i64, ptr %slot.msg, align 8
