...
entry:
  ...
  %r0 = add i64 1, 0
  store i64 %r0, ptr %slot.run, align 8
  %r1 = add i64 2, 0
  store i64 %r1, ptr %slot.really, align 8
  %r2 = add i64 3, 0
  store i64 %r2, ptr %slot.red, align 8
  %r3 = add i64 4, 0
  store i64 %r3, ptr %slot.apple, align 8
  %r4 = add i64 5, 0
  store i64 %r4, ptr %slot.row, align 8
  %r5 = load i64, ptr %slot.run, align 8
  %r6 = call i64 @nova_rt_print_any(i64 %r5)
  %r7 = load i64, ptr %slot.really, align 8
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = load i64, ptr %slot.red, align 8
  %r10 = call i64 @nova_rt_print_any(i64 %r9)
  %r11 = load i64, ptr %slot.apple, align 8
  %r12 = call i64 @nova_rt_print_any(i64 %r11)
  %r13 = load i64, ptr %slot.row, align 8
