...
define i64 @char_at(i64 %p0, i64 %p1) nounwind {
entry:
  ...
  %r1 = load i64, ptr %slot.idx, align 8
...
entry:
  ...
  %r0 = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0
  %r1 = ptrtoint ptr %r0 to i64
  store i64 %r1, ptr %slot.x, align 8
  %r2 = load i64, ptr %slot.x, align 8
  %r3 = call i64 @char_at(i64 %r2, i64 0)
  store i64 %r3, ptr %slot.ch, align 8
  %r4 = load i64, ptr %slot.ch, align 8
