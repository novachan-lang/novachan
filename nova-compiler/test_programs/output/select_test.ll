...
entry0:
  ...
  %t10 = alloca [2 x i64], align 8
  %t11 = getelementptr [2 x i64], ptr %t10, i64 0, i64 0
  store i64 %r0, ptr %t11
  %t12 = getelementptr [2 x i64], ptr %t10, i64 0, i64 1
  store i64 %r4, ptr %t12
  %t13 = ptrtoint ptr %t10 to i64
  %r14 = call i64 @nova_rt_channel_select(i64 %t13, i64 2)
  %t14 = inttoptr i64 %r14 to ptr
  %t15 = getelementptr i64, ptr %t14, i64 1
  %r26 = load i64, ptr %t15
  %t16 = alloca [2 x i64], align 8
  %t17 = getelementptr [2 x i64], ptr %t16, i64 0, i64 0
  store i64 %r0, ptr %t17
  %t18 = getelementptr [2 x i64], ptr %t16, i64 0, i64 1
  store i64 %r4, ptr %t18
  %t19 = ptrtoint ptr %t16 to i64
  %r32 = call i64 @nova_rt_channel_select(i64 %t19, i64 2)
  %t20 = inttoptr i64 %r32 to ptr
  %t21 = getelementptr i64, ptr %t20, i64 1
  %r38 = load i64, ptr %t21
  %r44 = add i64 %r26, %r38
  %t22 = call i64 @nova_rt_any_to_str(i64 %r44)
