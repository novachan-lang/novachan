...
ifb_then1:
  ...
  %t6 = call i64 @nova_rt_any_to_str(i64 %r21)
...
ifb_merge3:
  ...
  %r31 = ptrtoint ptr %t8 to i64
  %t9 = inttoptr i64 %r31 to ptr
  call i32 @puts(ptr %t9)
  call void @nova_rc_inc(i64 0)
  %t10 = load i64, ptr %slot.d, align 8
  call void @nova_rc_dec(i64 %t10)
  %t11 = load i64, ptr %slot.k, align 8
