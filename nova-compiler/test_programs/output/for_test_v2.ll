...
entry:
  ...
  %r6 = add i64 0, 0
  store i64 %r6, ptr %slot.total, align 8
...
for_body1:
  %r12.lp = inttoptr i64 %r7 to ptr
  %r12.dp = load ptr, ptr %r12.lp, align 8, !tbaa !2
  %r12.ep = getelementptr i64, ptr %r12.dp, i64 %r10
  %r12 = load i64, ptr %r12.ep, align 8, !tbaa !4
  store i64 %r12, ptr %slot.n, align 8
  %r13 = load i64, ptr %slot.n, align 8
  %r14 = load i64, ptr %slot.total, align 8
  %r15 = call i64 @nova_rt_add(i64 %r14, i64 %r13)
...
for_exit2:
  ...
  %r22.p = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0
  %r22 = ptrtoint ptr %r22.p to i64
  %r23.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r23 = ptrtoint ptr %r23.p to i64
  %r24.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  ...
  store i64 %r21, ptr %slot.words, align 8
  %r25 = load i64, ptr %slot.words, align 8
  %r26 = call i64 @nova_rt_len_any(i64 %r25)
  %r27 = add i64 0, 0
  store i64 %r27, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3, !llvm.loop !91
for_hdr3:
  %r28 = load i64, ptr %slot.__for_idx_3, align 8
  %r29.cmp = icmp slt i64 %r28, %r26
  %r29 = zext i1 %r29.cmp to i64
  %br_for_body4 = icmp ne i64 %r29, 0
  br i1 %br_for_body4, label %for_body4, label %for_exit5, !prof !90
for_body4:
  %r30.lp = inttoptr i64 %r25 to ptr
  %r30.dp = load ptr, ptr %r30.lp, align 8, !tbaa !2
  %r30.ep = getelementptr i64, ptr %r30.dp, i64 %r28
  %r30 = load i64, ptr %r30.ep, align 8, !tbaa !4
  store i64 %r30, ptr %slot.w, align 8
  %r31 = load i64, ptr %slot.w, align 8
  %r32 = call i64 @nova_rt_print_any(i64 %r31)
  %r33 = load i64, ptr %slot.__for_idx_3, align 8
  %r34 = add i64 1, 0
  %r35 = add i64 %r33, %r34
  store i64 %r35, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3, !llvm.loop !91
for_exit5:
  ret i64 0
}
