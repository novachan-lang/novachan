...
or_rhs52:
  ...
  %r41.p0 = inttoptr i64 %r39 to ptr
  %r41.p1 = inttoptr i64 %r40 to ptr
  %r41.sc = call i32 @strcmp(ptr %r41.p0, ptr %r41.p1)
  %r41.cmp = icmp eq i32 %r41.sc, 0
...
or_rhs55:
  ...
  %r45.p0 = inttoptr i64 %r43 to ptr
  %r45.p1 = inttoptr i64 %r44 to ptr
  %r45.sc = call i32 @strcmp(ptr %r45.p0, ptr %r45.p1)
  %r45.cmp = icmp eq i32 %r45.sc, 0
...
or_rhs58:
  ...
  %r49.p0 = inttoptr i64 %r47 to ptr
  %r49.p1 = inttoptr i64 %r48 to ptr
  %r49.sc = call i32 @strcmp(ptr %r49.p0, ptr %r49.p1)
  %r49.cmp = icmp eq i32 %r49.sc, 0
...
or_rhs64:
  ...
  %r57.p0 = inttoptr i64 %r55 to ptr
  %r57.p1 = inttoptr i64 %r56 to ptr
  %r57.sc = call i32 @strcmp(ptr %r57.p0, ptr %r57.p1)
  %r57.cmp = icmp eq i32 %r57.sc, 0
...
or_rhs67:
  ...
  %r61.p0 = inttoptr i64 %r59 to ptr
  %r61.p1 = inttoptr i64 %r60 to ptr
  %r61.sc = call i32 @strcmp(ptr %r61.p0, ptr %r61.p1)
  %r61.cmp = icmp eq i32 %r61.sc, 0
...
or_rhs70:
  ...
  %r65.p0 = inttoptr i64 %r63 to ptr
  %r65.p1 = inttoptr i64 %r64 to ptr
  %r65.sc = call i32 @strcmp(ptr %r65.p0, ptr %r65.p1)
  %r65.cmp = icmp eq i32 %r65.sc, 0
...
or_rhs79:
  ...
  %r77.p0 = inttoptr i64 %r75 to ptr
  %r77.p1 = inttoptr i64 %r76 to ptr
  %r77.sc = call i32 @strcmp(ptr %r77.p0, ptr %r77.p1)
  %r77.cmp = icmp eq i32 %r77.sc, 0
...
entry:
  ...
  br label %while_hdr81, !llvm.loop !91
while_hdr81:
  ...
  br i1 %br_while_body82, label %while_body82, label %while_exit83, !prof !90
while_body82:
...
then84:
  ...
  store i64 210691276070, ptr %r20.thash, align 8
...
then87:
  br label %while_hdr90, !llvm.loop !91
while_hdr90:
...
and_merge95:
  ...
  br i1 %br_while_body91, label %while_body91, label %while_exit92, !prof !90
while_body91:
...
then96:
  ...
  br label %while_hdr99, !llvm.loop !91
while_hdr99:
...
and_merge104:
  ...
  br i1 %br_while_body100, label %while_body100, label %while_exit101, !prof !90
while_body100:
...
then105:
  ...
  %r75.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r75.thash = getelementptr i64, ptr %r75.ptr, i64 0
  store i64 210691276070, ptr %r75.thash, align 8
  %r75.f0 = getelementptr i64, ptr %r75.ptr, i64 1
  store i64 %r71, ptr %r75.f0, align 8
  %r75.f1 = getelementptr i64, ptr %r75.ptr, i64 2
  store i64 %r72, ptr %r75.f1, align 8
  %r75.f2 = getelementptr i64, ptr %r75.ptr, i64 3
  store i64 %r73, ptr %r75.f2, align 8
  %r75.f3 = getelementptr i64, ptr %r75.ptr, i64 4
...
else106:
  ...
  %r82.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r82.thash = getelementptr i64, ptr %r82.ptr, i64 0
  store i64 210691276070, ptr %r82.thash, align 8
  %r82.f0 = getelementptr i64, ptr %r82.ptr, i64 1
  store i64 %r78, ptr %r82.f0, align 8
  %r82.f1 = getelementptr i64, ptr %r82.ptr, i64 2
  store i64 %r79, ptr %r82.f1, align 8
  %r82.f2 = getelementptr i64, ptr %r82.ptr, i64 3
  store i64 %r80, ptr %r82.f2, align 8
  %r82.f3 = getelementptr i64, ptr %r82.ptr, i64 4
...
then108:
  ...
  br label %while_hdr111, !llvm.loop !91
while_hdr111:
...
and_merge116:
  ...
  br i1 %br_while_body112, label %while_body112, label %while_exit113, !prof !90
while_body112:
...
while_exit113:
  ...
  %r112.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r112.thash = getelementptr i64, ptr %r112.ptr, i64 0
  store i64 210691276070, ptr %r112.thash, align 8
  %r112.f0 = getelementptr i64, ptr %r112.ptr, i64 1
  store i64 %r108, ptr %r112.f0, align 8
  %r112.f1 = getelementptr i64, ptr %r112.ptr, i64 2
  store i64 %r109, ptr %r112.f1, align 8
  %r112.f2 = getelementptr i64, ptr %r112.ptr, i64 3
  store i64 %r110, ptr %r112.f2, align 8
  %r112.f3 = getelementptr i64, ptr %r112.ptr, i64 4
...
else109:
  ...
  %r116.p0 = inttoptr i64 %r114 to ptr
  %r116.p1 = inttoptr i64 %r115 to ptr
  %r116.sc = call i32 @strcmp(ptr %r116.p0, ptr %r116.p1)
  %r116.cmp = icmp eq i32 %r116.sc, 0
  %r116 = zext i1 %r116.cmp to i64
...
then117:
  ...
  %r122.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r122.thash = getelementptr i64, ptr %r122.ptr, i64 0
  store i64 210691276070, ptr %r122.thash, align 8
  %r122.f0 = getelementptr i64, ptr %r122.ptr, i64 1
  store i64 %r118, ptr %r122.f0, align 8
  %r122.f1 = getelementptr i64, ptr %r122.ptr, i64 2
  store i64 %r119, ptr %r122.f1, align 8
  %r122.f2 = getelementptr i64, ptr %r122.ptr, i64 3
  store i64 %r120, ptr %r122.f2, align 8
  %r122.f3 = getelementptr i64, ptr %r122.ptr, i64 4
...
then120:
  ...
  %r138.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r138.thash = getelementptr i64, ptr %r138.ptr, i64 0
  store i64 210691276070, ptr %r138.thash, align 8
  %r138.f0 = getelementptr i64, ptr %r138.ptr, i64 1
  store i64 %r134, ptr %r138.f0, align 8
  %r138.f1 = getelementptr i64, ptr %r138.ptr, i64 2
  store i64 %r135, ptr %r138.f1, align 8
  %r138.f2 = getelementptr i64, ptr %r138.ptr, i64 3
  store i64 %r136, ptr %r138.f2, align 8
  %r138.f3 = getelementptr i64, ptr %r138.ptr, i64 4
...
while_exit83:
  ...
  %r157.ptr = call ptr @nova_rt_struct_alloc(i64 40)
  %r157.thash = getelementptr i64, ptr %r157.ptr, i64 0
  store i64 210691276070, ptr %r157.thash, align 8
  %r157.f0 = getelementptr i64, ptr %r157.ptr, i64 1
  store i64 %r153, ptr %r157.f0, align 8
  %r157.f1 = getelementptr i64, ptr %r157.ptr, i64 2
  store i64 %r154, ptr %r157.f1, align 8
  %r157.f2 = getelementptr i64, ptr %r157.ptr, i64 3
  store i64 %r155, ptr %r157.f2, align 8
  %r157.f3 = getelementptr i64, ptr %r157.ptr, i64 4
...
and_rhs130:
  ...
  %r32.cmp = icmp ne i32 %r32.sc, 0
  %r32 = zext i1 %r32.cmp to i64
  store i64 %r32, ptr %slot.__sc_129, align 8
  br label %and_merge131
and_merge131:
  %r33 = load i64, ptr %slot.__sc_129, align 8
  %br_then132 = icmp ne i64 %r33, 0
  br i1 %br_then132, label %then132, label %else133
then132:
  %r34 = load i64, ptr %slot.non_nl, align 8
  %r35 = load i64, ptr %slot.t, align 8
  %r36 = call i64 @nova_rt_list_append(i64 %r34, i64 %r35)
  br label %endif134
else133:
  br label %endif134
endif134:
  %r37 = load i64, ptr %slot.kind, align 8
  %r38.p = getelementptr inbounds [2 x i8], ptr @.str.40, i64 0, i64 0
  %r38 = ptrtoint ptr %r38.p to i64
  %r39 = call i64 @nova_rt_str_concat(i64 %r37, i64 %r38)
  %r40 = load i64, ptr %slot.value, align 8
  %r41 = call i64 @nova_rt_str_concat(i64 %r39, i64 %r40)
  %r42 = call i64 @nova_rt_print_any(i64 %r41)
  br label %match_exit126
match_fall128:
  br label %match_exit126
match_exit126:
  %r43 = load i64, ptr %slot.__for_idx_123, align 8
  %r44 = add i64 1, 0
  %r45 = add i64 %r43, %r44
  store i64 %r45, ptr %slot.__for_idx_123, align 8
  br label %for_hdr123, !llvm.loop !91
for_exit125:
  %r46.p = getelementptr inbounds [15 x i8], ptr @.str.41, i64 0, i64 0
  %r46 = ptrtoint ptr %r46.p to i64
  %r47 = load i64, ptr %slot.non_nl, align 8
  %r48 = call i64 @nova_rt_len_any(i64 %r47)
  %r49 = call i64 @nova_rt_int_to_str(i64 %r48)
  %r50 = call i64 @nova_rt_str_concat(i64 %r46, i64 %r49)
  %r51 = call i64 @nova_rt_print_any(i64 %r50)
  %r52 = load i64, ptr %slot.non_nl, align 8
  %r53 = call i64 @nova_rt_len_any(i64 %r52)
  %r54 = add i64 6, 0
  %r55.cmp = icmp eq i64 %r53, %r54
  %r55 = zext i1 %r55.cmp to i64
  %br_then135 = icmp ne i64 %r55, 0
  br i1 %br_then135, label %then135, label %else136
then135:
  %r56.p = getelementptr inbounds [5 x i8], ptr @.str.42, i64 0, i64 0
  %r56 = ptrtoint ptr %r56.p to i64
  %r57 = call i64 @nova_rt_print_any(i64 %r56)
  br label %endif137
else136:
  %r58.p = getelementptr inbounds [23 x i8], ptr @.str.43, i64 0, i64 0
  %r58 = ptrtoint ptr %r58.p to i64
  %r59 = load i64, ptr %slot.non_nl, align 8
