...
entry0:
  ...
  %slot.__mb2_steps = alloca i64, align 8
...
__mb0_entry0:
  ...
  %r56 = load i64, ptr %slot.__mb0_n, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r20 = load i64, ptr %slot.__mb0_i, align 8
  %t0 = icmp sle i64 %r20, %r56
  br i1 %t0, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r24 = load i64, ptr %slot.__mb0_total, align 8
  %r25 = load i64, ptr %slot.__mb0_i, align 8
  %r26 = add i64 %r24, %r25
  store i64 %r26, ptr %slot.__mb0_total, align 8
  %r29 = load i64, ptr %slot.__mb0_i, align 8
  %r31 = add i64 %r29, 1
  store i64 %r31, ptr %slot.__mb0_i, align 8
  br label %__mb0_while_header1, !llvm.loop !91

__mb0_while_exit3:
  %r35 = load i64, ptr %slot.__mb0_total, align 8
  store i64 %r35, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r36 = load i64, ptr %slot.__mb0_ret, align 8
  %t1 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t1, i64 %r36)
...
__mb1_while_header1:
  %r42 = load i64, ptr %slot.__mb1_n, align 8
  %t2 = icmp sgt i64 %r42, 0
  br i1 %t2, label %__mb1_while_body2, label %__mb1_while_exit3, !prof !90

__mb1_while_body2:
  %r46 = load i64, ptr %slot.__mb1_n, align 8
  %t3 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t3, i64 %r46)
  %r48 = load i64, ptr %slot.__mb1_n, align 8
  %r50 = sub i64 %r48, 1
  store i64 %r50, ptr %slot.__mb1_n, align 8
  br label %__mb1_while_header1, !llvm.loop !91

__mb1_while_exit3:
  %t4 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t4, i64 0)
...
__mb2_entry0:
  store i64 27, ptr %slot.__mb2_n, align 8
  store i64 0, ptr %slot.__mb2_steps, align 8
  br label %__mb2_while_header1

__mb2_while_header1:
  %r62 = load i64, ptr %slot.__mb2_n, align 8
  %t5 = icmp ne i64 %r62, 1
  br i1 %t5, label %__mb2_while_body2, label %__mb2_while_exit3, !prof !90

__mb2_while_body2:
  %r65 = load i64, ptr %slot.__mb2_n, align 8
  %r67 = srem i64 %r65, 2
  %t6 = icmp eq i64 %r67, 0
  br i1 %t6, label %__mb2_ifb_then4, label %__mb2_ifb_else5

__mb2_while_exit3:
  %r70 = load i64, ptr %slot.__mb2_steps, align 8
  store i64 %r70, ptr %slot.__mb2_ret, align 8
  br label %__mb2_merge

__mb2_ifb_then4:
  %r71 = load i64, ptr %slot.__mb2_n, align 8
  %r73 = sdiv i64 %r71, 2
  store i64 %r73, ptr %slot.__mb2_n, align 8
  br label %__mb2_ifb_merge6

__mb2_ifb_else5:
  %r76 = load i64, ptr %slot.__mb2_n, align 8
  %r78 = mul i64 %r76, 3
  %r80 = add i64 %r78, 1
  store i64 %r80, ptr %slot.__mb2_n, align 8
  br label %__mb2_ifb_merge6

__mb2_ifb_merge6:
  %r83 = load i64, ptr %slot.__mb2_steps, align 8
  %r85 = add i64 %r83, 1
  store i64 %r85, ptr %slot.__mb2_steps, align 8
  br label %__mb2_while_header1, !llvm.loop !91

__mb2_merge:
  %r87 = load i64, ptr %slot.__mb2_ret, align 8
  %t7 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t7, i64 %r87)
  ret i64 0
}
