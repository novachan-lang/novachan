...
@.str.0 = private unnamed_addr constant [19 x i8] c"distance squared: \00"
...
entry0:
  ...
  %t4 = alloca i64, i64 3, align 8
  %t5 = getelementptr i64, ptr %t4, i64 0
  store i64 210686530511, ptr %t5
  %t6 = getelementptr i64, ptr %t4, i64 1
  store i64 3, ptr %t6
  %t7 = getelementptr i64, ptr %t4, i64 2
  store i64 4, ptr %t7
  %r11 = ptrtoint ptr %t4 to i64
  %t8 = getelementptr inbounds [19 x i8], ptr @.str.0, i64 0, i64 0
  %r15 = ptrtoint ptr %t8 to i64
  %t9 = inttoptr i64 %r4 to ptr
  %t10 = getelementptr i64, ptr %t9, i64 1
  %r23 = load i64, ptr %t10
  %t11 = inttoptr i64 %r11 to ptr
  %t12 = getelementptr i64, ptr %t11, i64 1
  %r24 = load i64, ptr %t12
  %r25 = sub i64 %r23, %r24
  %t13 = inttoptr i64 %r4 to ptr
  %t14 = getelementptr i64, ptr %t13, i64 2
  %r26 = load i64, ptr %t14
  %t15 = inttoptr i64 %r11 to ptr
  %t16 = getelementptr i64, ptr %t15, i64 2
  %r27 = load i64, ptr %t16
  %r28 = sub i64 %r26, %r27
  %r29 = mul i64 %r25, %r25
  %r30 = mul i64 %r28, %r28
  %r31 = add i64 %r29, %r30
  %r19 = call i64 @nova_rt_int_to_str(i64 %r31)
  %t17 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r20 = ptrtoint ptr %t17 to i64
  %t18 = call i64 @nova_rt_str_concat(i64 %r15, i64 %r19)
  %t19 = call i64 @nova_rt_str_concat(i64 %t18, i64 %r20)
