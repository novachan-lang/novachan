...
entry:
  ...
  %r7 = add i64 1, 0
  %r8 = sub i64 0, %r7
  %r9.lp = inttoptr i64 %r6 to ptr
  %r9.dp = load ptr, ptr %r9.lp, align 8, !tbaa !2
  %r9.ep = getelementptr i64, ptr %r9.dp, i64 %r8
  %r9 = load i64, ptr %r9.ep, align 8, !tbaa !4
  %r10 = call i64 @nova_rt_print_any(i64 %r9)
  %r11 = load i64, ptr %slot.nums, align 8
  %r12 = add i64 2, 0
  %r13 = sub i64 0, %r12
  %r14.lp = inttoptr i64 %r11 to ptr
  %r14.dp = load ptr, ptr %r14.lp, align 8, !tbaa !2
  %r14.ep = getelementptr i64, ptr %r14.dp, i64 %r13
  %r14 = load i64, ptr %r14.ep, align 8, !tbaa !4
  %r15 = call i64 @nova_rt_print_any(i64 %r14)
  %r16 = load i64, ptr %slot.nums, align 8
  %r17 = add i64 5, 0
  %r18 = sub i64 0, %r17
  %r19.lp = inttoptr i64 %r16 to ptr
...
define i64 @test_dict_for() nounwind {
entry:
  ...
  %r5.p = getelementptr inbounds [5 x i8], ptr @.str.4, i64 0, i64 0
...
for_hdr0:
  ...
  %br_for_body1 = icmp ne i64 %r11, 0
...
for_body1:
  ...
  %r15 = load i64, ptr %slot.__for_idx_0, align 8
  %r16 = add i64 1, 0
  %r17 = add i64 %r15, %r16
  store i64 %r17, ptr %slot.__for_idx_0, align 8
  br label %for_hdr0, !llvm.loop !91
for_exit2:
  ret i64 0
}

define i64 @test_dict_values() nounwind {
entry:
  %slot.d = alloca i64, align 8
  store i64 0, ptr %slot.d, align 8
  ...
  %r4 = add i64 2, 0
  call i64 @nova_rt_dict_set(i64 %r0, i64 %r3, i64 %r4)
  %r5.p = getelementptr inbounds [2 x i8], ptr @.str.8, i64 0, i64 0
  %r5 = ptrtoint ptr %r5.p to i64
  %r6 = add i64 3, 0
  call i64 @nova_rt_dict_set(i64 %r0, i64 %r5, i64 %r6)
  store i64 %r0, ptr %slot.d, align 8
  %r7 = load i64, ptr %slot.d, align 8
  %r8 = call i64 @nova_rt_dict_values(i64 %r7)
  store i64 %r8, ptr %slot.vals, align 8
  %r9 = load i64, ptr %slot.vals, align 8
  %r10 = call i64 @nova_rt_len_any(i64 %r9)
  %r11 = add i64 0, 0
  store i64 %r11, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3, !llvm.loop !91
for_hdr3:
  %r12 = load i64, ptr %slot.__for_idx_3, align 8
  %r13.cmp = icmp slt i64 %r12, %r10
  %r13 = zext i1 %r13.cmp to i64
  %br_for_body4 = icmp ne i64 %r13, 0
  br i1 %br_for_body4, label %for_body4, label %for_exit5, !prof !90
for_body4:
  %r14 = call i64 @nova_rt_index_get(i64 %r9, i64 %r12)
  store i64 %r14, ptr %slot.v, align 8
  %r15 = load i64, ptr %slot.v, align 8
  %r16 = call i64 @nova_rt_print_any(i64 %r15)
  %r17 = load i64, ptr %slot.__for_idx_3, align 8
  %r18 = add i64 1, 0
  %r19 = add i64 %r17, %r18
  store i64 %r19, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3, !llvm.loop !91
for_exit5:
  ret i64 0
}

define i64 @test_dict_items() nounwind {
entry:
  %slot.d = alloca i64, align 8
  store i64 0, ptr %slot.d, align 8
  ...
  %r0 = call i64 @nova_rt_dict_create()
  %r1.p = getelementptr inbounds [2 x i8], ptr @.str.9, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2 = add i64 10, 0
  call i64 @nova_rt_dict_set(i64 %r0, i64 %r1, i64 %r2)
  ...
  %r6 = call i64 @nova_rt_dict_items(i64 %r5)
  store i64 %r6, ptr %slot.items, align 8
...
entry:
  ...
  %r1.p = getelementptr inbounds [4 x i8], ptr @.str.11, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3 = call i64 @test_dict_for()
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.11, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6 = call i64 @test_dict_values()
  %r7.p = getelementptr inbounds [4 x i8], ptr @.str.11, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  %r9 = call i64 @test_dict_items()
  %r10.p = getelementptr inbounds [5 x i8], ptr @.str.12, i64 0, i64 0
...
@.str.5 = private unnamed_addr constant [4 x i8] c"new\00"
@.str.6 = private unnamed_addr constant [2 x i8] c"a\00"
@.str.7 = private unnamed_addr constant [2 x i8] c"b\00"
@.str.8 = private unnamed_addr constant [2 x i8] c"c\00"
@.str.9 = private unnamed_addr constant [2 x i8] c"x\00"
@.str.10 = private unnamed_addr constant [2 x i8] c"y\00"
