...
entry:
  ...
  %r16 = call i64 @nova_rt_dict_get(i64 %r14, i64 %r15)
  ...
  %r27 = call i64 @nova_rt_dict_get(i64 %r25, i64 %r26)
  ...
  %r37 = add i64 0, 0
  %_iset.lp0 = inttoptr i64 %r36 to ptr
  %_iset.dp1 = load ptr, ptr %_iset.lp0, align 8, !tbaa !2
  %_iset.ep2 = getelementptr i64, ptr %_iset.dp1, i64 %r37
  store i64 %r35, ptr %_iset.ep2, align 8, !tbaa !4
  %r38 = add i64 30, 0
  %r39 = load i64, ptr %slot.items, align 8
  %r40 = add i64 2, 0
  %_iset.lp3 = inttoptr i64 %r39 to ptr
  %_iset.dp4 = load ptr, ptr %_iset.lp3, align 8, !tbaa !2
  %_iset.ep5 = getelementptr i64, ptr %_iset.dp4, i64 %r40
  store i64 %r38, ptr %_iset.ep5, align 8, !tbaa !4
  %r41 = add i64 50, 0
  %r42 = load i64, ptr %slot.items, align 8
  %r43 = add i64 4, 0
  %_iset.lp6 = inttoptr i64 %r42 to ptr
  %_iset.dp7 = load ptr, ptr %_iset.lp6, align 8, !tbaa !2
  %_iset.ep8 = getelementptr i64, ptr %_iset.dp7, i64 %r43
  store i64 %r41, ptr %_iset.ep8, align 8, !tbaa !4
  %r44 = load i64, ptr %slot.items, align 8
  %r45 = add i64 0, 0
  %r46.lp = inttoptr i64 %r44 to ptr
  %r46.dp = load ptr, ptr %r46.lp, align 8, !tbaa !2
  %r46.ep = getelementptr i64, ptr %r46.dp, i64 %r45
  %r46 = load i64, ptr %r46.ep, align 8, !tbaa !4
  ...
  %r50 = load i64, ptr %r50.ep, align 8, !tbaa !4
  %r51 = call i64 @nova_rt_print_any(i64 %r50)
  %r52 = load i64, ptr %slot.items, align 8
  %r53 = add i64 4, 0
  %r54.lp = inttoptr i64 %r52 to ptr
  %r54.dp = load ptr, ptr %r54.lp, align 8, !tbaa !2
  %r54.ep = getelementptr i64, ptr %r54.dp, i64 %r53
  %r54 = load i64, ptr %r54.ep, align 8, !tbaa !4
...
while_exit2:
  ...
  %r72 = call i64 @nova_rt_dict_get(i64 %r70, i64 %r71)
  ...
  %r76 = call i64 @nova_rt_dict_get(i64 %r74, i64 %r75)
  ...
  %r84 = call i64 @nova_rt_dict_get(i64 %r82, i64 %r83)
