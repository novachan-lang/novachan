...
entry0:
  ...
  %r12 = load i64, ptr %t6, align 8, !tbaa !4
  ...
  %r14 = ptrtoint ptr %t7 to i64
  %t8 = call i64 @nova_rt_str_concat(i64 %r9, i64 %r13)
  %t9 = call i64 @nova_rt_str_concat(i64 %t8, i64 %r14)
