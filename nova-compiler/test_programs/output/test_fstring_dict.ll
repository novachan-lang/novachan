...
__mb0_entry0:
  ...
  %r18 = call i64 @nova_rt_contains(i64 %r8, i64 %r9)
  %t7 = trunc i64 %r18 to i1
  br i1 %t7, label %__mb0_ifb_then1, label %__mb0_ifb_else2

__mb0_ifb_then1:
  %t8 = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
  %r21 = ptrtoint ptr %t8 to i64
  %r22 = load i64, ptr %slot.__mb0_d, align 8
  %r23 = load i64, ptr %slot.__mb0_k, align 8
  %r24 = call i64 @nova_rt_dict_get(i64 %r22, i64 %r23)
  ...
  %t11 = call i64 @nova_rt_str_concat(i64 %t10, i64 %r26)
