...
entry0:
  ...
  store i64 20, ptr %t4
  %t5 = ptrtoint ptr @__nova_spawn_tramp_3 to i64
  %t6 = ptrtoint ptr %t0 to i64
  %r19 = call i64 @nova_rt_spawn(i64 %t5, i64 %t6)
  %r21 = call i64 @nova_rt_channel_recv(i64 %r0)
  %t7 = call i64 @nova_rt_any_to_str(i64 %r21)
  %t8 = inttoptr i64 %t7 to ptr
  call i32 @puts(ptr %t8)
  %r27 = call i64 @nova_rt_channel_create()
  %t9 = call ptr @malloc(i64 32)
  %t10 = ptrtoint ptr @nova_main_spawn1 to i64
  store i64 %t10, ptr %t9
  %t11 = getelementptr i64, ptr %t9, i32 1
  store i64 %r27, ptr %t11
  %t12 = getelementptr i64, ptr %t9, i32 2
  store i64 %r21, ptr %t12
  %t13 = getelementptr i64, ptr %t9, i32 3
  store i64 5, ptr %t13
  %t14 = ptrtoint ptr @__nova_spawn_tramp_3 to i64
  %t15 = ptrtoint ptr %t9 to i64
  %r38 = call i64 @nova_rt_spawn(i64 %t14, i64 %t15)
  %r40 = call i64 @nova_rt_channel_recv(i64 %r27)
  %t16 = call i64 @nova_rt_any_to_str(i64 %r40)
  %t17 = inttoptr i64 %t16 to ptr
  call i32 @puts(ptr %t17)
  ret i64 0
}

define i64 @nova_main_spawn0(i64 %p0, i64 %p1, i64 %p2) nounwind {
entry0:
  %r26 = add i64 %p1, %p2
...
define i64 @nova_main_spawn1(i64 %p0, i64 %p1, i64 %p2) nounwind {
entry0:
  %r45 = mul i64 %p1, %p2
