...
@.str.0 = private unnamed_addr constant [13 x i8] c"Hello, NOVA!\00"
@.str.1 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.2 = private unnamed_addr constant [3 x i8] c"ab\00"
...
entry0:
  ...
  %t0 = getelementptr inbounds [5 x i8], ptr @.str.5, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t0, i64 3)
  %t1 = getelementptr inbounds [13 x i8], ptr @.str.0, i64 0, i64 0
  %r46 = ptrtoint ptr %t1 to i64
  %t2 = inttoptr i64 %r46 to ptr
  call i32 @puts(ptr %t2)
  %t3 = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r9 = ptrtoint ptr %t3 to i64
  %r51 = call i64 @nova_rt_upper(i64 %r9)
  %t4 = inttoptr i64 %r51 to ptr
...
__mb0_entry0:
  %t6 = load i64, ptr %slot.__mb0_s, align 8
  call void @nova_rc_dec(i64 %t6)
  store i64 %r12, ptr %slot.__mb0_s, align 8
  store i64 3, ptr %slot.__mb0_n, align 8
  %t7 = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r86 = ptrtoint ptr %t7 to i64
  %t8 = load i64, ptr %slot.__mb0_result, align 8
  call void @nova_rc_dec(i64 %t8)
  store i64 %r86, ptr %slot.__mb0_result, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r114 = load i64, ptr %slot.__mb0_n, align 8
  %r115 = load i64, ptr %slot.__mb0_s, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r95 = load i64, ptr %slot.__mb0_i, align 8
  %t9 = icmp slt i64 %r95, %r114
  br i1 %t9, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r99 = load i64, ptr %slot.__mb0_result, align 8
  %t10 = call i64 @nova_rt_str_concat(i64 %r99, i64 %r115)
  %t11 = load i64, ptr %slot.__mb0_result, align 8
  call void @nova_rc_dec(i64 %t11)
  store i64 %t10, ptr %slot.__mb0_result, align 8
  %r104 = load i64, ptr %slot.__mb0_i, align 8
  %r106 = add i64 %r104, 1
  store i64 %r106, ptr %slot.__mb0_i, align 8
  br label %__mb0_while_header1, !llvm.loop !91

__mb0_while_exit3:
  %r110 = load i64, ptr %slot.__mb0_result, align 8
  %t12 = load i64, ptr %slot.__mb0_ret, align 8
  call void @nova_rc_dec(i64 %t12)
  call void @nova_rc_inc(i64 %r110)
  store i64 %r110, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r111 = load i64, ptr %slot.__mb0_ret, align 8
  %t13 = inttoptr i64 %r111 to ptr
  call i32 @puts(ptr %t13)
  %t14 = getelementptr inbounds [5 x i8], ptr @.str.5, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t14, i64 25)
  %t15 = getelementptr inbounds [14 x i8], ptr @.str.4, i64 0, i64 0
  %r79 = ptrtoint ptr %t15 to i64
  %t16 = inttoptr i64 %r79 to ptr
  call i32 @puts(ptr %t16)
  %t17 = load i64, ptr %slot.__mb0_s, align 8
  call void @nova_rc_dec(i64 %t17)
  %t18 = load i64, ptr %slot.__mb0_result, align 8
