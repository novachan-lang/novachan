...
@.str.4 = private unnamed_addr constant [15 x i8] c"foo = \22hello\22\0A\00"
...
entry0:
  ...
  %t9 = getelementptr inbounds [15 x i8], ptr @.str.4, i64 0, i64 0
  %r28 = ptrtoint ptr %t9 to i64
  %t10 = inttoptr i64 %r28 to ptr
