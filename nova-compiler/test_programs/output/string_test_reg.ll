...
entry:
  ...
  %r0.p = getelementptr inbounds [18 x i8], ptr @.str.1, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  ret i64 %r0
}
...
entry:
  ...
  %r0.p = getelementptr inbounds [18 x i8], ptr @.str.2, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  ret i64 %r0
}
...
entry:
  ...
  %r3.p = getelementptr inbounds [5 x i8], ptr @.str.4, i64 0, i64 0
  ...
  %r12.p = getelementptr inbounds [4 x i8], ptr @.str.5, i64 0, i64 0
  %r12 = ptrtoint ptr %r12.p to i64
  %r13 = add i64 1000, 0
  %r14 = call i64 @formatResult(i64 %r12, i64 %r13)
  %r15 = call i64 @nova_rt_print_any(i64 %r14)
  %r16.p = getelementptr inbounds [3 x i8], ptr @.str.6, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [15 x i8] c"Hello, {name}!\00"
@.str.1 = private unnamed_addr constant [18 x i8] c"The number is {n}\00"
@.str.2 = private unnamed_addr constant [18 x i8] c"{label} = {value}\00"
@.str.3 = private unnamed_addr constant [6 x i8] c"World\00"
@.str.4 = private unnamed_addr constant [5 x i8] c"NOVA\00"
@.str.5 = private unnamed_addr constant [4 x i8] c"sum\00"
@.str.6 = private unnamed_addr constant [3 x i8] c"pi\00"
