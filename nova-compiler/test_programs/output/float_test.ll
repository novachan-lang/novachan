...
entry0:
  ...
  %t10 = bitcast i64 4635227165174326876 to double
  %t11 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t11, double %t10)
  %t12 = bitcast i64 4636737291354636288 to double
  %t13 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t13, double %t12)
  %t14 = bitcast i64 0 to double
  %t15 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t15, double %t14)
  br label %__mb0_entry0

__mb0_entry0:
  store i64 -4592193876290174976, ptr %slot.__mb0_x, align 8
  br label %__mb0_ifb_then1

__mb0_ifb_then1:
  %r75 = load i64, ptr %slot.__mb0_x, align 8
  %t16 = bitcast i64 %r75 to double
  %t17 = fneg double %t16
  %r76 = bitcast double %t17 to i64
  store i64 %r76, ptr %slot.__mb0___ifb_0, align 8
  br label %__mb0_ifb_merge3

__mb0_ifb_merge3:
  %r81 = load i64, ptr %slot.__mb0___ifb_0, align 8
  %t18 = bitcast i64 %r81 to double
  store i64 %r81, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r82 = load i64, ptr %slot.__mb0_ret, align 8
  %t19 = bitcast i64 %r82 to double
  %t20 = bitcast i64 %r82 to double
  %t21 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t21, double %t20)
  %t22 = bitcast i64 4609047870845179867 to double
