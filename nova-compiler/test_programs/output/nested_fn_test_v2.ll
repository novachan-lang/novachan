...
define i64 @outer(i64 %p0) nounwind {
entry:
  ...
  %r6 = load i64, ptr %slot.add_ten, align 8
  %r5.rec = inttoptr i64 %r6 to ptr
  %r5.fnraw = load i64, ptr %r5.rec, align 8
  %r5.fnptr = inttoptr i64 %r5.fnraw to ptr
  %r5 = call i64 %r5.fnptr(i64 %r6, i64 %r3)
  ret i64 %r5
}

define i64 @__nfn_double_0(i64 %p0) nounwind {
entry:
...
define i64 @__nfn_add_ten_1(i64 %p0) nounwind {
entry:
  %slot.n = alloca i64, align 8
  store i64 %p0, ptr %slot.n, align 8
  %r0 = load i64, ptr %slot.n, align 8
...
entry:
  %r0 = add i64 5, 0
  %r1 = call i64 @outer(i64 %r0)
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3 = add i64 15, 0
  %r4 = call i64 @outer(i64 %r3)
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6 = add i64 0, 0
  %r7 = call i64 @outer(i64 %r6)
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  ret i64 0
}

define i64 @__ntramp_double_0(i64 %record, i64 %p0) nounwind {
entry:
  %result = call i64 @__nfn_double_0(i64 %p0)
  ret i64 %result
}

define i64 @__ntramp_add_ten_1(i64 %record, i64 %p0) nounwind {
entry:
  %result = call i64 @__nfn_add_ten_1(i64 %p0)
  ret i64 %result
}
