...
@.str.0 = private unnamed_addr constant [24 x i8] c"hello world foo bar baz\00"
...
entry0:
  ...
  call i32 (ptr, ...) @printf(ptr %t0, i64 20)
  %t1 = getelementptr inbounds [24 x i8], ptr @.str.0, i64 0, i64 0
  %r141 = ptrtoint ptr %t1 to i64
  %t2 = inttoptr i64 %r141 to ptr
