...
entry0:
  ...
  store i64 %r36, ptr %slot.t, align 8
  %r8 = load i64, ptr %slot.t, align 8
  %t7 = inttoptr i64 %r8 to ptr
  %t8 = getelementptr i64, ptr %t7, i64 0
  %r10 = load i64, ptr %t8
  %t9 = icmp eq i64 %r10, 210691276070
  br i1 %t9, label %arm0_body2, label %match_merge1

arm0_body2:
  %t10 = inttoptr i64 %r8 to ptr
  %t11 = getelementptr i64, ptr %t10, i64 1
  %r13 = load i64, ptr %t11
  %t12 = inttoptr i64 %r8 to ptr
  ...
  %t15 = call i64 @nova_rt_str_concat(i64 %r13, i64 %r21)
  %t16 = call i64 @nova_rt_str_concat(i64 %t15, i64 %r16)
