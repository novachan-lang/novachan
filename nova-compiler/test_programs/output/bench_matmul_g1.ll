...
while_body1:
  ...
  %r10 = add i64 7, 0
  %r11 = srem i64 %r9, %r10
  %r12 = call i64 @nova_rt_add(i64 %r8, i64 %r11)
  %r13 = call i64 @nova_rt_push(i64 %r7, i64 %r12)
...
while_body4:
  ...
  %r8 = add i64 0, 0
  %r9 = call i64 @nova_rt_push(i64 %r7, i64 %r8)
...
while_body13:
  ...
  %r32 = add i64 %r30, %r31
  %r33 = call i64 @nova_rt_index_get(i64 %r27, i64 %r32)
  ...
  %r39 = add i64 %r37, %r38
  %r40 = call i64 @nova_rt_index_get(i64 %r34, i64 %r39)
  %r41 = mul i64 %r33, %r40
  %r42 = add i64 %r26, %r41
...
while_exit14:
  ...
  %r52 = add i64 %r50, %r51
  call i64 @nova_rt_index_set(i64 %r47, i64 %r52, i64 %r46)
