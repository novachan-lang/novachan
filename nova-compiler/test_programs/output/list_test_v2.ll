...
while_body1:
  %r5 = load i64, ptr %slot.nums, align 8
  %r6 = load i64, ptr %slot.i, align 8
  %r7 = call i64 @nova_rt_index_get(i64 %r5, i64 %r6)
  %r8 = load i64, ptr %slot.total, align 8
  %r9 = call i64 @nova_rt_add(i64 %r8, i64 %r7)
...
endif8:
  ...
  br label %while_hdr3, !llvm.loop !91
while_exit5:
  %r18 = load i64, ptr %slot.best, align 8
  ret i64 %r18
}
...
entry:
  ...
  %r7 = add i64 0, 0
  %r8.lp = inttoptr i64 %r6 to ptr
  %r8.dp = load ptr, ptr %r8.lp, align 8, !tbaa !2
  %r8.ep = getelementptr i64, ptr %r8.dp, i64 %r7
  %r8 = load i64, ptr %r8.ep, align 8, !tbaa !4
  %r9 = call i64 @nova_rt_print_any(i64 %r8)
  %r10 = load i64, ptr %slot.nums, align 8
  %r11 = add i64 2, 0
  %r12.lp = inttoptr i64 %r10 to ptr
  %r12.dp = load ptr, ptr %r12.lp, align 8, !tbaa !2
  %r12.ep = getelementptr i64, ptr %r12.dp, i64 %r11
  %r12 = load i64, ptr %r12.ep, align 8, !tbaa !4
  %r13 = call i64 @nova_rt_print_any(i64 %r12)
  %r14 = load i64, ptr %slot.nums, align 8
  %r15 = add i64 4, 0
  %r16.lp = inttoptr i64 %r14 to ptr
  %r16.dp = load ptr, ptr %r16.lp, align 8, !tbaa !2
  %r16.ep = getelementptr i64, ptr %r16.dp, i64 %r15
  %r16 = load i64, ptr %r16.ep, align 8, !tbaa !4
  ...
  %r37 = add i64 0, 0
  %r38.lp = inttoptr i64 %r36 to ptr
  %r38.dp = load ptr, ptr %r38.lp, align 8, !tbaa !2
  %r38.ep = getelementptr i64, ptr %r38.dp, i64 %r37
  %r38 = load i64, ptr %r38.ep, align 8, !tbaa !4
  %r39 = call i64 @nova_rt_print_any(i64 %r38)
  %r40 = load i64, ptr %slot.primes, align 8
  %r41 = add i64 5, 0
  %r42.lp = inttoptr i64 %r40 to ptr
  %r42.dp = load ptr, ptr %r42.lp, align 8, !tbaa !2
  %r42.ep = getelementptr i64, ptr %r42.dp, i64 %r41
  %r42 = load i64, ptr %r42.ep, align 8, !tbaa !4
