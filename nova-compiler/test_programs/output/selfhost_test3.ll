...
__mb0_entry0:
  store i64 5, ptr %slot.__mb0_x, align 8
...
__mb0_ifb_merge3:
  %r22 = load i64, ptr %slot.__mb0_x, align 8
  store i64 %r22, ptr %slot.__mb0_ret, align 8
...
__mb1_entry0:
  store i64 -3, ptr %slot.__mb1_x, align 8
  br label %__mb1_ifb_then1

__mb1_ifb_then1:
  %r36 = load i64, ptr %slot.__mb1_x, align 8
  %r37 = sub i64 0, %r36
  store i64 %r37, ptr %slot.__mb1_ret, align 8
  br label %__mb1_merge

__mb1_merge:
  %r42 = load i64, ptr %slot.__mb1_ret, align 8
  %t1 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t1, i64 %r42)
  ret i64 0
}
