...
endif11:
  ...
  %r63.p = getelementptr inbounds [4 x i8], ptr @.str.17, i64 0, i64 0
  %r63 = ptrtoint ptr %r63.p to i64
  %r64 = call i64 @nova_rt_str_concat(i64 %r62, i64 %r63)
  %r65 = load i64, ptr %slot.b, align 8
  %r66 = call i64 @nova_rt_any_to_str(i64 %r65)
  %r67 = call i64 @nova_rt_str_concat(i64 %r64, i64 %r66)
  %r68.p = getelementptr inbounds [4 x i8], ptr @.str.18, i64 0, i64 0
  %r68 = ptrtoint ptr %r68.p to i64
  %r69 = call i64 @nova_rt_str_concat(i64 %r67, i64 %r68)
  %r70 = load i64, ptr %slot.a, align 8
  %r71 = load i64, ptr %slot.b, align 8
  %r72 = add i64 %r70, %r71
  %r73 = call i64 @nova_rt_any_to_str(i64 %r72)
  %r74 = call i64 @nova_rt_str_concat(i64 %r69, i64 %r73)
  %r75.p = getelementptr inbounds [1 x i8], ptr @.str.16, i64 0, i64 0
  %r75 = ptrtoint ptr %r75.p to i64
  %r76 = call i64 @nova_rt_str_concat(i64 %r74, i64 %r75)
  %r77 = call i64 @nova_rt_print_any(i64 %r76)
  %r78.p = getelementptr inbounds [9 x i8], ptr @.str.19, i64 0, i64 0
  %r78 = ptrtoint ptr %r78.p to i64
  %r79 = load i64, ptr %slot.name, align 8
  %r80 = call i64 @nova_rt_any_to_str(i64 %r79)
  %r81 = call i64 @nova_rt_str_concat(i64 %r78, i64 %r80)
  %r82.p = getelementptr inbounds [10 x i8], ptr @.str.20, i64 0, i64 0
  ...
  %r87 = call i64 @nova_rt_str_concat(i64 %r83, i64 %r86)
  ...
  call i64 @nova_rt_list_append(i64 %r91, i64 %r92)
  call i64 @nova_rt_list_append(i64 %r91, i64 %r93)
  call i64 @nova_rt_list_append(i64 %r91, i64 %r94)
  store i64 %r91, ptr %slot.items, align 8
  %r95.p = getelementptr inbounds [8 x i8], ptr @.str.21, i64 0, i64 0
  %r95 = ptrtoint ptr %r95.p to i64
  %r96 = load i64, ptr %slot.items, align 8
  %r97 = call i64 @nova_rt_len_any(i64 %r96)
  %r98 = call i64 @nova_rt_any_to_str(i64 %r97)
  %r99 = call i64 @nova_rt_str_concat(i64 %r95, i64 %r98)
  %r100.p = getelementptr inbounds [1 x i8], ptr @.str.16, i64 0, i64 0
  %r100 = ptrtoint ptr %r100.p to i64
  %r101 = call i64 @nova_rt_str_concat(i64 %r99, i64 %r100)
  %r102 = call i64 @nova_rt_print_any(i64 %r101)
  %r103.p = getelementptr inbounds [13 x i8], ptr @.str.22, i64 0, i64 0
  %r103 = ptrtoint ptr %r103.p to i64
  %r104 = call i64 @nova_rt_print_any(i64 %r103)
  %r105.p = getelementptr inbounds [1 x i8], ptr @.str.16, i64 0, i64 0
  %r105 = ptrtoint ptr %r105.p to i64
  %r106 = add i64 42, 0
  %r107 = call i64 @nova_rt_any_to_str(i64 %r106)
  %r108 = call i64 @nova_rt_str_concat(i64 %r105, i64 %r107)
  ...
  %r112.p = getelementptr inbounds [2 x i8], ptr @.str.23, i64 0, i64 0
  %r112 = ptrtoint ptr %r112.p to i64
  store i64 %r112, ptr %slot.x, align 8
  %r113.p = getelementptr inbounds [2 x i8], ptr @.str.24, i64 0, i64 0
  %r113 = ptrtoint ptr %r113.p to i64
  store i64 %r113, ptr %slot.y, align 8
  %r114.p = getelementptr inbounds [1 x i8], ptr @.str.16, i64 0, i64 0
  %r114 = ptrtoint ptr %r114.p to i64
  %r115 = load i64, ptr %slot.x, align 8
  ...
  %r120 = load i64, ptr %slot.y, align 8
  %r121 = call i64 @nova_rt_any_to_str(i64 %r120)
  %r122 = call i64 @nova_rt_str_concat(i64 %r119, i64 %r121)
  ...
  %r126.p = getelementptr inbounds [8 x i8], ptr @.str.25, i64 0, i64 0
  %r126 = ptrtoint ptr %r126.p to i64
  %r127 = load i64, ptr %slot.name, align 8
  %r128 = call i64 @nova_rt_upper(i64 %r127)
  %r129 = call i64 @nova_rt_any_to_str(i64 %r128)
  %r130 = call i64 @nova_rt_str_concat(i64 %r126, i64 %r129)
  %r131.p = getelementptr inbounds [1 x i8], ptr @.str.16, i64 0, i64 0
  %r131 = ptrtoint ptr %r131.p to i64
  %r132 = call i64 @nova_rt_str_concat(i64 %r130, i64 %r131)
  %r133 = call i64 @nova_rt_print_any(i64 %r132)
  %r134 = add i64 10, 0
  %r135 = load i64, ptr %slot.nums, align 8
  %r136 = call i64 @nova_rt_contains(i64 %r135, i64 %r134)
  %br_then12 = icmp ne i64 %r136, 0
  br i1 %br_then12, label %then12, label %else13
then12:
  %r137.p = getelementptr inbounds [21 x i8], ptr @.str.26, i64 0, i64 0
  %r137 = ptrtoint ptr %r137.p to i64
  %r138 = load i64, ptr %slot.nums, align 8
  %r139 = call i64 @nova_rt_len_any(i64 %r138)
  %r140 = call i64 @nova_rt_any_to_str(i64 %r139)
  %r141 = call i64 @nova_rt_str_concat(i64 %r137, i64 %r140)
  %r142.p = getelementptr inbounds [7 x i8], ptr @.str.27, i64 0, i64 0
  %r142 = ptrtoint ptr %r142.p to i64
  %r143 = call i64 @nova_rt_str_concat(i64 %r141, i64 %r142)
