...
entry:
  ...
  %r10 = add i64 0, 0
  %r11.lp = inttoptr i64 %r9 to ptr
  %r11.dp = load ptr, ptr %r11.lp, align 8, !tbaa !2
  %r11.ep = getelementptr i64, ptr %r11.dp, i64 %r10
  %r11 = load i64, ptr %r11.ep, align 8, !tbaa !4
  %r12 = call i64 @nova_rt_print_any(i64 %r11)
  %r13 = load i64, ptr %slot.nums, align 8
  %r14 = add i64 4, 0
  %r15.lp = inttoptr i64 %r13 to ptr
  %r15.dp = load ptr, ptr %r15.lp, align 8, !tbaa !2
  %r15.ep = getelementptr i64, ptr %r15.dp, i64 %r14
  %r15 = load i64, ptr %r15.ep, align 8, !tbaa !4
...
while_body1:
  ...
  %r26.lp = inttoptr i64 %r24 to ptr
  %r26.dp = load ptr, ptr %r26.lp, align 8, !tbaa !2
  %r26.ep = getelementptr i64, ptr %r26.dp, i64 %r25
  %r26 = load i64, ptr %r26.ep, align 8, !tbaa !4
