...
@.str.0 = private unnamed_addr constant [5 x i8] c"init\00"
@.str.1 = private unnamed_addr constant [4 x i8] c"key\00"
...
define i64 @dict_insert_lookup(i64 %p0) nounwind {
entry0:
...
while_body2:
  ...
  %r21 = ptrtoint ptr %t4 to i64
  %r22 = load i64, ptr %slot.i, align 8
  %r23 = call i64 @nova_rt_int_to_str(i64 %r22)
  %t5 = call i64 @nova_rt_dict_set_concat2(i64 %r63, i64 %r21, i64 %r23, i64 %r19)
...
while_header4:
  ...
  %t6 = icmp slt i64 %r41, %r64
  br i1 %t6, label %while_body5, label %while_exit6, !prof !90

while_body5:
  %r45 = load i64, ptr %slot.total, align 8
  %t7 = getelementptr inbounds [4 x i8], ptr @.str.1, i64 0, i64 0
  %r47 = ptrtoint ptr %t7 to i64
  %r48 = load i64, ptr %slot.j, align 8
  %r49 = call i64 @nova_rt_int_to_str(i64 %r48)
  %r51 = call i64 @nova_rt_dict_get_concat2(i64 %r65, i64 %r47, i64 %r49)
  call void @nova_rc_dec(i64 %r49)
  %r52 = add i64 %r45, %r51
  store i64 %r52, ptr %slot.total, align 8
  %r55 = load i64, ptr %slot.j, align 8
  %r57 = add i64 %r55, 1
  store i64 %r57, ptr %slot.j, align 8
  br label %while_header4, !llvm.loop !91

while_exit6:
  %r61 = load i64, ptr %slot.total, align 8
  %t8 = load i64, ptr %slot.d, align 8
...
entry0:
  %r1 = call i64 @dict_insert_lookup(i64 10000)
