...
catch_err10:
  ...
  %r12 = add i64 1, 0
  %r13 = sub i64 0, %r12
  store i64 %r13, ptr %slot.__catch_9, align 8
  br label %catch_merge12
catch_ok11:
  store i64 %r2, ptr %slot.__catch_9, align 8
  br label %catch_merge12
catch_merge12:
  %r14 = load i64, ptr %slot.__catch_9, align 8
...
catch_err14:
  ...
  %r29 = add i64 1, 0
  %r30 = sub i64 0, %r29
  store i64 %r30, ptr %slot.__catch_13, align 8
  br label %catch_merge16
catch_ok15:
  store i64 %r24, ptr %slot.__catch_13, align 8
  br label %catch_merge16
catch_merge16:
  %r31 = load i64, ptr %slot.__catch_13, align 8
  store i64 %r31, ptr %slot.good, align 8
...
catch_err18:
  ...
  %r54.p = getelementptr inbounds [8 x i8], ptr @.str.10, i64 0, i64 0
  %r54 = ptrtoint ptr %r54.p to i64
  store i64 %r54, ptr %slot.__catch_17, align 8
  br label %catch_merge20
catch_ok19:
  store i64 %r44, ptr %slot.__catch_17, align 8
  br label %catch_merge20
catch_merge20:
  %r55 = load i64, ptr %slot.__catch_17, align 8
  store i64 %r55, ptr %slot.val, align 8
