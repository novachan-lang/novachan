...
entry:
  ...
  %r9 = call i64 @nova_rt_dict_get(i64 %r7, i64 %r8)
  ...
  %r13 = call i64 @nova_rt_dict_get(i64 %r11, i64 %r12)
  ...
  %r24 = call i64 @nova_rt_dict_has(i64 %r22, i64 %r23)
  ...
  %r28 = call i64 @nova_rt_dict_has(i64 %r26, i64 %r27)
  ...
  %r41 = call i64 @nova_rt_dict_del(i64 %r39, i64 %r40)
  ...
  %r47 = call i64 @nova_rt_dict_has(i64 %r45, i64 %r46)
  ...
  %r60 = call i64 @nova_rt_dict_keys(i64 %r59)
