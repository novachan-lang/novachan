...
ifb_then10:
  %r56 = load i64, ptr %slot.count, align 8
  %r58 = add i64 %r56, 1
  store i64 %r58, ptr %slot.count, align 8
...
ifb_merge12:
  ...
  %r67 = add i64 %r65, 1
  store i64 %r67, ptr %slot.n, align 8
...
entry0:
  ...
  %r1 = call i64 @nova_rt_clock_ns()
  store i64 %r1, ptr %slot.t0, align 8
...
__mb0_merge:
  ...
  %r12 = call i64 @nova_rt_clock_ns()
  %r18 = call i64 @count_primes(i64 50000)
  %r23 = call i64 @nova_rt_clock_ns()
  %t1 = getelementptr inbounds [17 x i8], ptr @.str.0, i64 0, i64 0
  %r27 = ptrtoint ptr %t1 to i64
  %r29 = call i64 @nova_rt_int_to_str(i64 %r89)
  %t2 = call i64 @nova_rt_str_concat(i64 %r27, i64 %r29)
  call void @nova_rc_dec(i64 %r29)
  %t3 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r31 = ptrtoint ptr %t3 to i64
  %t4 = call i64 @nova_rt_str_concat(i64 %t2, i64 %r31)
  call void @nova_rc_dec(i64 %t2)
  %r34 = load i64, ptr %slot.t0, align 8
  %r35 = sub i64 %r12, %r34
  %r37 = sdiv i64 %r35, 1000000
  %r38 = call i64 @nova_rt_int_to_str(i64 %r37)
  %t5 = call i64 @nova_rt_str_concat(i64 %t4, i64 %r38)
  call void @nova_rc_dec(i64 %t4)
  call void @nova_rc_dec(i64 %r38)
  %t6 = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
  %r40 = ptrtoint ptr %t6 to i64
  %t7 = call i64 @nova_rt_str_concat(i64 %t5, i64 %r40)
  ...
  %r43 = ptrtoint ptr %t9 to i64
  %r45 = call i64 @nova_rt_int_to_str(i64 %r18)
  %t10 = call i64 @nova_rt_str_concat(i64 %r43, i64 %r45)
  call void @nova_rc_dec(i64 %r45)
  %t11 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  %r47 = ptrtoint ptr %t11 to i64
  %t12 = call i64 @nova_rt_str_concat(i64 %t10, i64 %r47)
  call void @nova_rc_dec(i64 %t10)
  %r51 = sub i64 %r23, %r12
  %r53 = sdiv i64 %r51, 1000000
  %r54 = call i64 @nova_rt_int_to_str(i64 %r53)
  %t13 = call i64 @nova_rt_str_concat(i64 %t12, i64 %r54)
  call void @nova_rc_dec(i64 %t12)
  call void @nova_rc_dec(i64 %r54)
  %t14 = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
  %r56 = ptrtoint ptr %t14 to i64
  %t15 = call i64 @nova_rt_str_concat(i64 %t13, i64 %r56)
