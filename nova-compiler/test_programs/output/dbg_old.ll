...
define i64 @simple_test() nounwind {
entry:
  ...
  store i64 42, ptr %slot.x, align 8
  ...
  %t6 = icmp sgt i64 %r4, 10
  %r5 = zext i1 %t6 to i64
  %t7 = icmp ne i64 %r5, 0
  br i1 %t7, label %then0, label %else1
then0:
  %r8 = getelementptr inbounds [4 x i8], ptr @.str.0, i64 0, i64 0
...
while_hdr3:
  ...
  %t16 = icmp slt i64 %r14, 5
  %r15 = zext i1 %t16 to i64
  %t17 = icmp ne i64 %r15, 0
  br i1 %t17, label %while_body4, label %while_exit5
while_body4:
...
; String constants
@.str.0 = private unnamed_addr constant [4 x i8] c"big\00"
@.str.1 = private unnamed_addr constant [6 x i8] c"small\00"
