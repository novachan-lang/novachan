...
entry:
  ...
  %r1 = load i64, ptr %slot.greeting, align 8
  %r2 = call i64 @nova_rt_any_to_str(i64 %r1)
  ...
  %r9.p = getelementptr inbounds [1 x i8], ptr @.str.0, i64 0, i64 0
...
entry:
  ...
  %slot.xp = alloca i64, align 8
  store i64 0, ptr %slot.xp, align 8
  %r0 = add i64 1, 0
...
for_body1:
  ...
  %r7 = load i64, ptr %slot.xp, align 8
  %r8 = add i64 1, 0
  %r9 = sub i64 %r7, %r8
  %r10 = load i64, ptr %slot.result, align 8
  %r11 = load i64, ptr %slot.base, align 8
  %r12 = mul i64 %r10, %r11
...
define i64 @make_list(i64 %p0, i64 %p1) nounwind {
entry:
  %slot.size = alloca i64, align 8
  store i64 %p0, ptr %slot.size, align 8
...
for_body4:
  %r6 = call i64 @nova_rt_index_get(i64 %r1, i64 %r4)
  store i64 %r6, ptr %slot.i, align 8
  %r7 = load i64, ptr %slot.size, align 8
  %r8 = add i64 1, 0
  %r9 = sub i64 %r7, %r8
  %r10 = load i64, ptr %slot.result, align 8
...
entry:
  ...
  %slot.nums2 = alloca i64, align 8
  store i64 0, ptr %slot.nums2, align 8
  %r0.p = getelementptr inbounds [6 x i8], ptr @.str.2, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = call i64 @greet(i64 %r0)
  %r2.p = getelementptr inbounds [5 x i8], ptr @.str.3, i64 0, i64 0
  %r2 = ptrtoint ptr %r2.p to i64
  %r3.p = getelementptr inbounds [11 x i8], ptr @.str.4, i64 0, i64 0
  %r3 = ptrtoint ptr %r3.p to i64
  %r4 = call i64 @greet(i64 %r2, i64 %r3)
  %r5 = add i64 3, 0
  %r6 = call i64 @power(i64 %r5)
  %r7 = call i64 @nova_rt_print_any(i64 %r6)
  %r8 = add i64 2, 0
  %r9 = add i64 10, 0
  %r10 = call i64 @power(i64 %r8, i64 %r9)
  %r11 = call i64 @nova_rt_print_any(i64 %r10)
  %r12 = add i64 3, 0
  %r13 = call i64 @make_list(i64 %r12)
  ...
  %r17 = add i64 3, 0
  %r18 = add i64 42, 0
  %r19 = call i64 @make_list(i64 %r17, i64 %r18)
  store i64 %r19, ptr %slot.nums2, align 8
  %r20 = load i64, ptr %slot.nums2, align 8
  %r21 = add i64 1, 0
  %r22 = sub i64 0, %r21
  %r23 = call i64 @nova_rt_index_get(i64 %r20, i64 %r22)
  %r24 = call i64 @nova_rt_print_any(i64 %r23)
  %r25.p = getelementptr inbounds [5 x i8], ptr @.str.5, i64 0, i64 0
...
@.str.4 = private unnamed_addr constant [11 x i8] c"welcome to\00"
