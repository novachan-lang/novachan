...
entry:
  ...
  %r0.p = getelementptr inbounds [15 x i8], ptr @.str.2, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = load i64, ptr %slot.n, align 8
  %r2 = call i64 @nova_rt_any_to_str(i64 %r1)
  %r3 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r2)
  %r4.p = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @nova_rt_str_concat(i64 %r3, i64 %r4)
  ret i64 %r5
}

define i64 @formatResult(i64 %p0, i64 %p1) nounwind {
entry:
  ...
  %r0.p = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = load i64, ptr %slot.label, align 8
  %r2 = call i64 @nova_rt_any_to_str(i64 %r1)
  %r3 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r2)
  %r4.p = getelementptr inbounds [4 x i8], ptr @.str.4, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @nova_rt_str_concat(i64 %r3, i64 %r4)
...
entry:
  %r0.p = getelementptr inbounds [6 x i8], ptr @.str.5, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = call i64 @greet(i64 %r0)
  %r2 = call i64 @nova_rt_print_any(i64 %r1)
  %r3.p = getelementptr inbounds [5 x i8], ptr @.str.6, i64 0, i64 0
  ...
  %r12.p = getelementptr inbounds [4 x i8], ptr @.str.7, i64 0, i64 0
  %r12 = ptrtoint ptr %r12.p to i64
  %r13 = add i64 1000, 0
  %r14 = call i64 @formatResult(i64 %r12, i64 %r13)
  ...
  %r17 = add i64 3, 0
  %r18 = call i64 @formatResult(i64 %r16, i64 %r17)
