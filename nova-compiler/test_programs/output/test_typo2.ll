...
entry:
  %slot.ad = alloca i64, align 8
  store i64 0, ptr %slot.ad, align 8
  ...
  %slot.le = alloca i64, align 8
  store i64 0, ptr %slot.le, align 8
  %slot.length = alloca i64, align 8
  store i64 0, ptr %slot.length, align 8
  %slot.reslt = alloca i64, align 8
  store i64 0, ptr %slot.reslt, align 8
  %r0 = add i64 3, 0
  %r1 = add i64 4, 0
  %r3 = load i64, ptr %slot.ad, align 8
  ...
  store i64 %r4, ptr %slot.msg, align 8
  %r5 = load i64, ptr %slot.msg, align 8
  %r7 = load i64, ptr %slot.le, align 8
  ...
  store i64 %r6, ptr %slot.length, align 8
  %r8 = load i64, ptr %slot.reslt, align 8
