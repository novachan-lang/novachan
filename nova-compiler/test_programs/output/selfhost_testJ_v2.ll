...
entry:
  ...
  %r0 = add i64 10, 0
  %r1 = call i64 @make_range(i64 %r0)
  store i64 %r1, ptr %slot.nums, align 8
  %r2 = load i64, ptr %slot.nums, align 8
  %r3 = call i64 @nova_rt_len_any(i64 %r2)
  %r4 = call i64 @nova_rt_print_any(i64 %r3)
  %r5 = load i64, ptr %slot.nums, align 8
  %r6 = call i64 @sum_list(i64 %r5)
  %r7 = call i64 @nova_rt_print_any(i64 %r6)
  %r9.p = getelementptr inbounds [6 x i8], ptr @.str.0, i64 0, i64 0
  %r9 = ptrtoint ptr %r9.p to i64
  %r10.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r10 = ptrtoint ptr %r10.p to i64
  %r11.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
  %r11 = ptrtoint ptr %r11.p to i64
  %r8 = call i64 @nova_rt_list_create()
  call i64 @nova_rt_list_append(i64 %r8, i64 %r9)
  call i64 @nova_rt_list_append(i64 %r8, i64 %r10)
  call i64 @nova_rt_list_append(i64 %r8, i64 %r11)
  store i64 %r8, ptr %slot.words, align 8
  %r12 = load i64, ptr %slot.words, align 8
  %r13 = call i64 @nova_rt_len_any(i64 %r12)
  %r14 = add i64 0, 0
  store i64 %r14, ptr %slot.__for_idx_6, align 8
  br label %for_hdr6, !llvm.loop !91
for_hdr6:
  %r15 = load i64, ptr %slot.__for_idx_6, align 8
  %r16.cmp = icmp slt i64 %r15, %r13
  %r16 = zext i1 %r16.cmp to i64
  %br_for_body7 = icmp ne i64 %r16, 0
  br i1 %br_for_body7, label %for_body7, label %for_exit8, !prof !90
for_body7:
  %r17.lp = inttoptr i64 %r12 to ptr
  %r17.dp = load ptr, ptr %r17.lp, align 8, !tbaa !2
  %r17.ep = getelementptr i64, ptr %r17.dp, i64 %r15
  %r17 = load i64, ptr %r17.ep, align 8, !tbaa !4
  store i64 %r17, ptr %slot.w, align 8
  %r18 = load i64, ptr %slot.w, align 8
  %r19 = call i64 @nova_rt_print_any(i64 %r18)
  %r20 = load i64, ptr %slot.__for_idx_6, align 8
  %r21 = add i64 1, 0
  %r22 = add i64 %r20, %r21
  store i64 %r22, ptr %slot.__for_idx_6, align 8
  br label %for_hdr6, !llvm.loop !91
for_exit8:
  ret i64 0
}
