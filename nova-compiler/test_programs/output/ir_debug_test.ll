...
__mb0_entry0:
  %t0 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t0, i64 43)
...
__mb0_while_header4:
  %r14 = load i64, ptr %slot.__mb0_i, align 8
  %t3 = icmp slt i64 %r14, 5
  br i1 %t3, label %__mb0_while_body5, label %__mb0_while_exit6, !prof !90

__mb0_while_body5:
  %r17 = load i64, ptr %slot.__mb0_total, align 8
  %r18 = load i64, ptr %slot.__mb0_i, align 8
  %r19 = add i64 %r17, %r18
  store i64 %r19, ptr %slot.__mb0_total, align 8
  %r21 = load i64, ptr %slot.__mb0_i, align 8
  %r23 = add i64 %r21, 1
  store i64 %r23, ptr %slot.__mb0_i, align 8
  br label %__mb0_while_header4, !llvm.loop !91

__mb0_while_exit6:
  %r25 = load i64, ptr %slot.__mb0_total, align 8
  %t4 = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t4, i64 %r25)
