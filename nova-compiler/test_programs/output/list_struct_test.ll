...
list_append_28:
  ...
  store i64 %r14, ptr %t33, align 8, !tbaa !4
  call void @nova_rc_inc(i64 %r14)
  %t34 = add i64 %t25, 1
  store i64 %t34, ptr %t23, align 8, !tbaa !6
  call void @nova_rc_dec(i64 %r14)
  %t35 = inttoptr i64 %r2 to ptr
  %t36 = load ptr, ptr %t35, align 8, !tbaa !2
  %t37 = getelementptr i64, ptr %t36, i64 0
  %r19 = load i64, ptr %t37, align 8, !tbaa !4
  %t38 = load i64, ptr %slot.first, align 8
  call void @nova_rc_dec(i64 %t38)
  call void @nova_rc_inc(i64 %r19)
  store i64 %r19, ptr %slot.first, align 8
  %r23 = load i64, ptr %slot.first, align 8
  br label %arm0_body2

arm0_body2:
  %t39 = inttoptr i64 %r23 to ptr
  %t40 = getelementptr i64, ptr %t39, i64 0
  %r25 = load i64, ptr %t40
  %t41 = inttoptr i64 %r23 to ptr
  %t42 = getelementptr i64, ptr %t41, i64 1
  %r28 = load i64, ptr %t42
  %t43 = inttoptr i64 %r25 to ptr
  call i32 @puts(ptr %t43)
  %r35 = call i64 @nova_rt_int_to_str(i64 %r28)
  %t44 = inttoptr i64 %r35 to ptr
...
match_merge1:
  ...
  %t45 = inttoptr i64 %r40 to ptr
  %t46 = load ptr, ptr %t45, align 8, !tbaa !2
  %t47 = getelementptr i64, ptr %t46, i64 1
  %r42 = load i64, ptr %t47, align 8, !tbaa !4
  %t48 = load i64, ptr %slot.second, align 8
  call void @nova_rc_dec(i64 %t48)
  call void @nova_rc_inc(i64 %r42)
  store i64 %r42, ptr %slot.second, align 8
  %r46 = load i64, ptr %slot.second, align 8
  br label %arm0_body4

arm0_body4:
  %t49 = inttoptr i64 %r46 to ptr
  %t50 = getelementptr i64, ptr %t49, i64 0
  %r48 = load i64, ptr %t50
  %t51 = inttoptr i64 %r46 to ptr
  %t52 = getelementptr i64, ptr %t51, i64 1
  %r50 = load i64, ptr %t52
  %t53 = inttoptr i64 %r48 to ptr
  call i32 @puts(ptr %t53)
  %r56 = call i64 @nova_rt_int_to_str(i64 %r50)
  %t54 = inttoptr i64 %r56 to ptr
  call i32 @puts(ptr %t54)
  call void @nova_rc_dec(i64 %r56)
  br label %match_merge3, !llvm.loop !91

match_merge3:
  %t55 = load i64, ptr %slot.items, align 8
  call void @nova_rc_dec(i64 %t55)
  %t56 = load i64, ptr %slot.first, align 8
  call void @nova_rc_dec(i64 %t56)
  %t57 = load i64, ptr %slot.second, align 8
