...
define i64 @range(i64 %p0) nounwind {
entry:
...
while_hdr0:
  ...
  %br_while_body1 = icmp ne i64 %r3, 0
...
define i64 @squares(i64 %p0) nounwind {
entry:
  %slot.n = alloca i64, align 8
  store i64 %p0, ptr %slot.n, align 8
  ...
  %r1 = call i64 @nova_rt_range(i64 %r0)
...
for_body4:
  ...
  store i64 %r6, ptr %slot.i, align 8
  %r7 = load i64, ptr %slot.__for_idx_3, align 8
  %r8 = add i64 1, 0
  %r9 = add i64 %r7, %r8
  store i64 %r9, ptr %slot.__for_idx_3, align 8
  br label %for_hdr3, !llvm.loop !91
for_exit5:
  ret i64 0
}

define i64 @fibonacci(i64 %p0) nounwind {
entry:
  %slot.n = alloca i64, align 8
  store i64 %p0, ptr %slot.n, align 8
  ...
  %r2 = add i64 0, 0
  store i64 %r2, ptr %slot.count, align 8
  br label %while_hdr6, !llvm.loop !91
while_hdr6:
  %r3 = load i64, ptr %slot.count, align 8
  %r4 = load i64, ptr %slot.n, align 8
  %r5.cmp = icmp slt i64 %r3, %r4
  %r5 = zext i1 %r5.cmp to i64
  %br_while_body7 = icmp ne i64 %r5, 0
...
while_body7:
  ...
  %r8 = add i64 %r6, %r7
  store i64 %r8, ptr %slot.temp, align 8
  %r9 = load i64, ptr %slot.b, align 8
  store i64 %r9, ptr %slot.a, align 8
  %r10 = load i64, ptr %slot.temp, align 8
  store i64 %r10, ptr %slot.b, align 8
  %r11 = load i64, ptr %slot.count, align 8
  %r12 = add i64 1, 0
  %r13 = add i64 %r11, %r12
  store i64 %r13, ptr %slot.count, align 8
  br label %while_hdr6, !llvm.loop !91
while_exit8:
  ret i64 0
}
...
entry:
  ...
  %slot.fibs = alloca i64, align 8
  store i64 0, ptr %slot.fibs, align 8
  %r0 = add i64 5, 0
  %r1 = call i64 @nova_rt_range(i64 %r0)
  ...
  %r4 = add i64 5, 0
  %r5 = call i64 @squares(i64 %r4)
  store i64 %r5, ptr %slot.sq, align 8
  %r6 = load i64, ptr %slot.sq, align 8
  %r7 = call i64 @nova_rt_print_any(i64 %r6)
  %r8 = add i64 8, 0
  %r9 = call i64 @fibonacci(i64 %r8)
  store i64 %r9, ptr %slot.fibs, align 8
  %r10 = load i64, ptr %slot.fibs, align 8
  %r11 = call i64 @nova_rt_print_any(i64 %r10)
  %r12 = add i64 10, 0
  %r13 = call i64 @nova_rt_range(i64 %r12)
