...
entry:
  ...
  %r2.p = getelementptr inbounds [12 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %r6.p = getelementptr inbounds [10 x i8], ptr @.str.2, i64 0, i64 0
  %r6 = ptrtoint ptr %r6.p to i64
  %r7 = call i64 @nova_rt_str_concat(i64 %r5, i64 %r6)
  %r8 = load i64, ptr %slot.version, align 8
  %r9 = call i64 @nova_rt_any_to_str(i64 %r8)
  %r10 = call i64 @nova_rt_str_concat(i64 %r7, i64 %r9)
  %r11.p = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r11 = ptrtoint ptr %r11.p to i64
  %r12 = call i64 @nova_rt_str_concat(i64 %r10, i64 %r11)
  %r13 = call i64 @nova_rt_print_any(i64 %r12)
  %r14 = add i64 10, 0
  store i64 %r14, ptr %slot.x, align 8
  %r15 = add i64 20, 0
  store i64 %r15, ptr %slot.y, align 8
  ...
  %r25.p = getelementptr inbounds [4 x i8], ptr @.str.5, i64 0, i64 0
  %r25 = ptrtoint ptr %r25.p to i64
  %r26 = call i64 @nova_rt_str_concat(i64 %r24, i64 %r25)
  %r27 = load i64, ptr %slot.x, align 8
  %r28 = load i64, ptr %slot.y, align 8
  %r29 = add i64 %r27, %r28
  %r30 = call i64 @nova_rt_any_to_str(i64 %r29)
  %r31 = call i64 @nova_rt_str_concat(i64 %r26, i64 %r30)
  %r32.p = getelementptr inbounds [1 x i8], ptr @.str.3, i64 0, i64 0
  %r32 = ptrtoint ptr %r32.p to i64
  %r33 = call i64 @nova_rt_str_concat(i64 %r31, i64 %r32)
  %r34 = call i64 @nova_rt_print_any(i64 %r33)
  %r35.p = getelementptr inbounds [5 x i8], ptr @.str.6, i64 0, i64 0
...
@.str.1 = private unnamed_addr constant [12 x i8] c"Hello from \00"
@.str.2 = private unnamed_addr constant [10 x i8] c" version \00"
