...
entry:
  %r0.p = getelementptr inbounds [22 x i8], ptr @.str.0, i64 0, i64 0
  %r0 = ptrtoint ptr %r0.p to i64
  %r1 = call i64 @nova_rt_write_raw(i64 %r0)
  %r2.p = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r2 = ptrtoint ptr %r2.p to i64
  %r3 = call i64 @nova_rt_write_raw(i64 %r2)
  %r4.p = getelementptr inbounds [1 x i8], ptr @.str.2, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = call i64 @nova_rt_print_any(i64 %r4)
  %r6.p = getelementptr inbounds [22 x i8], ptr @.str.3, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [22 x i8] c"Content-Length: 5\0D\0A\0D\0A\00"
@.str.1 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.2 = private unnamed_addr constant [1 x i8] c"\00"
@.str.3 = private unnamed_addr constant [22 x i8] c"write_raw test passed\00"
