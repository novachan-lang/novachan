...
while_header1:
  %r18 = load i64, ptr %slot.running, align 8
  %t6 = icmp eq i64 %r18, 1
  br i1 %t6, label %while_body2, label %while_exit3, !prof !90

while_body2:
  %r23 = call i64 @nova_rt_channel_recv(i64 %r54)
  %t7 = load i64, ptr %slot.val, align 8
  call void @nova_rc_dec(i64 %t7)
  store i64 %r23, ptr %slot.val, align 8
  %t8 = icmp eq i64 %r23, -1
...
while_exit3:
  ...
  call i32 (ptr, ...) @printf(ptr %t9, i64 %r51)
  %t10 = load i64, ptr %slot.ch, align 8
  call void @nova_rc_dec(i64 %t10)
  %t11 = load i64, ptr %slot.val, align 8
...
ifb_else5:
  ...
  %r39 = load i64, ptr %slot.val, align 8
  %r40 = add i64 %r38, %r39
...
while_exit3:
  ...
  %t2 = call i64 @nova_rt_channel_send(i64 %r24, i64 -1)
  ret i64 0
}
