...
@.str.1 = private unnamed_addr constant [18 x i8] c"The answer is {x}\00"
@.str.2 = private unnamed_addr constant [20 x i8] c"{a} + {b} = {a + b}\00"
...
entry0:
  ...
  %t2 = getelementptr inbounds [18 x i8], ptr @.str.1, i64 0, i64 0
  %r14 = ptrtoint ptr %t2 to i64
  %t3 = inttoptr i64 %r14 to ptr
  call i32 @puts(ptr %t3)
  %t4 = getelementptr inbounds [20 x i8], ptr @.str.2, i64 0, i64 0
  %r28 = ptrtoint ptr %t4 to i64
  %t5 = inttoptr i64 %r28 to ptr
