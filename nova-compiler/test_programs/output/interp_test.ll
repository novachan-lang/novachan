...
@.str.1 = private unnamed_addr constant [17 x i8] c"The answer is 42\00"
...
entry0:
  ...
  %t2 = getelementptr inbounds [17 x i8], ptr @.str.1, i64 0, i64 0
  %r22 = ptrtoint ptr %t2 to i64
  %t3 = inttoptr i64 %r22 to ptr
  call i32 @puts(ptr %t3)
  %t4 = getelementptr inbounds [13 x i8], ptr @.str.2, i64 0, i64 0
  %r48 = ptrtoint ptr %t4 to i64
  %t5 = inttoptr i64 %r48 to ptr
