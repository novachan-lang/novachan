...
@.str.0 = private unnamed_addr constant [17 x i8] c"this should fail\00"
@.str.1 = private unnamed_addr constant [22 x i8] c"should not reach here\00"
...
entry0:
  ...
  call void @nova_rt_assert(i64 0, i64 %r3)
  %t1 = getelementptr inbounds [22 x i8], ptr @.str.1, i64 0, i64 0
