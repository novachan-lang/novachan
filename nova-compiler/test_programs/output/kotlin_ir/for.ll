...
entry0:
  ...
  store i64 %r4, ptr %slot.__for_iter_1, align 8
  store i64 0, ptr %slot.__for_idx_1, align 8
  %r69 = load i64, ptr %slot.__for_iter_1, align 8
  br label %for_header1

for_header1:
  %r16 = load i64, ptr %slot.__for_idx_1, align 8
  %t7 = inttoptr i64 %r69 to ptr
  %t8 = getelementptr i64, ptr %t7, i64 1
  %t9 = load i64, ptr %t8, align 8
  %t10 = icmp slt i64 %r16, %t9
  %r15 = zext i1 %t10 to i64
  %t11 = trunc i64 %r15 to i1
  br i1 %t11, label %for_body2, label %for_exit3, !prof !90

for_body2:
  %r18 = load i64, ptr %slot.__for_idx_1, align 8
  %t12 = inttoptr i64 %r69 to ptr
  %t13 = load ptr, ptr %t12, align 8, !tbaa !2
  %t14 = getelementptr i64, ptr %t13, i64 %r18
  %r19 = load i64, ptr %t14, align 8, !tbaa !4
  %t15 = inttoptr i64 %r19 to ptr
  call i32 @puts(ptr %t15)
  %r25 = add i64 %r18, 1
  store i64 %r25, ptr %slot.__for_idx_1, align 8
  br label %for_header1, !llvm.loop !91

for_exit3:
  %r33 = call i64 @nova_rt_list_create()
  %t16 = call i64 @nova_rt_list_append(i64 %r33, i64 10)
  %t17 = call i64 @nova_rt_list_append(i64 %r33, i64 20)
  %t18 = call i64 @nova_rt_list_append(i64 %r33, i64 30)
  store i64 0, ptr %slot.total, align 8
  %t19 = load i64, ptr %slot.__for_iter_4, align 8
  call void @nova_rc_dec(i64 %t19)
  store i64 %r33, ptr %slot.__for_iter_4, align 8
  store i64 0, ptr %slot.__for_idx_4, align 8
  %r70 = load i64, ptr %slot.__for_iter_4, align 8
  br label %for_header4

for_header4:
  %r50 = load i64, ptr %slot.__for_idx_4, align 8
  %t20 = inttoptr i64 %r70 to ptr
  %t21 = getelementptr i64, ptr %t20, i64 1
  %t22 = load i64, ptr %t21, align 8
  %t23 = icmp slt i64 %r50, %t22
  %r49 = zext i1 %t23 to i64
  %t24 = trunc i64 %r49 to i1
  br i1 %t24, label %for_body5, label %for_exit6, !prof !90

for_body5:
  %r52 = load i64, ptr %slot.__for_idx_4, align 8
  %t25 = inttoptr i64 %r70 to ptr
  %t26 = load ptr, ptr %t25, align 8, !tbaa !2
  %t27 = getelementptr i64, ptr %t26, i64 %r52
  %r53 = load i64, ptr %t27, align 8, !tbaa !4
  %r57 = load i64, ptr %slot.total, align 8
  %r59 = add i64 %r57, %r53
  store i64 %r59, ptr %slot.total, align 8
  %r62 = add i64 %r52, 1
  store i64 %r62, ptr %slot.__for_idx_4, align 8
  br label %for_header4, !llvm.loop !91

for_exit6:
  %r66 = load i64, ptr %slot.total, align 8
  %t28 = getelementptr inbounds [5 x i8], ptr @.str.3, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t28, i64 %r66)
  %t29 = load i64, ptr %slot.__for_iter_1, align 8
