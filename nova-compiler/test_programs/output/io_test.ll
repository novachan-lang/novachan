...
entry0:
  ...
  %r12 = call i64 @nova_rt_contains(i64 %r4, i64 %r11)
  %t5 = icmp ne i64 %r12, 0
  ...
  %r16 = call i64 @nova_rt_contains(i64 %r4, i64 %r15)
  ...
  %r19 = call i64 @nova_rt_len(i64 %r4)
  call void @nova_rc_dec(i64 %r4)
  %t14 = call i64 @nova_rt_any_to_str(i64 %r19)
