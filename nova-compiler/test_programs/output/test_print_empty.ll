...
entry0:
  %t0 = getelementptr inbounds [32 x i8], ptr @.str.0, i64 0, i64 0
  ...
  %r7 = ptrtoint ptr %t6 to i64
  %t7 = inttoptr i64 %r7 to ptr
  call i32 @puts(ptr %t7)
  %t8 = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
  ...
  %t12 = getelementptr inbounds [4 x i8], ptr @.str.3, i64 0, i64 0
  %r18 = ptrtoint ptr %t12 to i64
  %t13 = inttoptr i64 %r18 to ptr
  call i32 @puts(ptr %t13)
  %t14 = getelementptr inbounds [6 x i8], ptr @.str.5, i64 0, i64 0
  %r21 = ptrtoint ptr %t14 to i64
  %t15 = getelementptr inbounds [1 x i8], ptr @.str.1, i64 0, i64 0
  %r22 = ptrtoint ptr %t15 to i64
  %t16 = getelementptr inbounds [6 x i8], ptr @.str.6, i64 0, i64 0
  %r23 = ptrtoint ptr %t16 to i64
  %r24 = call i64 @nova_rt_list_create()
  %t17 = call i64 @nova_rt_list_append(i64 %r24, i64 %r21)
  %t18 = call i64 @nova_rt_list_append(i64 %r24, i64 %r22)
  %t19 = call i64 @nova_rt_list_append(i64 %r24, i64 %r23)
  call i64 @nova_rt_list_print(i64 %r24)
  call void @nova_rc_dec(i64 %r24)
  %t20 = getelementptr inbounds [13 x i8], ptr @.str.7, i64 0, i64 0
  %r30 = ptrtoint ptr %t20 to i64
