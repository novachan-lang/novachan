...
while_body16:
  ...
  %r59 = call i64 @nova_rt_add(i64 %r55, i64 %r58)
...
while_body22:
  ...
  %r81 = add i64 1, 0
  %r82 = call i64 @nova_rt_add(i64 %r80, i64 %r81)
...
while_body25:
  ...
  %r92 = call i64 @nova_rt_add(i64 %r88, i64 %r91)
...
then27:
  ...
  %r110 = add i64 1, 0
  %r111 = call i64 @nova_rt_add(i64 %r109, i64 %r110)
...
entry:
  ...
  br label %for_hdr36
for_hdr36:
  %r8 = load i64, ptr %slot.__for_idx_36, align 8
  %r9.cmp = icmp slt i64 %r8, %r7
  %r9 = zext i1 %r9.cmp to i64
  %br_for_body37 = icmp ne i64 %r9, 0
  br i1 %br_for_body37, label %for_body37, label %for_exit38
for_body37:
  %r10 = call i64 @nova_rt_index_get(i64 %r6, i64 %r8)
  store i64 %r10, ptr %slot.t, align 8
  %r11 = load i64, ptr %slot.__for_idx_36, align 8
  %r12 = add i64 1, 0
  %r13 = add i64 %r11, %r12
  store i64 %r13, ptr %slot.__for_idx_36, align 8
  br label %for_hdr36
for_exit38:
  ret i64 0
}
