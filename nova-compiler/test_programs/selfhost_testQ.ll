...
while_hdr15:
  ...
  %br_while_body16 = icmp ne i64 %r5, 0
...
while_body16:
  ...
  %br_or_merge20 = icmp ne i64 %r11, 0
...
then24:
  ...
  %r25.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r25.thash = getelementptr i64, ptr %r25.ptr, i64 0
  store i64 210691276070, ptr %r25.thash, align 8
  %r25.f0 = getelementptr i64, ptr %r25.ptr, i64 1
  store i64 %r23, ptr %r25.f0, align 8
  %r25.f1 = getelementptr i64, ptr %r25.ptr, i64 2
...
while_hdr30:
  ...
  store i64 %r36, ptr %slot.__sc_33, align 8
  %br_and_rhs34 = icmp ne i64 %r36, 0
...
and_rhs34:
  ...
  store i64 %r40, ptr %slot.__sc_36, align 8
  %br_or_merge38 = icmp ne i64 %r40, 0
...
or_rhs37:
  ...
  store i64 %r44, ptr %slot.__sc_36, align 8
  br label %or_merge38
or_merge38:
  %r45 = load i64, ptr %slot.__sc_36, align 8
  store i64 %r45, ptr %slot.__sc_33, align 8
  br label %and_merge35
and_merge35:
  %r46 = load i64, ptr %slot.__sc_33, align 8
  %br_while_body31 = icmp ne i64 %r46, 0
  br i1 %br_while_body31, label %while_body31, label %while_exit32, !prof !90
while_body31:
...
while_exit32:
  ...
  br label %while_hdr39, !llvm.loop !91
while_hdr39:
  %r52 = load i64, ptr %slot.j, align 8
  %r53 = load i64, ptr %slot.i, align 8
  %r54.cmp = icmp slt i64 %r52, %r53
  %r54 = zext i1 %r54.cmp to i64
  %br_while_body40 = icmp ne i64 %r54, 0
  br i1 %br_while_body40, label %while_body40, label %while_exit41, !prof !90
while_body40:
...
while_exit41:
  ...
  %r66.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r66.thash = getelementptr i64, ptr %r66.ptr, i64 0
  store i64 210691276070, ptr %r66.thash, align 8
  %r66.f0 = getelementptr i64, ptr %r66.ptr, i64 1
  store i64 %r64, ptr %r66.f0, align 8
  %r66.f1 = getelementptr i64, ptr %r66.ptr, i64 2
...
while_hdr45:
  ...
  store i64 %r74, ptr %slot.__sc_48, align 8
  %br_and_rhs49 = icmp ne i64 %r74, 0
  br i1 %br_and_rhs49, label %and_rhs49, label %and_merge50
and_rhs49:
  ...
  store i64 %r78, ptr %slot.__sc_48, align 8
  br label %and_merge50
and_merge50:
  %r79 = load i64, ptr %slot.__sc_48, align 8
  %br_while_body46 = icmp ne i64 %r79, 0
  br i1 %br_while_body46, label %while_body46, label %while_exit47, !prof !90
while_body46:
...
while_exit47:
  ...
  br label %while_hdr51, !llvm.loop !91
while_hdr51:
  %r85 = load i64, ptr %slot.j, align 8
  %r86 = load i64, ptr %slot.i, align 8
  %r87.cmp = icmp slt i64 %r85, %r86
  %r87 = zext i1 %r87.cmp to i64
  %br_while_body52 = icmp ne i64 %r87, 0
  br i1 %br_while_body52, label %while_body52, label %while_exit53, !prof !90
while_body52:
...
while_exit53:
  ...
  %r99.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r99.thash = getelementptr i64, ptr %r99.ptr, i64 0
  store i64 210691276070, ptr %r99.thash, align 8
  %r99.f0 = getelementptr i64, ptr %r99.ptr, i64 1
  store i64 %r97, ptr %r99.f0, align 8
  %r99.f1 = getelementptr i64, ptr %r99.ptr, i64 2
...
else43:
  ...
  %r103.p0 = inttoptr i64 %r101 to ptr
  %r103.p1 = inttoptr i64 %r102 to ptr
  %r103.sc = call i32 @strcmp(ptr %r103.p0, ptr %r103.p1)
  %r103.cmp = icmp eq i32 %r103.sc, 0
  %r103 = zext i1 %r103.cmp to i64
  %br_then54 = icmp ne i64 %r103, 0
...
then54:
  ...
  %r107.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r107.thash = getelementptr i64, ptr %r107.ptr, i64 0
  store i64 210691276070, ptr %r107.thash, align 8
  %r107.f0 = getelementptr i64, ptr %r107.ptr, i64 1
  store i64 %r105, ptr %r107.f0, align 8
  %r107.f1 = getelementptr i64, ptr %r107.ptr, i64 2
...
else55:
  ...
  %r114.p0 = inttoptr i64 %r112 to ptr
  %r114.p1 = inttoptr i64 %r113 to ptr
  %r114.sc = call i32 @strcmp(ptr %r114.p0, ptr %r114.p1)
  %r114.cmp = icmp eq i32 %r114.sc, 0
  %r114 = zext i1 %r114.cmp to i64
  %br_then57 = icmp ne i64 %r114, 0
...
then57:
  ...
  %r118.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r118.thash = getelementptr i64, ptr %r118.ptr, i64 0
  store i64 210691276070, ptr %r118.thash, align 8
  %r118.f0 = getelementptr i64, ptr %r118.ptr, i64 1
  store i64 %r116, ptr %r118.f0, align 8
  %r118.f1 = getelementptr i64, ptr %r118.ptr, i64 2
...
then60:
  ...
  %r129.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r129.thash = getelementptr i64, ptr %r129.ptr, i64 0
  store i64 210691276070, ptr %r129.thash, align 8
  %r129.f0 = getelementptr i64, ptr %r129.ptr, i64 1
  store i64 %r127, ptr %r129.f0, align 8
  %r129.f1 = getelementptr i64, ptr %r129.ptr, i64 2
...
else61:
  ...
  %r137.ptr = call ptr @nova_rt_struct_alloc(i64 24)
  %r137.thash = getelementptr i64, ptr %r137.ptr, i64 0
  store i64 210691276070, ptr %r137.thash, align 8
  %r137.f0 = getelementptr i64, ptr %r137.ptr, i64 1
  store i64 %r135, ptr %r137.f0, align 8
  %r137.f1 = getelementptr i64, ptr %r137.ptr, i64 2
...
entry:
  ...
  br label %for_hdr63, !llvm.loop !91
for_hdr63:
  ...
  br i1 %br_for_body64, label %for_body64, label %for_exit65, !prof !90
for_body64:
...
marm_067:
  ...
  %r21 = load i64, ptr %slot.value, align 8
  %r22 = call i64 @nova_rt_str_concat(i64 %r20, i64 %r21)
  %r23 = call i64 @nova_rt_print_any(i64 %r22)
  br label %match_exit66
match_fall68:
  br label %match_exit66
match_exit66:
  %r24 = load i64, ptr %slot.__for_idx_63, align 8
  %r25 = add i64 1, 0
  %r26 = add i64 %r24, %r25
  store i64 %r26, ptr %slot.__for_idx_63, align 8
  br label %for_hdr63, !llvm.loop !91
for_exit65:
  ret i64 0
}
