...
entry:
  ...
  %r4.p = getelementptr inbounds [10 x i8], ptr @.str.2, i64 0, i64 0
  %r4 = ptrtoint ptr %r4.p to i64
  %r5 = load i64, ptr %slot.d, align 8
  %r6 = load i64, ptr %slot.k, align 8
  %r7 = call i64 @nova_rt_dict_get(i64 %r5, i64 %r6)
  ...
  %r18.p = getelementptr inbounds [3 x i8], ptr @.str.6, i64 0, i64 0
...
@.str.2 = private unnamed_addr constant [10 x i8] c"value is \00"
@.str.3 = private unnamed_addr constant [1 x i8] c"\00"
@.str.4 = private unnamed_addr constant [5 x i8] c" = \22\00"
@.str.5 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.6 = private unnamed_addr constant [3 x i8] c"\22\0A\00"
