...
entry0:
  ...
  %r40 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r39)
  %t9 = getelementptr inbounds [11 x i8], ptr @.str.3, i64 0, i64 0
  %r41 = ptrtoint ptr %t9 to i64
  call void @nova_rt_assert(i64 %r40, i64 %r41)
  %t10 = getelementptr inbounds [11 x i8], ptr @.str.4, i64 0, i64 0
  %r44 = ptrtoint ptr %t10 to i64
  %r45 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r44)
  %t11 = getelementptr inbounds [14 x i8], ptr @.str.5, i64 0, i64 0
  %r46 = ptrtoint ptr %t11 to i64
  call void @nova_rt_assert(i64 %r45, i64 %r46)
  %t12 = getelementptr inbounds [12 x i8], ptr @.str.6, i64 0, i64 0
  %r49 = ptrtoint ptr %t12 to i64
  %r50 = call i64 @nova_rt_regex_match(i64 %r31, i64 %r49)
  %t13 = getelementptr inbounds [12 x i8], ptr @.str.7, i64 0, i64 0
  %r51 = ptrtoint ptr %t13 to i64
  call void @nova_rt_assert(i64 %r50, i64 %r51)
  %t14 = getelementptr inbounds [17 x i8], ptr @.str.8, i64 0, i64 0
  %r53 = ptrtoint ptr %t14 to i64
  %t15 = inttoptr i64 %r53 to ptr
