...
entry:
  ...
  %r1 = load i64, ptr %slot.d, align 8
  %r2 = load i64, ptr %slot.k, align 8
  %r3 = call i64 @nova_rt_dict_get(i64 %r1, i64 %r2)
  %r4 = call i64 @nova_rt_any_to_str(i64 %r3)
  %r5 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r4)
  ...
  %r9.p = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
