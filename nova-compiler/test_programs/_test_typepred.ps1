...
$env:NOVA_NO_CACHE = "1"
$r = Invoke-Timed -FilePath "$base\gen3_test.exe" -Arguments "`"$base\type_pred_test.nova`"" -TimeoutMs 60000 -WorkingDirectory $base
...
$r3 = Invoke-Timed -FilePath "$base\type_pred_test.exe" -Arguments "" -TimeoutMs 15000 -WorkingDirectory $base
