...
then0:
  %r7.p = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  %r7 = ptrtoint ptr %r7.p to i64
  %r8 = call i64 @nova_rt_print_any(i64 %r7)
  br label %endif2
else1:
  %r9.p = getelementptr inbounds [5 x i8], ptr @.str.1, i64 0, i64 0
...
; String constants
@.str.0 = private unnamed_addr constant [5 x i8] c"PASS\00"
