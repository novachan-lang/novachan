...
while_hdr15:
  ...
  store i64 %r42, ptr %slot.__sc_18, align 8
  %br_and_rhs19 = icmp ne i64 %r42, 0
...
and_rhs19:
  ...
  store i64 %r47, ptr %slot.__sc_18, align 8
  br label %and_merge20
and_merge20:
  %r48 = load i64, ptr %slot.__sc_18, align 8
  store i64 %r48, ptr %slot.__sc_21, align 8
  %br_and_rhs22 = icmp ne i64 %r48, 0
  br i1 %br_and_rhs22, label %and_rhs22, label %and_merge23
and_rhs22:
  ...
  store i64 %r53, ptr %slot.__sc_21, align 8
  br label %and_merge23
and_merge23:
  %r54 = load i64, ptr %slot.__sc_21, align 8
  store i64 %r54, ptr %slot.__sc_24, align 8
  %br_and_rhs25 = icmp ne i64 %r54, 0
...
and_rhs25:
  ...
  store i64 %r59, ptr %slot.__sc_24, align 8
  br label %and_merge26
and_merge26:
  %r60 = load i64, ptr %slot.__sc_24, align 8
  store i64 %r60, ptr %slot.__sc_27, align 8
  %br_and_rhs28 = icmp ne i64 %r60, 0
...
and_rhs28:
  ...
  store i64 %r65, ptr %slot.__sc_27, align 8
  br label %and_merge29
and_merge29:
  %r66 = load i64, ptr %slot.__sc_27, align 8
  %br_while_body16 = icmp ne i64 %r66, 0
...
entry:
  ...
  %r10 = add i64 0, 0
  store i64 %r10, ptr %slot.__for_idx_30, align 8
  br label %for_hdr30
for_hdr30:
  %r11 = load i64, ptr %slot.__for_idx_30, align 8
  %r12.cmp = icmp slt i64 %r11, %r9
  %r12 = zext i1 %r12.cmp to i64
  %br_for_body31 = icmp ne i64 %r12, 0
...
for_body31:
  ...
  %r18 = load i64, ptr %slot.__for_idx_30, align 8
  %r19 = add i64 1, 0
  %r20 = add i64 %r18, %r19
  store i64 %r20, ptr %slot.__for_idx_30, align 8
  br label %for_hdr30
for_exit32:
