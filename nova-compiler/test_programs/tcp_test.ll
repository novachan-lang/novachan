...
@.str.2 = private unnamed_addr constant [11 x i8] c"ECHO:hello\00"
@.str.3 = private unnamed_addr constant [9 x i8] c"tcp echo\00"
@.str.4 = private unnamed_addr constant [16 x i8] c"TCP: ALL PASSED\00"
@.str.5 = private unnamed_addr constant [6 x i8] c"ECHO:\00"
...
entry0:
  ...
  %r10 = call i64 @nova_rt_tcp_connect(i64 %r8, i64 19876)
  %t6 = getelementptr inbounds [6 x i8], ptr @.str.1, i64 0, i64 0
  %r15 = ptrtoint ptr %t6 to i64
  %r16 = call i64 @nova_rt_tcp_send(i64 %r10, i64 %r15)
  %r18 = call i64 @nova_rt_tcp_recv(i64 %r10)
  %r23 = call i64 @nova_rt_tcp_close(i64 %r10)
  %t7 = getelementptr inbounds [11 x i8], ptr @.str.2, i64 0, i64 0
  %r25 = ptrtoint ptr %t7 to i64
  %t8 = inttoptr i64 %r18 to ptr
  %t9 = inttoptr i64 %r25 to ptr
  %t10 = call i32 @strcmp(ptr %t8, ptr %t9)
  %t11 = icmp eq i32 %t10, 0
  %r26 = zext i1 %t11 to i64
  %t12 = getelementptr inbounds [9 x i8], ptr @.str.3, i64 0, i64 0
  %r27 = ptrtoint ptr %t12 to i64
  call void @nova_rt_assert(i64 %r26, i64 %r27)
  %t13 = getelementptr inbounds [16 x i8], ptr @.str.4, i64 0, i64 0
...
entry0:
  %r9 = call i64 @nova_rt_tcp_listen(i64 %p0)
  %r10 = call i64 @nova_rt_tcp_accept(i64 %r9)
  %r11 = call i64 @nova_rt_tcp_recv(i64 %r10)
  %t0 = getelementptr inbounds [6 x i8], ptr @.str.5, i64 0, i64 0
  %r12 = ptrtoint ptr %t0 to i64
  %t1 = call i64 @nova_rt_str_concat(i64 %r12, i64 %r11)
  %r14 = call i64 @nova_rt_tcp_send(i64 %r10, i64 %t1)
  %r15 = call i64 @nova_rt_tcp_close(i64 %r10)
  %r16 = call i64 @nova_rt_tcp_close(i64 %r9)
  ret i64 %r16
}
