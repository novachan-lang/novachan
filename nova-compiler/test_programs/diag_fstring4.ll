...
entry:
  ...
  %r1.p = getelementptr inbounds [13 x i8], ptr @.str.1, i64 0, i64 0
  %r1 = ptrtoint ptr %r1.p to i64
  %r2 = call i64 @nova_rt_str_concat(i64 %r0, i64 %r1)
  %r3.p = getelementptr inbounds [1 x i8], ptr @.str.2, i64 0, i64 0
...
@.str.1 = private unnamed_addr constant [13 x i8] c"\0Aprint(msg)\0A\00"
