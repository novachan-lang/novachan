...
__mb0_entry0:
  store i64 1000000000, ptr %slot.__mb0_n, align 8
  store i64 0, ptr %slot.__mb0_total, align 8
  store i64 0, ptr %slot.__mb0_i, align 8
  %r34 = load i64, ptr %slot.__mb0_n, align 8
  br label %__mb0_while_header1

__mb0_while_header1:
  %r15 = load i64, ptr %slot.__mb0_i, align 8
  %t0 = icmp sle i64 %r15, %r34
  br i1 %t0, label %__mb0_while_body2, label %__mb0_while_exit3, !prof !90

__mb0_while_body2:
  %r19 = load i64, ptr %slot.__mb0_total, align 8
  %r20 = load i64, ptr %slot.__mb0_i, align 8
  %r21 = add i64 %r19, %r20
  store i64 %r21, ptr %slot.__mb0_total, align 8
  %r24 = load i64, ptr %slot.__mb0_i, align 8
  %r26 = add i64 %r24, 1
  store i64 %r26, ptr %slot.__mb0_i, align 8
  br label %__mb0_while_header1, !llvm.loop !91

__mb0_while_exit3:
  %r30 = load i64, ptr %slot.__mb0_total, align 8
  store i64 %r30, ptr %slot.__mb0_ret, align 8
  br label %__mb0_merge

__mb0_merge:
  %r31 = load i64, ptr %slot.__mb0_ret, align 8
  %t1 = getelementptr inbounds [5 x i8], ptr @.str.0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr %t1, i64 %r31)
  ret i64 0
}
