...
@.str.0 = private unnamed_addr constant [19 x i8] c"test_io_output.txt\00"
@.str.1 = private unnamed_addr constant [24 x i8] c"Hello from NOVA stdlib!\00"
@.str.2 = private unnamed_addr constant [25 x i8] c"nonexistent_file_xyz.txt\00"
...
entry0:
  ...
  %t1 = getelementptr inbounds [24 x i8], ptr @.str.1, i64 0, i64 0
  %r2 = ptrtoint ptr %t1 to i64
  %r25 = call i64 @nova_rt_write_file(i64 %r1, i64 %r2)
  %t2 = getelementptr inbounds [19 x i8], ptr @.str.0, i64 0, i64 0
  %r4 = ptrtoint ptr %t2 to i64
  %r30 = call i64 @nova_rt_read_file(i64 %r4)
  %t3 = inttoptr i64 %r30 to ptr
  call i32 @puts(ptr %t3)
  call void @nova_rc_dec(i64 %r30)
  %t4 = getelementptr inbounds [19 x i8], ptr @.str.0, i64 0, i64 0
  %r11 = ptrtoint ptr %t4 to i64
  %r35 = call i64 @nova_rt_read_file(i64 %r11)
  %r40 = call i64 @nova_rt_len(i64 %r35)
  call void @nova_rc_dec(i64 %r35)
  %t5 = icmp sgt i64 %r40, 0
  %r42 = zext i1 %t5 to i64
  %t6 = icmp ne i64 %r42, 0
  ...
  %t10 = getelementptr inbounds [25 x i8], ptr @.str.2, i64 0, i64 0
  %r14 = ptrtoint ptr %t10 to i64
  %r47 = call i64 @nova_rt_read_file(i64 %r14)
  %r52 = call i64 @nova_rt_len(i64 %r47)
  call void @nova_rc_dec(i64 %r47)
  %t11 = icmp sgt i64 %r52, 0
  %r54 = zext i1 %t11 to i64
  %t12 = icmp ne i64 %r54, 0
  %t13 = getelementptr inbounds [5 x i8], ptr @.str.6, i64 0, i64 0
  %t14 = getelementptr inbounds [6 x i8], ptr @.str.7, i64 0, i64 0
