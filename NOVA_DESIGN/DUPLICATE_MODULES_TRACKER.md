...
### Validation
```
[D] forge/forge_ean.nova              | std/validation/ean.nova
...
[D] forge/forge_stopwatch.nova        | std/time/stopwatch.nova
```
...
```
[D] forge/forge_cursor.nova           | std/io/cursor.nova, std/term/cursor.nova
[D] forge/forge_diff.nova             | std/testing/diff.nova, std/text/diff.nova
