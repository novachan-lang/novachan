...
| **12** WASM | bytecode interpreter: i32 const + locals + full compare/arith + **structured control flow** (block/loop/if/else/br/br_if/return/select) + **function calls & recursion** (multi-function modules) | **REAL ✓ (control flow + calls added 2026-05-29)** | add→42; loop sum(1..10)→55; recursive fac(5)→120. linear memory/i64/f32/f64/br_table TODO |
