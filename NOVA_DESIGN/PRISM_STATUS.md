...
| T9 | **Step 3 — vertical-slice spec at buildable depth** | ⬜ TODO | — | — | grammar + lowering · DOM emission map for all 22 primitives · update path · closure→WASM table · event loop · 3 widgets fully specified. **~80 pp. Docs only, no permission needed** |
