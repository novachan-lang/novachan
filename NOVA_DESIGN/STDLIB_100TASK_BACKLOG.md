...
| 62 | std/coding/ ECC (reed_muller repetition_code parity2d convolutional viterbi interleaver hadamard_code berger_code crc_param checksum_fletcher constant_weight dual_modular) — integer/bit. Audit ALL 12 ACCEPT clean: error correction verified at EVERY position (RM 8/8, Hadamard 64/64, Viterbi 12/12, TMR 24/24) + all CRC/Fletcher check values recomputed (0x29B1/0xCBF43926/0xF4/0x4B37/0xC8F0/0x024D0127) | 12 | *(this commit)* |
