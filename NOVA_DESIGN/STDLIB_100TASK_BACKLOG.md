...
| 59 | std/interval/ (interval_arith interval_bound interval_overlap allen interval_merge interval_set interval_partition interval_cover interval_scheduling interval_stab interval_map interval_tree2) — integer/exact. Audit ALL 12 ACCEPT (scheduling optimality + weighted DP brute-force-confirmed; set difference/complement + Allen 13-relations verified fresh). Cleanest task. ib_shrink over-shrink guard added; allen point-interval limitation documented | 12 | *(this commit)* |
