...
| 64 | std/game2d/ (aabb_collide circle_collide sat_collide spatial_hash quadtree_hit sweep_test grid_astar raycast2d tilemap steering2d collision_resolve motion2d) — float/no-trig/no-HOF. Audit ALL 12 ACCEPT: A* hand-traced optimal (len 9 around fresh maze wall) + valid path + [] no-path; SAT/MTV separates; swept-AABB TOI=gap/vel; raycast hit points exact; reflect v-2(v.n)n + impulse momentum. 2 low doc-notes (id-keying, quadtree boundary) | 12 | *(this commit)* |
